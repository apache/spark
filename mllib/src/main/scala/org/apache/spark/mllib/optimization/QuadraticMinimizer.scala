...
class QuadraticMinimizer(nGram: Int,
  ...
  Aeq: Option[DoubleMatrix] = None, addEqualityToGram: Boolean = false) {
...
object QuadraticMinimizer {
  def main(args: Array[String]) {
    ...
    val directQpMl = new QuadraticMinimizer(ml, Some(lbeq), Some(ubeq), Some(Aeq), true)

...
class ALSModel private[ml] (
  ...
  def recommendForAllUsers(numItems: Int): DataFrame = {
    recommendForAll(rank, userFactors, itemFactors, $(userCol),
  ...
  def recommendForUserSubset(dataset: Dataset[_], numItems: Int): DataFrame = {
    ...
    recommendForAll(rank, srcFactorSubset, itemFactors, $(userCol),
      $(itemCol), numItems, $(blockSize))
  }
  ...
  def recommendForAllItems(numUsers: Int): DataFrame = {
    recommendForAll(rank, itemFactors, userFactors, $(itemCol), $(userCol), numUsers, $(blockSize))
  }
  ...
  def recommendForItemSubset(dataset: Dataset[_], numUsers: Int): DataFrame = {
    ...
    recommendForAll(rank, srcFactorSubset, userFactors, $(itemCol),
      $(userCol), numUsers, $(blockSize))
  }

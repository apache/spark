...
trait HasIntermediateStorageLevel extends Params {
  ...
  /**
   * Param for StorageLevel for intermediate datasets. Pass in a string representation of `StorageLevel`. Cannot be 'NONE'..
   * @group expertParam
   */
  final val intermediateStorageLevel: Param[String] = new Param[String](this, "intermediateStorageLevel", "StorageLevel for intermediate datasets. Pass in a string representation of `StorageLevel`. Cannot be 'NONE'.", (s: String) => Try(StorageLevel.fromString(s)).isSuccess && s != "NONE")

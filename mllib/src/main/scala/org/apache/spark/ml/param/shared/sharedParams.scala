...
trait HasIntermediateStorageLevel extends Params {
  ...
  /**
   * Param for storageLevel for intermediate datasets. Cannot be NONE.
   * @group expertParam
   */
  final val intermediateStorageLevel: Param[String] = new Param[String](this, "intermediateStorageLevel", "storageLevel for intermediate datasets. Cannot be NONE", (s: String) => Try(StorageLevel.fromString(s)).isSuccess && s != "NONE")

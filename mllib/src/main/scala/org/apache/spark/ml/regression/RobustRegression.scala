...
import breeze.optimize.{CachedDiffFunction, DiffFunction, LBFGS => BreezeLBFGS, LBFGSB => BreezeLBFGSB}
...
//    val lowerBounds = BDV[Double](Array.fill(numFeatures + 2)(Double.MinValue))
//    lowerBounds(0) = 1E-20
//    val upperBounds = BDV[Double](Array.fill(numFeatures + 2)(Double.MaxValue))

//    val optimizer = new BreezeLBFGSB(lowerBounds, upperBounds, $(maxIter), 10, $(tol))
    val optimizer = new BreezeLBFGS[BDV[Double]]($(maxIter), 10, $(tol))

    val initialArray = Array.fill(numFeatures + 2)(1E-20)

 ...
 */
private[ml] abstract class TreeEstimator[M] {
 ...
 * @tparam M  Concrete class implementing this trait.
 */
private[ml] abstract class TreeClassifier[M] extends TreeEstimator[M] {
 ...
 * @tparam M  Concrete class implementing this trait.
 */
private[ml] abstract class TreeRegressor[M] extends TreeEstimator[M]

/** Version of [[TreeEstimator]] for algorithms which support runWithValidation(). */
private[ml] trait TreeEstimatorWithValidate[M] {
...
private[ml] abstract class TreeClassifierWithValidate[M]
...
private[ml] abstract class TreeRegressorWithValidate[M]

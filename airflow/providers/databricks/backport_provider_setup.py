...
"""Setup.py for the apache-airflow-backport-providers-databricks package."""
...
try:
    with open(
        os.path.join(my_dir, 'airflow/providers/databricks/BACKPORT_PROVIDER_README.md'), encoding='utf-8'
    ) as f:
...
def do_setup(version_suffix_for_pypi=''):
    """Perform the package apache-airflow-backport-providers-databricks setup."""
    setup(
        name='apache-airflow-backport-providers-databricks',
        description='Backport provider package '
        'apache-airflow-backport-providers-databricks for Apache Airflow',
        long_description=long_description,
        long_description_content_type='text/markdown',
        license='Apache License 2.0',
        version=version + version_suffix_for_pypi,
        packages=find_packages(include=['airflow.providers.databricks*']),
        zip_safe=False,
        install_requires=['apache-airflow~=1.10', 'requests>=2.20.0, <3'],

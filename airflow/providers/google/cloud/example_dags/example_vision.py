...
with models.DAG(
    'example_gcp_vision_autogenerated_id', schedule_interval='@once', start_date=days_ago(1)
...
with models.DAG(
    'example_gcp_vision_explicit_id', schedule_interval='@once', start_date=days_ago(1)
) as dag_explicit_id:
    # ############################# #
...
with models.DAG(
    'example_gcp_vision_annotate_image', schedule_interval='@once', start_date=days_ago(1)

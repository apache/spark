...
In Airflow 2.0, all operators, transfers, hooks, sensors, secrets for the `email` provider
are in the `airflow.providers.email` package. You can read more about the naming conventions used

...
try:
    with open(
        os.path.join(my_dir, 'airflow/providers/slack/BACKPORT_PROVIDER_README.md'), encoding='utf-8'
    ) as f:
...
def do_setup(version_suffix_for_pypi=''):
    ...
    setup(
        ...
        packages=find_packages(include=['airflow.providers.slack*']),
        zip_safe=False,
        install_requires=['apache-airflow~=1.10', 'slackclient>=2.0.0,<3.0.0'],

...
private object ResourceRequestHelper extends Logging {
  ...
  def validateResources(sparkConf: SparkConf): Unit = {
    val resourceDefinitions = Seq[(String, String)](
      ...
      (SPARK_EXECUTOR_RESOURCE_PREFIX + "fpga" + SPARK_RESOURCE_COUNT_POSTFIX,
        YARN_EXECUTOR_RESOURCE_TYPES_PREFIX + YARN_FPGA_RESOURCE_CONFIG),
      (SPARK_DRIVER_RESOURCE_PREFIX + "fpga" + SPARK_RESOURCE_COUNT_POSTFIX,
        YARN_DRIVER_RESOURCE_TYPES_PREFIX + YARN_FPGA_RESOURCE_CONFIG),
      (SPARK_EXECUTOR_RESOURCE_PREFIX + "gpu" + SPARK_RESOURCE_COUNT_POSTFIX,
        YARN_EXECUTOR_RESOURCE_TYPES_PREFIX + YARN_GPU_RESOURCE_CONFIG),
      (SPARK_DRIVER_RESOURCE_PREFIX + "gpu" + SPARK_RESOURCE_COUNT_POSTFIX,
        YARN_DRIVER_RESOURCE_TYPES_PREFIX + YARN_GPU_RESOURCE_CONFIG))

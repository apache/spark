...
class KubernetesSuite extends SparkFunSuite
  ...
  override def beforeAll(): Unit = {
    ...
    image = testImageRef(Option(System.getProperty(CONFIG_KEY_IMAGE_JVM)).getOrElse("spark"))
    pyImage = testImageRef(Option(System.getProperty(CONFIG_KEY_IMAGE_PYTHON)).getOrElse("spark-py"))
    rImage = testImageRef(Option(System.getProperty(CONFIG_KEY_IMAGE_R)).getOrElse("spark-r"))

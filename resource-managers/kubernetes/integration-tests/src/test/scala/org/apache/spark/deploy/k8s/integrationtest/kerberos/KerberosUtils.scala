         ...
         .editSpec()
           .editTemplate()
             ...
             .addNewVolume()
               ...
               .endVolume()
             .addNewVolume()
                .withName("kerberos-test-keytab")
                .withNewPersistentVolumeClaim("server-keytab", false)
                .endVolume()
           .addNewContainer()
             .addNewEnv()
               .withName("NAMESPACE")
             ...
             .addNewVolumeMount()
               .withName("kerberos-test-keytab")
               .withMountPath("/var/keytabs")
               .endVolumeMount()
             .withCommand(List("/bin/bash").asJava)
             .withArgs(List("/opt/spark/run-kerberos-test.sh").asJava)
             .withName("kerberos-test")

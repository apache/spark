...
import org.apache.spark.deploy.k8s.integrationtest.{TestConstants, Utils}
...
private[spark] object CloudTestBackend extends IntegrationTestBackend {
  ...
  override def initialize(): Unit = {
    val masterUrl = Option(System.getProperty(TestConstants.CONFIG_KEY_KUBE_MASTER_URL))

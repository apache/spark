...
private[spark] object Config extends Logging {
  ...
  val KUBERNETES_VOLUMES_CSI_TYPE = "csi"
  ...
  val KUBERNETES_VOLUMES_OPTIONS_DRIVER_KEY = "options.driver"
  val KUBERNETES_VOLUMES_OPTIONS_FS_TYPE_KEY = "options.fsType"
  val KUBERNETES_VOLUMES_OPTIONS_NODE_PUBLISH_SECRET_NAME_KEY = "options.nodePublishSecretName"
  val KUBERNETES_VOLUMES_OPTIONS_VOLUME_ATTRIBUTES_KEY = "options.volumeAttributes."

...
try:
    ...
    setup(
        ...
        packages=[
            ...
            "pyspark.graphframes",
            "pyspark.graphframes.classic",
            "pyspark.graphframes.connect",
            "pyspark.graphframes.examples",
            "pyspark.graphframes.internal",
            "pyspark.graphframes.lib",
            "pyspark.graphframes.pg",
            "pyspark.sql",
            "pyspark.sql.avro",
            "pyspark.sql.classic",
            "pyspark.sql.connect",

...
try:
    ...
    from pyspark_connect.sql import Window
    from pyspark_connect.sql import functions as F
    from pyspark_connect.sql.column import Column
    from pyspark_connect.sql.window import WindowSpec

from pyspark_common.pandas.missing.window import (
...
from pyspark_common import pandas as ps  # noqa: F401
from pyspark_common.pandas._typing import FrameLike
from pyspark_common.pandas.groupby import GroupBy, DataFrameGroupBy
from pyspark_common.pandas.internal import NATURAL_ORDER_COLUMN_NAME, SPARK_INDEX_NAME_FORMAT
from pyspark_common.pandas.spark import functions as SF
from pyspark_common.pandas.utils import scol_for
...
class Rolling(RollingLike[FrameLike]):
    def __init__(
        ...
        from pyspark_common.pandas.frame import DataFrame
        from pyspark_common.pandas.series import Series
    ...
    def count(self) -> FrameLike:
        ...
        See Also
        --------
        pyspark_common.pandas.Series.expanding : Calling object with Series data.
        pyspark_common.pandas.DataFrame.expanding : Calling object with DataFrames.
        pyspark_common.pandas.Series.count : Count of the full Series.
        pyspark_common.pandas.DataFrame.count : Count of the full DataFrame.
    ...
    def sum(self) -> FrameLike:
        ...
        pyspark_common.pandas.Series.expanding : Calling object with Series data.
        pyspark_common.pandas.DataFrame.expanding : Calling object with DataFrames.
        pyspark_common.pandas.Series.sum : Reducing sum for Series.
        pyspark_common.pandas.DataFrame.sum : Reducing sum for DataFrame.
    ...
    def min(self) -> FrameLike:
        ...
        See Also
        --------
        pyspark_common.pandas.Series.rolling : Calling object with a Series.
        pyspark_common.pandas.DataFrame.rolling : Calling object with a DataFrame.
        pyspark_common.pandas.Series.min : Similar method for Series.
        pyspark_common.pandas.DataFrame.min : Similar method for DataFrame.
    ...
    def max(self) -> FrameLike:
        ...
        See Also
        --------
        pyspark_common.pandas.Series.rolling : Series rolling.
        pyspark_common.pandas.DataFrame.rolling : DataFrame rolling.
        pyspark_common.pandas.Series.max : Similar method for Series.
        pyspark_common.pandas.DataFrame.max : Similar method for DataFrame.
    ...
    def mean(self) -> FrameLike:
        ...
        See Also
        --------
        pyspark_common.pandas.Series.rolling : Calling object with Series data.
        pyspark_common.pandas.DataFrame.rolling : Calling object with DataFrames.
        pyspark_common.pandas.Series.mean : Equivalent method for Series.
        pyspark_common.pandas.DataFrame.mean : Equivalent method for DataFrame.
    ...
    def quantile(self, quantile: float, accuracy: int = 10000) -> FrameLike:
        ...
        See Also
        --------
        pyspark_common.pandas.Series.rolling : Calling rolling with Series data.
        pyspark_common.pandas.DataFrame.rolling : Calling rolling with DataFrames.
        pyspark_common.pandas.Series.quantile : Aggregating quantile for Series.
        pyspark_common.pandas.DataFrame.quantile : Aggregating quantile for DataFrame.
    ...
    def std(self) -> FrameLike:
        ...
        pyspark_common.pandas.Series.rolling : Calling object with Series data.
        pyspark_common.pandas.DataFrame.rolling : Calling object with DataFrames.
        pyspark_common.pandas.Series.std : Equivalent method for Series.
        pyspark_common.pandas.DataFrame.std : Equivalent method for DataFrame.
    ...
    def kurt(self) -> FrameLike:
        ...
        pyspark_common.pandas.Series.rolling : Calling object with Series data.
        pyspark_common.pandas.DataFrame.rolling : Calling object with DataFrames.
        pyspark_common.pandas.Series.var : Equivalent method for Series.
        pyspark_common.pandas.DataFrame.var : Equivalent method for DataFrame.
        numpy.var : Equivalent method for Numpy array.
...
class RollingGroupby(RollingLike[FrameLike]):
    ...
    def _apply_as_series_or_frame(self, func: Callable[[Column], Column]) -> FrameLike:
        ...
        Note that the given `func` name should be same as the API's method name.
        """
        from pyspark_common.pandas import DataFrame
    ...
    def sum(self) -> FrameLike:
        ...
        pyspark_common.pandas.Series.rolling : Calling object with Series data.
        pyspark_common.pandas.DataFrame.rolling : Calling object with DataFrames.
        pyspark_common.pandas.Series.sum : Sum of the full Series.
        pyspark_common.pandas.DataFrame.sum : Sum of the full DataFrame.
    ...
    def min(self) -> FrameLike:
        ...
        pyspark_common.pandas.Series.rolling : Calling object with Series data.
        pyspark_common.pandas.DataFrame.rolling : Calling object with DataFrames.
        pyspark_common.pandas.Series.min : Min of the full Series.
        pyspark_common.pandas.DataFrame.min : Min of the full DataFrame.
    ...
    def max(self) -> FrameLike:
        ...
        pyspark_common.pandas.Series.rolling : Calling object with Series data.
        pyspark_common.pandas.DataFrame.rolling : Calling object with DataFrames.
        pyspark_common.pandas.Series.max : Max of the full Series.
        pyspark_common.pandas.DataFrame.max : Max of the full DataFrame.
    ...
    def mean(self) -> FrameLike:
        ...
        pyspark_common.pandas.Series.rolling : Calling object with Series data.
        pyspark_common.pandas.DataFrame.rolling : Calling object with DataFrames.
        pyspark_common.pandas.Series.mean : Mean of the full Series.
        pyspark_common.pandas.DataFrame.mean : Mean of the full DataFrame.
...
class Expanding(ExpandingLike[FrameLike]):
    ...
    def min(self) -> FrameLike:
        ...
        See Also
        --------
        pyspark_common.pandas.Series.expanding : Calling object with a Series.
        pyspark_common.pandas.DataFrame.expanding : Calling object with a DataFrame.
        pyspark_common.pandas.Series.min : Similar method for Series.
        pyspark_common.pandas.DataFrame.min : Similar method for DataFrame.
    ...
    def quantile(self, quantile: float, accuracy: int = 10000) -> FrameLike:
        ...
        See Also
        --------
        pyspark_common.pandas.Series.expanding : Calling expanding with Series data.
        pyspark_common.pandas.DataFrame.expanding : Calling expanding with DataFrames.
        pyspark_common.pandas.Series.quantile : Aggregating quantile for Series.
        pyspark_common.pandas.DataFrame.quantile : Aggregating quantile for DataFrame.
...
def _test() -> None:
    ...
    import pyspark_common.pandas.window

    os.chdir(os.environ["SPARK_HOME"])

    globs = pyspark_common.pandas.window.__dict__.copy()
    globs["ps"] = pyspark_common.pandas
    spark = (
        SparkSession.builder.master("local[4]").appName("pyspark_common.pandas.window tests").getOrCreate()
    )
    (failure_count, test_count) = doctest.testmod(
        pyspark_common.pandas.window,
        globs=globs,

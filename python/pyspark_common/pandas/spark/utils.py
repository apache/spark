...
from pyspark_common.sql.types import DecimalType, StructType, MapType, ArrayType, StructField, DataType
...
def _test() -> None:
    import doctest
    import sys
    import pyspark_common.pandas.spark.utils

    globs = pyspark_common.pandas.spark.utils.__dict__.copy()
    (failure_count, test_count) = doctest.testmod(
        pyspark_common.pandas.spark.utils,
        globs=globs,

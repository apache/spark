...
from pyspark_common.pandas.missing import unsupported_function, unsupported_property
...
class MissingPandasLikeDataFrameResampler:
    ...
    # Documentation path: `python/docs/source/reference/pyspark_common.pandas/`.

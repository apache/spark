...
from pyspark_common.pandas._typing import (
    Axis,
    DataFrameOrSeries,
    Dtype,
    FrameLike,
...
from pyspark_common.pandas.indexing import AtIndexer, iAtIndexer, iLocIndexer, LocIndexer
from pyspark_common.pandas.internal import InternalFrame
from pyspark_common.pandas.spark import functions as SF
from pyspark_common.pandas.typedef import spark_type_to_pandas_dtype
...
if TYPE_CHECKING:
    ...
    from pyspark_common.pandas.window import Rolling, Expanding, ExponentialMoving
...
class Frame(object, metaclass=ABCMeta):
    ...
    def groupby(
        ...
        See Also
        --------
        pyspark_common.pandas.groupby.GroupBy
    ...
    def rolling(
        ...
        """
        from pyspark_common.pandas.window import Rolling
    ...
    def expanding(self: FrameLike, min_periods: int = 1) -> "Expanding[FrameLike]":
        ...
        a Window sub-classed for the operation
        """
        from pyspark_common.pandas.window import Expanding
    ...
    def ewm(
        ...
        a Window sub-classed for the operation
        """
        from pyspark_common.pandas.window import ExponentialMoving
...
def _test() -> None:
    ...
    import pyspark_common.pandas.generic

    os.chdir(os.environ["SPARK_HOME"])

    globs = pyspark_common.pandas.generic.__dict__.copy()
    globs["ps"] = pyspark_common.pandas
    spark = (
        SparkSession.builder.master("local[4]")
        .appName("pyspark_common.pandas.generic tests")
        .getOrCreate()
    )

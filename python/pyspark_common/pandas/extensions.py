...
from pyspark_common.pandas._typing import T
...
def register_dataframe_accessor(name: str) -> Callable[[Type[T]], Type[T]]:
    ...
    In your library code::
        ...
        from pyspark_common.pandas.extensions import register_dataframe_accessor
...
def register_series_accessor(name: str) -> Callable[[Type[T]], Type[T]]:
    ...
    In your library code::
        ...
        from pyspark_common.pandas.extensions import register_series_accessor
    ...
    Then, in an ipython session::
        ...
        True
    """
    from pyspark_common.pandas import Series
...
def register_index_accessor(name: str) -> Callable[[Type[T]], Type[T]]:
    ...
    In your library code::
        ...
        from pyspark_common.pandas.extensions import register_index_accessor
    ...
    Then, in an ipython session::
        ...
        'baz'
    """
    from pyspark_common.pandas import Index
...
def _test() -> None:
    ...
    import pyspark_common.pandas.extensions

    os.chdir(os.environ["SPARK_HOME"])

    globs = pyspark_common.pandas.extensions.__dict__.copy()
    globs["np"] = numpy
    globs["ps"] = pyspark_common.pandas
    spark = (
        SparkSession.builder.master("local[4]")
        .appName("pyspark_common.pandas.extensions tests")
        .getOrCreate()
    )
    (failure_count, test_count) = doctest.testmod(
        pyspark_common.pandas.extensions,
        globs=globs,

...
try:
    ...
    from pyspark_connect.sql import Column as PySparkColumn, DataFrame as PySparkDataFrame, functions as F
...
from pyspark_common.pandas.config import option_context, get_option
...
from pyspark_common.pandas.spark.accessors import SparkFrameMethods, CachedSparkFrameMethods
...
if TYPE_CHECKING:
    from pyspark_common.sql._typing import OptionalPrimitiveType
    from pyspark_common.pandas.groupby import DataFrameGroupBy
    from pyspark_common.pandas.resample import DataFrameResampler
...
defaultdict(<class 'list'>, {'col..., 'col...})]
    ...
    def transpose(self) -> "DataFrame":
        ...
        .. note:: This method is based on an expensive operation due to the nature
            ...
            has the 'compute.max_rows' default limit of input length and raises a ValueError.
                ...
                >>> from pyspark_common.pandas.config import option_context
    ...
    def to_spark_io(
        ...
        **options: "OptionalPrimitiveType",
        ...
        See :meth:`pyspark_common.pandas.spark.accessors.SparkFrameMethods.to_spark_io`.
    ...
    def _assign(self, kwargs: Any) -> "DataFrame":
        ...
        from pyspark_common.pandas.series import IndexOpsMixin
    ...
    def select_dtypes(
        ...
        * To select datetimes, use ``np.datetime64``, ``'datetime'`` or
        ...
        5  2  False  2.0
        """
        from pyspark_common.sql.types import _parse_datatype_string
    ...
    def info(
        ...
        <class 'pyspark_common.pandas.frame.DataFrame'>
...
def _test() -> None:
    ...
    import pyspark_common.pandas.frame

    os.chdir(os.environ["SPARK_HOME"])

    globs = pyspark_common.pandas.frame.__dict__.copy()
    globs["ps"] = pyspark_common.pandas
    spark = (
        SparkSession.builder.master("local[4]").appName("pyspark_common.pandas.frame tests").getOrCreate()
    )
    globs["spark"] = spark

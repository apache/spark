...
try:
    ...
    from pyspark_connect.sql import functions as F, Column as PySparkColumn, DataFrame as SparkDataFrame
    from pyspark_connect.sql.window import Window
...
from pyspark_common.sql.utils import get_column_class, get_window_class

from pyspark_common import pandas as ps  # For running doctests and reference resolution in PyCharm.
from pyspark_common.pandas._typing import Axis, Dtype, Label, Name, Scalar, T
from pyspark_common.pandas.accessors import PandasOnSparkSeriesMethods
from pyspark_common.pandas.categorical import CategoricalAccessor
from pyspark_common.pandas.config import get_option
from pyspark_common.pandas.correlation import (
    compute,
...
from pyspark_common.pandas.base import IndexOpsMixin
from pyspark_common.pandas.exceptions import SparkPandasIndexingError
from pyspark_common.pandas.frame import DataFrame
from pyspark_common.pandas.generic import Frame
from pyspark_common.pandas.internal import (
    InternalField,
    InternalFrame,
    DEFAULT_SERIES_NAME,
...
from pyspark_common.pandas.missing.series import MissingPandasLikeSeries
from pyspark_common.pandas.plot import PandasOnSparkPlotAccessor
from pyspark_common.pandas.utils import (
    combine_frames,
    is_name_like_tuple,
    is_name_like_value,
    name_like_string,
...
from pyspark_common.pandas.datetimes import DatetimeMethods
from pyspark_common.pandas.spark import functions as SF
from pyspark_common.pandas.spark.accessors import SparkSeriesMethods
from pyspark_common.pandas.strings import StringMethods
from pyspark_common.pandas.typedef import (
    infer_return_type,
...
from pyspark_common.pandas.typedef.typehints import as_spark_type

if TYPE_CHECKING:
    from pyspark_common.sql._typing import ColumnOrName

    from pyspark_common.pandas.groupby import SeriesGroupBy
    from pyspark_common.pandas.resample import SeriesResampler
    from pyspark_common.pandas.indexes import Index
    from pyspark_common.pandas.spark.accessors import SparkIndexOpsMethods
...
class Series(Frame, IndexOpsMixin, Generic[T]):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        if isinstance(data, DataFrame):
            ...
            if isinstance(data, pd.Series):
                ...
                from pyspark_common.pandas.indexes.base import Index
    ...
    def cov(self, other: "Series", min_periods: Optional[int] = None, ddof: int = 1) -> float:
        ...
        Examples
        --------
        >>> from pyspark_common.pandas.config import set_option, reset_option
    ...
    def resample(
        ...
        """
        from pyspark_common.pandas.indexes import DatetimeIndex
        from pyspark_common.pandas.resample import SeriesResampler
...
def _test() -> None:
    ...
    import pyspark_common.pandas.series

    os.chdir(os.environ["SPARK_HOME"])

    globs = pyspark_common.pandas.series.__dict__.copy()
    globs["ps"] = pyspark_common.pandas
    spark = (
        SparkSession.builder.master("local[4]").appName("pyspark_common.pandas.series tests").getOrCreate()
    )
    (failure_count, test_count) = doctest.testmod(
        pyspark_common.pandas.series,
        globs=globs,

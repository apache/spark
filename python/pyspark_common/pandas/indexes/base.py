...
from pyspark_common.pandas._typing import Dtype, Label, Name, Scalar
...
from pyspark_common.pandas.missing.indexes import MissingPandasLikeIndex
from pyspark_common.pandas.series import Series, first_series
from pyspark_common.pandas.spark.accessors import SparkIndexMethods
...
def _test() -> None:
    ...
    import pyspark_common.pandas.indexes.base

    os.chdir(os.environ["SPARK_HOME"])

    globs = pyspark_common.pandas.indexes.base.__dict__.copy()
    globs["ps"] = pyspark_common.pandas
    spark = (
        SparkSession.builder.master("local[4]")
        .appName("pyspark_common.pandas.indexes.base tests")
        .getOrCreate()
    )
    (failure_count, test_count) = doctest.testmod(
        pyspark_common.pandas.indexes.base,
        globs=globs,

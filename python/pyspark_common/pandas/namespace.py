...
try:
    ...
    from pyspark_connect.sql.dataframe import DataFrame as PySparkDataFrame
...
from pyspark_common.pandas._typing import Axis, Dtype, Label, Name
...
from pyspark_common.pandas.frame import DataFrame, _reduce_spark_multi
...
from pyspark_common.pandas.indexes import Index, DatetimeIndex, TimedeltaIndex
...
def _test() -> None:
    ...
    import pyspark_common.pandas.namespace

    os.chdir(os.environ["SPARK_HOME"])

    globs = pyspark_common.pandas.namespace.__dict__.copy()
    globs["ps"] = pyspark_common.pandas
    globs["sf"] = F
    spark = (
        SparkSession.builder.master("local[4]")
        .appName("pyspark_common.pandas.namespace tests")
        .getOrCreate()
    )
    ...
    (failure_count, test_count) = doctest.testmod(
        pyspark_common.pandas.namespace,
        globs=globs,

...
try:
    ...
    from pyspark_connect.ml.feature import Bucketizer
    from pyspark_connect.sql import functions as F
    # Spark Connect does not support `KernelDensity`.
from pandas.core.base import PandasObject
from pandas.core.dtypes.inference import is_integer

from pyspark_common.pandas.missing import unsupported_function
from pyspark_common.pandas.config import get_option
from pyspark_common.pandas.utils import name_like_string


class TopNPlotBase:
    def get_top_n(self, data):
        from pyspark_common.pandas import DataFrame, Series
...
class PandasOnSparkPlotAccessor(PandasObject):
    ...
    def _get_plot_backend(backend=None):
        ...
        if backend == "matplotlib":
            ...
            try:
                ...
                from pyspark_common.pandas.plot import matplotlib as module
            except ImportError:
                raise ImportError(
            ...
            try:
                ...
                from pyspark_common.pandas.plot import plotly as module
            except ImportError:
                raise ImportError(
    ...
    def bar(self, x=None, y=None, **kwds):
        ...
        **kwds : optional
            ...
            :meth:`pyspark_common.pandas.Series.plot` or
            :meth:`pyspark_common.pandas.DataFrame.plot`.
    ...
    def barh(self, x=None, y=None, **kwargs):
        ...
        **kwds
            ...
            :meth:`pyspark_common.pandas.DataFrame.plot` or :meth:`pyspark_common.pandas.Series.plot`.
    ...
    def box(self, **kwds):
        ...
        **kwds : optional
            Additional keyword arguments are documented in
            :meth:`pyspark_common.pandas.Series.plot`.
    ...
    def scatter(self, x, y, **kwds):
        ...
        **kwds: Optional
            Keyword arguments to pass on to :meth:`pyspark_common.pandas.DataFrame.plot`.

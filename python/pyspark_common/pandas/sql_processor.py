...
try:
    ...
    from pyspark_connect.sql import SparkSession, DataFrame as SDataFrame

from pyspark_common import pandas as ps  # For running doctests and reference resolution in PyCharm.
from pyspark_common.pandas.utils import default_session
from pyspark_common.pandas.frame import DataFrame
from pyspark_common.pandas.series import Series
from pyspark_common.pandas.internal import InternalFrame
from pyspark_common.pandas.namespace import _get_index_map
    ...
    **kwargs: Any,
    ...
    index_col : str or list of str, optional
        ...
        .. note:: If you want to preserve the index, explicitly use :func:`DataFrame.reset_index`,
            ...
            >>> from pyspark_common.pandas import sql_processor
...
def _test() -> None:
    ...
    import pyspark_common.pandas.sql_processor

    os.chdir(os.environ["SPARK_HOME"])

    globs = pyspark_common.pandas.sql_processor.__dict__.copy()
    globs["ps"] = pyspark_common.pandas
    spark = (
        SparkSession.builder.master("local[4]")
        .appName("pyspark_common.pandas.sql_processor tests")
        .getOrCreate()
    )
    (failure_count, test_count) = doctest.testmod(
        pyspark_common.pandas.sql_processor,
        globs=globs,

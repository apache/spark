...
from pyspark_common.sql.types import BooleanType, LongType, DataType
...
from pyspark_common.pandas.exceptions import SparkPandasIndexingError, SparkPandasNotImplementedError
...
def _test() -> None:
    ...
    import pyspark_common.pandas.indexing

    os.chdir(os.environ["SPARK_HOME"])

    globs = pyspark_common.pandas.indexing.__dict__.copy()
    globs["ps"] = pyspark_common.pandas
    spark = (
        SparkSession.builder.master("local[4]")
        .appName("pyspark_common.pandas.indexing tests")
        .getOrCreate()
    )
    (failure_count, test_count) = doctest.testmod(
        pyspark_common.pandas.indexing,
        globs=globs,

...
import pyspark_common.sql.types as types
from pyspark.sql.pandas.types import to_arrow_type, from_arrow_type

# For running doctests and reference resolution in PyCharm.
from pyspark import pandas as ps  # noqa: F401
from pyspark_common.pandas._typing import Dtype, T
...
def infer_return_type(f: Callable) -> Union[SeriesType, DataFrameType, ScalarType, UnknownType]:
    ...
    # canonically.
    from pyspark_common.pandas.internal import InternalField, SPARK_INDEX_NAME_FORMAT
    from pyspark_common.pandas.typedef import SeriesType, NameTypeHolder, IndexNameTypeHolder
...
def create_type_for_series_type(param: Any) -> Type[SeriesType]:
    ...
    True
    """
    from pyspark_common.pandas.typedef import NameTypeHolder
...
def _to_type_holders(params: Any) -> Tuple:
    from pyspark_common.pandas.typedef import NameTypeHolder, IndexNameTypeHolder
...
def _test() -> None:
    import doctest
    import sys
    import pyspark_common.pandas.typedef.typehints

    globs = pyspark_common.pandas.typedef.typehints.__dict__.copy()
    (failure_count, test_count) = doctest.testmod(
        pyspark_common.pandas.typedef.typehints,
        globs=globs,

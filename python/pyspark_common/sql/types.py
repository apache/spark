...
class ArrayType(DataType):
    ...
    Examples
    --------
    >>> from pyspark_common.sql.types import ArrayType, StringType, StructField, StructType
...
class MapType(DataType):
    ...
    Examples
    --------
    >>> from pyspark_common.sql.types import IntegerType, FloatType, MapType, StringType
...
class StructField(DataType):
    ...
    Examples
    --------
    >>> from pyspark_common.sql.types import StringType, StructField
...
class StructType(DataType):
    ...
    def add(
        ...
        Examples
        --------
        >>> from pyspark_common.sql.types import IntegerType, StringType, StructField, StructType
    ...
    def fieldNames(self) -> List[str]:
        ...
        Examples
        --------
        >>> from pyspark_common.sql.types import StringType, StructField, StructType
...
def _make_type_verifier(
    ...
    Traceback (most recent call last):
        ...
    pyspark_common.errors.exceptions.base.PySparkValueError:...
    >>> _make_type_verifier(ArrayType(ShortType()))(list(range(3)))
    >>> _make_type_verifier(ArrayType(StringType()))(set()) # doctest: +IGNORE_EXCEPTION_DETAIL
    Traceback (most recent call last):
        ...
    pyspark_common.errors.exceptions.base.PySparkTypeError:...

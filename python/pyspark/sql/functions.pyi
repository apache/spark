...
class UserDefinedFunctionWrapper(Protocol):
    def __call__(self, *args: Column) -> Column: ...
    def asNonDeterministic(self) -> UserDefinedFunctionWrapper: ...
...
def udf(
    f: DataTypeOrString = ...,
) -> Callable[[Callable[..., Any]], UserDefinedFunctionWrapper]: ...
@overload
def udf(
    *,

...
_atomic_types: Dict
_all_atomic_types: Dict
_all_complex_types: Dict


def _parse_datatype_string(s: str) -> DataType: ...
def _make_type_verifier(dataType: DataType, nullable: bool, name: str) -> Callable: ...
def _infer_schema(row, names): ...
def _has_nulltype(dt): ...
def _merge_type(a, b, name): ...

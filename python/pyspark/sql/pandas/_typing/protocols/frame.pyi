...
class DataFrameLike(Protocol):
    ...
    def select_dtypes(self, include: Any = ..., exclude: Any = ...) -> DataFrameLike: ...
    ...
    def swaplevel(self, i: Any = ..., j: Any = ..., axis: Any = ...) -> DataFrameLike: ...
    ...
    def pivot(self, index: Any = ..., columns: Any = ..., values: Any = ...) -> DataFrameLike: ...
    def pivot_table(
        self,
        values: Any = ...,
        index: Any = ...,
    ...
    agg: Any = ...
    def transform(self, func: Any, axis: Any = ..., *args: Any, **kwargs: Any) -> DataFrameLike: ...
    def apply(
        self,
        func: Any,
        axis: int = ...,
    ...
    def round(self, decimals: Any = ..., *args: Any, **kwargs: Any) -> DataFrameLike: ...
    ...
    def to_period(self, freq: Any = ..., axis: Any = ..., copy: Any = ...) -> DataFrameLike: ...

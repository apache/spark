...
class ListStateCall(_message.Message):
    ...
    stateName: str
    def __init__(self, stateName: Optional[str] = ..., exists: Optional[Union[Exists, Mapping]] = ..., get: Optional[Union[Get, Mapping]] = ..., listStatePut: Optional[Union[ListStatePut, Mapping]] = ..., appendValue: Optional[Union[AppendValue, Mapping]] = ..., appendList: Optional[Union[AppendList, Mapping]] = ..., clear: Optional[Union[Clear, Mapping]] = ...) -> None: ...

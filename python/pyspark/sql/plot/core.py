...
class PySparkPlotAccessor:
    ...
    def line(self, x: str, y: Union[str, list[str]], **kwargs: Any) -> "Figure":
        ...
        **kwargs : optional
        ...
        Examples
        --------
        Plot with a single column as the vertical axis.
        ...
        Plot with multiple columns as the vertical axis.
    ...
    def barh(self, x: str, y: Union[str, list[str]], **kwargs: Any) -> "Figure":
        ...
        **kwargs : optional
        ...
        Examples
        --------
        Plot with a single column as the horizontal axis.
        ...
        Plot with multiple columns as the horizontal axis.

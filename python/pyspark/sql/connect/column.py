...
class Column:
    ...
    def when(self, condition: "Column", value: Any) -> "Column":
        ...
        case_when: CaseWhen = cast(CaseWhen, self._expr)
        if case_when._else_value is not None:
        ...
        _branches = case_when._branches + [(condition._expr, _value)]
    ...
    def otherwise(self, value: Any) -> "Column":
        ...
        return Column(CaseWhen(branches=case_when._branches, else_value=_value))

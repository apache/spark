...
class Expression(google.protobuf.message.Message):
    ...
    class Literal(google.protobuf.message.Message):
        ...
        uuid: builtins.bytes
        @property
        def null(self) -> spark.connect.types_pb2.Type:
            """a typed null literal"""
        @property
        def list(self) -> global___Expression.Literal.List: ...
        @property
        def empty_list(self) -> spark.connect.types_pb2.Type.List: ...
        @property
        def empty_map(self) -> spark.connect.types_pb2.Type.Map: ...
        @property
        ...
        def __init__(
            ...
            *,
            ...
            timestamp_tz: builtins.int = ...,
            uuid: builtins.bytes = ...,
            null: spark.connect.types_pb2.Type | None = ...,
            list: global___Expression.Literal.List | None = ...,
            empty_list: spark.connect.types_pb2.Type.List | None = ...,
            empty_map: spark.connect.types_pb2.Type.Map | None = ...,

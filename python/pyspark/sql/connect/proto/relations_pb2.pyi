...
class Project(google.protobuf.message.Message):
    ...
    def expressions(
        ...
        spark.connect.expressions_pb2.Expression
    ]: ...
    def __init__(
        self,
        *,
        input: global___Relation | None = ...,
        expressions: collections.abc.Iterable[spark.connect.expressions_pb2.Expression]
        | None = ...,
    ) -> None: ...
    def HasField(
...
class Join(google.protobuf.message.Message):
    ...
    @property
    def on(self) -> spark.connect.expressions_pb2.Expression: ...
    ...
    def __init__(
        ...
        *,
        ...
        on: spark.connect.expressions_pb2.Expression | None = ...,
        how: global___Join.JoinType.ValueType = ...,
    ) -> None: ...
    def HasField(
...
class Aggregate(google.protobuf.message.Message):
    ...
    class Measure(google.protobuf.message.Message):
        ...
        @property
        def filter(self) -> spark.connect.expressions_pb2.Expression:
            """Conditional filter for SUM(x FILTER WHERE x < 10)"""
        def __init__(
            self,
            *,
            function: global___Aggregate.AggregateFunction | None = ...,
            filter: spark.connect.expressions_pb2.Expression | None = ...,
        ) -> None: ...
        def HasField(
            self,
    ...
    class AggregateFunction(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            name: builtins.str = ...,
            arguments: collections.abc.Iterable[spark.connect.expressions_pb2.Expression]
            | None = ...,
        ) -> None: ...
        def ClearField(
...
class Sort(google.protobuf.message.Message):
    ...
    class SortField(google.protobuf.message.Message):
        ...
        @property
        def expression(self) -> spark.connect.expressions_pb2.Expression: ...
        direction: global___Sort.SortDirection.ValueType
        nulls: global___Sort.SortNulls.ValueType
        def __init__(
            self,
            *,
            expression: spark.connect.expressions_pb2.Expression | None = ...,
            direction: global___Sort.SortDirection.ValueType = ...,
            nulls: global___Sort.SortNulls.ValueType = ...,
        ) -> None: ...
        def HasField(

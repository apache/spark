...
class Relation(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        common: typing.Optional[global___RelationCommon] = ...,
        read: typing.Optional[global___Read] = ...,
        project: typing.Optional[global___Project] = ...,
        filter: typing.Optional[global___Filter] = ...,
        join: typing.Optional[global___Join] = ...,
        set_op: typing.Optional[global___SetOperation] = ...,
        sort: typing.Optional[global___Sort] = ...,
        limit: typing.Optional[global___Limit] = ...,
        aggregate: typing.Optional[global___Aggregate] = ...,
        sql: typing.Optional[global___SQL] = ...,
        local_relation: typing.Optional[global___LocalRelation] = ...,
        sample: typing.Optional[global___Sample] = ...,
        offset: typing.Optional[global___Offset] = ...,
        deduplicate: typing.Optional[global___Deduplicate] = ...,
        range: typing.Optional[global___Range] = ...,
        subquery_alias: typing.Optional[global___SubqueryAlias] = ...,
        repartition: typing.Optional[global___Repartition] = ...,
        to_df: typing.Optional[global___ToDF] = ...,
        with_columns_renamed: typing.Optional[global___WithColumnsRenamed] = ...,
        show_string: typing.Optional[global___ShowString] = ...,
        drop: typing.Optional[global___Drop] = ...,
        tail: typing.Optional[global___Tail] = ...,
        with_columns: typing.Optional[global___WithColumns] = ...,
        hint: typing.Optional[global___Hint] = ...,
        unpivot: typing.Optional[global___Unpivot] = ...,
        to_schema: typing.Optional[global___ToSchema] = ...,
        repartition_by_expression: typing.Optional[global___RepartitionByExpression] = ...,
        map_partitions: typing.Optional[global___MapPartitions] = ...,
        collect_metrics: typing.Optional[global___CollectMetrics] = ...,
        parse: typing.Optional[global___Parse] = ...,
        group_map: typing.Optional[global___GroupMap] = ...,
        co_group_map: typing.Optional[global___CoGroupMap] = ...,
        with_watermark: typing.Optional[global___WithWatermark] = ...,
        apply_in_pandas_with_state: typing.Optional[global___ApplyInPandasWithState] = ...,
        html_string: typing.Optional[global___HtmlString] = ...,
        cached_local_relation: typing.Optional[global___CachedLocalRelation] = ...,
        cached_remote_relation: typing.Optional[global___CachedRemoteRelation] = ...,
        common_inline_user_defined_table_function: typing.Optional[
            global___CommonInlineUserDefinedTableFunction
        ] = ...,
        as_of_join: typing.Optional[global___AsOfJoin] = ...,
        common_inline_user_defined_data_source: typing.Optional[
            global___CommonInlineUserDefinedDataSource
        ] = ...,
        with_relations: typing.Optional[global___WithRelations] = ...,
        transpose: typing.Optional[global___Transpose] = ...,
        unresolved_table_valued_function: typing.Optional[
            global___UnresolvedTableValuedFunction
        ] = ...,
        lateral_join: typing.Optional[global___LateralJoin] = ...,
        chunked_cached_local_relation: typing.Optional[global___ChunkedCachedLocalRelation] = ...,
        relation_changes: typing.Optional[global___RelationChanges] = ...,
        fill_na: typing.Optional[global___NAFill] = ...,
        drop_na: typing.Optional[global___NADrop] = ...,
        replace: typing.Optional[global___NAReplace] = ...,
        summary: typing.Optional[global___StatSummary] = ...,
        crosstab: typing.Optional[global___StatCrosstab] = ...,
        describe: typing.Optional[global___StatDescribe] = ...,
        cov: typing.Optional[global___StatCov] = ...,
        corr: typing.Optional[global___StatCorr] = ...,
        approx_quantile: typing.Optional[global___StatApproxQuantile] = ...,
        freq_items: typing.Optional[global___StatFreqItems] = ...,
        sample_by: typing.Optional[global___StatSampleBy] = ...,
        catalog: typing.Optional[pyspark.sql.connect.proto.catalog_pb2.Catalog] = ...,
        ml_relation: typing.Optional[global___MlRelation] = ...,
        extension: typing.Optional[google.protobuf.any_pb2.Any] = ...,
        unknown: typing.Optional[global___Unknown] = ...,
    ) -> None: ...
    def HasField(
        self,
...
class MlRelation(google.protobuf.message.Message):
    ...
    class Transform(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            ...
            transformer: typing.Optional[pyspark.sql.connect.proto.ml_common_pb2.MlOperator] = ...,
            input: typing.Optional[global___Relation] = ...,
        ...
        ) -> typing.Optional[typing_extensions.Literal["obj_ref", "transformer"]]: ...
    ...
    def __init__(
        self,
        *,
        transform: typing.Optional[global___MlRelation.Transform] = ...,
        fetch: typing.Optional[global___Fetch] = ...,
        model_summary_dataset: typing.Optional[global___Relation] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["model_summary_dataset"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["ml_type", b"ml_type"]
    ) -> typing.Optional[typing_extensions.Literal["transform", "fetch"]]: ...
...
class Fetch(google.protobuf.message.Message):
    ...
    class Method(google.protobuf.message.Message):
        ...
        class Args(google.protobuf.message.Message):
            ...
            ) -> typing.Optional[typing_extensions.Literal["param", "input"]]: ...
        ...
        def __init__(
            ...
            *,
            method: typing.Text = ...,
            args: typing.Optional[typing.Iterable[global___Fetch.Method.Args]] = ...,
        ) -> None: ...
        def ClearField(
    ...
    def __init__(
        ...
        *,
        obj_ref: typing.Optional[pyspark.sql.connect.proto.ml_common_pb2.ObjectRef] = ...,
        methods: typing.Optional[typing.Iterable[global___Fetch.Method]] = ...,
    ) -> None: ...
    def HasField(
...
class WithRelations(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        root: typing.Optional[global___Relation] = ...,
        references: typing.Optional[typing.Iterable[global___Relation]] = ...,
    ) -> None: ...
...
class Read(google.protobuf.message.Message):
    ...
    class DataSource(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            ...
            schema: typing.Optional[typing.Text] = ...,
            options: typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
            paths: typing.Optional[typing.Iterable[typing.Text]] = ...,
            predicates: typing.Optional[typing.Iterable[typing.Text]] = ...,
            source_name: typing.Optional[typing.Text] = ...,
        ) -> None: ...
        def HasField(
            self,
            field_name: typing_extensions.Literal[
        ...
        ) -> typing.Optional[typing_extensions.Literal["source_name"]]: ...
    ...
    def __init__(
        self,
        *,
        named_table: typing.Optional[global___Read.NamedTable] = ...,
        data_source: typing.Optional[global___Read.DataSource] = ...,
        is_streaming: builtins.bool = ...,
    ) -> None: ...
    def HasField(
        self,
    ...
    ) -> typing.Optional[typing_extensions.Literal["named_table", "data_source"]]: ...
...
class Filter(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        condition: typing.Optional[pyspark.sql.connect.proto.expressions_pb2.Expression] = ...,
    ) -> None: ...
    def HasField(
...
class Join(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        left: typing.Optional[global___Relation] = ...,
        right: typing.Optional[global___Relation] = ...,
        join_condition: typing.Optional[pyspark.sql.connect.proto.expressions_pb2.Expression] = ...,
        join_type: global___Join.JoinType.ValueType = ...,
        using_columns: typing.Optional[typing.Iterable[typing.Text]] = ...,
        join_data_type: typing.Optional[global___Join.JoinDataType] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["join_data_type"]]: ...
...
class SetOperation(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        left_input: typing.Optional[global___Relation] = ...,
        right_input: typing.Optional[global___Relation] = ...,
        set_op_type: global___SetOperation.SetOpType.ValueType = ...,
        is_all: typing.Optional[builtins.bool] = ...,
        by_name: typing.Optional[builtins.bool] = ...,
        allow_missing_columns: typing.Optional[builtins.bool] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["allow_missing_columns"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_by_name", b"_by_name"]
    ) -> typing.Optional[typing_extensions.Literal["by_name"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_is_all", b"_is_all"]
    ) -> typing.Optional[typing_extensions.Literal["is_all"]]: ...
...
class Aggregate(google.protobuf.message.Message):
    ...
    class Pivot(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            col: typing.Optional[pyspark.sql.connect.proto.expressions_pb2.Expression] = ...,
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        group_type: global___Aggregate.GroupType.ValueType = ...,
        grouping_expressions: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
        aggregate_expressions: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
        pivot: typing.Optional[global___Aggregate.Pivot] = ...,
        grouping_sets: typing.Optional[typing.Iterable[global___Aggregate.GroupingSets]] = ...,
    ) -> None: ...
    def HasField(
...
class Sort(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        order: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression.SortOrder]
        ] = ...,
        is_global: typing.Optional[builtins.bool] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["is_global"]]: ...
...
class Drop(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        column_names: typing.Optional[typing.Iterable[typing.Text]] = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["input", b"input"]
    ) -> builtins.bool: ...
...
class Deduplicate(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        column_names: typing.Optional[typing.Iterable[typing.Text]] = ...,
        all_columns_as_keys: typing.Optional[builtins.bool] = ...,
        within_watermark: typing.Optional[builtins.bool] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["all_columns_as_keys"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_within_watermark", b"_within_watermark"]
    ) -> typing.Optional[typing_extensions.Literal["within_watermark"]]: ...
...
class ChunkedCachedLocalRelation(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        dataHashes: typing.Optional[typing.Iterable[typing.Text]] = ...,
        schemaHash: typing.Optional[typing.Text] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["schemaHash"]]: ...
...
class Sample(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        lower_bound: builtins.float = ...,
        upper_bound: builtins.float = ...,
        with_replacement: typing.Optional[builtins.bool] = ...,
    ...
    ) -> typing.Optional[typing_extensions.Literal["seed"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_with_replacement", b"_with_replacement"]
    ) -> typing.Optional[typing_extensions.Literal["with_replacement"]]: ...
...
class Range(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        step: builtins.int = ...,
        num_partitions: typing.Optional[builtins.int] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["num_partitions"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_start", b"_start"]
    ) -> typing.Optional[typing_extensions.Literal["start"]]: ...
...
class SubqueryAlias(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        alias: typing.Text = ...,
        qualifier: typing.Optional[typing.Iterable[typing.Text]] = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["input", b"input"]
    ) -> builtins.bool: ...
...
class Repartition(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        num_partitions: builtins.int = ...,
        shuffle: typing.Optional[builtins.bool] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["shuffle"]]: ...
...
class StatSummary(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        statistics: typing.Optional[typing.Iterable[typing.Text]] = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["input", b"input"]
    ) -> builtins.bool: ...
...
class StatDescribe(google.protobuf.message.Message):
    ...
    def input(self) -> global___Relation:
        ...
        pass
    @property
    def cols(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        cols: typing.Optional[typing.Iterable[typing.Text]] = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["input", b"input"]
    ) -> builtins.bool: ...
...
class StatCorr(google.protobuf.message.Message):
    ...
    ) -> typing.Optional[typing_extensions.Literal["method"]]: ...
...
class StatApproxQuantile(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        cols: typing.Optional[typing.Iterable[typing.Text]] = ...,
        probabilities: typing.Optional[typing.Iterable[builtins.float]] = ...,
        relative_error: builtins.float = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["input", b"input"]
...
class StatFreqItems(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        cols: typing.Optional[typing.Iterable[typing.Text]] = ...,
        support: typing.Optional[builtins.float] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["support"]]: ...
...
class StatSampleBy(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        col: typing.Optional[pyspark.sql.connect.proto.expressions_pb2.Expression] = ...,
        fractions: typing.Optional[typing.Iterable[global___StatSampleBy.Fraction]] = ...,
        seed: typing.Optional[builtins.int] = ...,
    ) -> None: ...
    def HasField(
        self,
...
class NADrop(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        cols: typing.Optional[typing.Iterable[typing.Text]] = ...,
        min_non_nulls: typing.Optional[builtins.int] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["min_non_nulls"]]: ...
...
class NAReplace(google.protobuf.message.Message):
    ...
    class Replacement(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            old_value: typing.Optional[
                pyspark.sql.connect.proto.expressions_pb2.Expression.Literal
            ] = ...,
            new_value: typing.Optional[
                pyspark.sql.connect.proto.expressions_pb2.Expression.Literal
            ] = ...,
        ) -> None: ...
        def HasField(
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        cols: typing.Optional[typing.Iterable[typing.Text]] = ...,
        replacements: typing.Optional[typing.Iterable[global___NAReplace.Replacement]] = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["input", b"input"]
    ) -> builtins.bool: ...
...
class WithColumnsRenamed(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        rename_columns_map: typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        renames: typing.Optional[typing.Iterable[global___WithColumnsRenamed.Rename]] = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["input", b"input"]
    ) -> builtins.bool: ...
    ...
    def __init__(
        ...
        *,
        ...
        aliases: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression.Alias]
        ] = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["input", b"input"]
...
class Unpivot(google.protobuf.message.Message):
    ...
    def values(self) -> global___Unpivot.Values:
        ...
        pass
    variable_column_name: typing.Text
    ...
    def __init__(
        ...
        *,
        ...
        values: typing.Optional[global___Unpivot.Values] = ...,
        variable_column_name: typing.Text = ...,
        value_column_name: typing.Text = ...,
    ) -> None: ...
    def HasField(
...
class RepartitionByExpression(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        partition_exprs: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
        num_partitions: typing.Optional[builtins.int] = ...,
    ) -> None: ...
...
class MapPartitions(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        is_barrier: typing.Optional[builtins.bool] = ...,
        profile_id: typing.Optional[builtins.int] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["is_barrier"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_profile_id", b"_profile_id"]
    ) -> typing.Optional[typing_extensions.Literal["profile_id"]]: ...
...
class GroupMap(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        sorting_expressions: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
        initial_input: typing.Optional[global___Relation] = ...,
        initial_grouping_expressions: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
        is_map_groups_with_state: typing.Optional[builtins.bool] = ...,
        output_mode: typing.Optional[typing.Text] = ...,
        timeout_conf: typing.Optional[typing.Text] = ...,
        state_schema: typing.Optional[pyspark.sql.connect.proto.types_pb2.DataType] = ...,
        transform_with_state_info: typing.Optional[global___TransformWithStateInfo] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["is_map_groups_with_state"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_output_mode", b"_output_mode"]
    ) -> typing.Optional[typing_extensions.Literal["output_mode"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_state_schema", b"_state_schema"]
    ) -> typing.Optional[typing_extensions.Literal["state_schema"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_timeout_conf", b"_timeout_conf"]
    ) -> typing.Optional[typing_extensions.Literal["timeout_conf"]]: ...
    @typing.overload
    def WhichOneof(
        self,
        oneof_group: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["transform_with_state_info"]]: ...
...
class TransformWithStateInfo(google.protobuf.message.Message):
    ...
    time_mode: typing.Text
    """(Required) Time mode string for transformWithState."""

    event_time_column_name: typing.Text
    ...
    def __init__(
        ...
        *,
        time_mode: typing.Text = ...,
        event_time_column_name: typing.Optional[typing.Text] = ...,
        output_schema: typing.Optional[pyspark.sql.connect.proto.types_pb2.DataType] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["event_time_column_name"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_output_schema", b"_output_schema"]
    ) -> typing.Optional[typing_extensions.Literal["output_schema"]]: ...
...
class CoGroupMap(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        input: typing.Optional[global___Relation] = ...,
        input_grouping_expressions: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
        other: typing.Optional[global___Relation] = ...,
        other_grouping_expressions: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
        func: typing.Optional[
            pyspark.sql.connect.proto.expressions_pb2.CommonInlineUserDefinedFunction
        ] = ...,
        input_sorting_expressions: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
        other_sorting_expressions: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
    ) -> None: ...
    def HasField(
...
class ApplyInPandasWithState(google.protobuf.message.Message):
    ...
    def func(self) -> pyspark.sql.connect.proto.expressions_pb2.CommonInlineUserDefinedFunction:
        """(Required) Input user-defined function."""
        pass
    output_schema: typing.Text
    """(Required) Schema for the output DataFrame."""

    state_schema: typing.Text
...
class CommonInlineUserDefinedTableFunction(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        python_udtf: typing.Optional[global___PythonUDTF] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["python_udtf"]]: ...
...
class PythonUDTF(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        return_type: typing.Optional[pyspark.sql.connect.proto.types_pb2.DataType] = ...,
        eval_type: builtins.int = ...,
        command: builtins.bytes = ...,
        python_ver: typing.Text = ...,
    ) -> None: ...
    ...
    ) -> typing.Optional[typing_extensions.Literal["return_type"]]: ...
...
class CommonInlineUserDefinedDataSource(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        name: typing.Text = ...,
        python_data_source: typing.Optional[global___PythonDataSource] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["python_data_source"]]: ...
...
class AsOfJoin(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        left: typing.Optional[global___Relation] = ...,
        right: typing.Optional[global___Relation] = ...,
        left_as_of: typing.Optional[pyspark.sql.connect.proto.expressions_pb2.Expression] = ...,
        right_as_of: typing.Optional[pyspark.sql.connect.proto.expressions_pb2.Expression] = ...,
        join_expr: typing.Optional[pyspark.sql.connect.proto.expressions_pb2.Expression] = ...,
        using_columns: typing.Optional[typing.Iterable[typing.Text]] = ...,
        join_type: typing.Text = ...,
        tolerance: typing.Optional[pyspark.sql.connect.proto.expressions_pb2.Expression] = ...,
        allow_exact_matches: builtins.bool = ...,
        direction: typing.Text = ...,
    ) -> None: ...
    def HasField(

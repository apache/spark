...
class ExecutePlanResponse(google.protobuf.message.Message):
    ...
    QUERY_OPERATION_ID_FIELD_NUMBER: builtins.int
    ...
    """
    query_operation_id: builtins.str
    """(Optional) For sequence executions: identifies which query in the sequence this response belongs to.
    This is set when the execution is part of a BatchListExecutePlan sequence.
    """
    @property
    ...
    def __init__(
        ...
        *,
        ...
        operation_id: builtins.str = ...,
        response_id: builtins.str = ...,
        query_operation_id: builtins.str | None = ...,
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_query_operation_id", b"_query_operation_id"]
    ) -> typing_extensions.Literal["query_operation_id"] | None: ...
    @typing.overload
    def WhichOneof(
...
class BatchListExecutePlanRequest(google.protobuf.message.Message):
    """Request to execute multiple sequences of plans in batch.
    Each sequence executes sequentially in its own thread, all sequences execute in parallel.
    """

    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    class PlanSequence(google.protobuf.message.Message):
        """A sequence of plans that execute sequentially"""

        DESCRIPTOR: google.protobuf.descriptor.Descriptor

        SEQUENCE_OPERATION_ID_FIELD_NUMBER: builtins.int
        PLAN_EXECUTIONS_FIELD_NUMBER: builtins.int
        sequence_operation_id: builtins.str
        """(Optional) Operation ID for the entire sequence.
        If not provided, a UUID will be generated by the server.
        The id must be an UUID string of the format `00112233-4455-6677-8899-aabbccddeeff`
        """
        @property
        def plan_executions(
            ...
            global___BatchListExecutePlanRequest.PlanExecution
        ]:
            """(Required) Plans to execute sequentially within this sequence"""
        def __init__(
            self,
            *,
            sequence_operation_id: builtins.str | None = ...,
            plan_executions: collections.abc.Iterable[
                global___BatchListExecutePlanRequest.PlanExecution
            ]
            | None = ...,
        ) -> None: ...
        def HasField(
            self,
            field_name: typing_extensions.Literal[
                "_sequence_operation_id",
                b"_sequence_operation_id",
                "sequence_operation_id",
                b"sequence_operation_id",
            ],
        ) -> builtins.bool: ...
        def ClearField(
            self,
        ...
        def WhichOneof(
            self,
            oneof_group: typing_extensions.Literal[
                "_sequence_operation_id", b"_sequence_operation_id"
            ],
        ) -> typing_extensions.Literal["sequence_operation_id"] | None: ...

    class PlanExecution(google.protobuf.message.Message):
        """A single plan execution within a sequence"""
        ...
        @property
        def plan(self) -> global___Plan:
            """(Required) The logical plan to execute."""
        operation_id: builtins.str
        """(Optional) Operation ID for this individual query.
        If not provided, a UUID will be generated by the server.
        The id must be an UUID string of the format `00112233-4455-6677-8899-aabbccddeeff`
        """
        @property
        def tags(
            ...
            """(Optional) Tags to be assigned to the operations."""
        def __init__(
            self,
            *,
            plan: global___Plan | None = ...,
    ...
    USER_CONTEXT_FIELD_NUMBER: builtins.int
    CLIENT_TYPE_FIELD_NUMBER: builtins.int
    PLAN_SEQUENCES_FIELD_NUMBER: builtins.int
    session_id: builtins.str
    """(Required) The session_id for which this batch execute is targeting."""
    client_observed_server_side_session_id: builtins.str
    """(Optional) Client-side observed server-side session ID."""
    @property
    def user_context(self) -> global___UserContext:
        """(Required) User context"""
    client_type: builtins.str
    """(Optional) An optional client-type identifier (e.g., "spark-sql", "pyspark")."""
    @property
    def plan_sequences(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___BatchListExecutePlanRequest.PlanSequence
    ]:
        """(Required) List of plan sequences to execute. Each sequence runs in parallel."""
    def __init__(
        self,
        *,
        session_id: builtins.str = ...,
        ...
        user_context: global___UserContext | None = ...,
        client_type: builtins.str | None = ...,
        plan_sequences: collections.abc.Iterable[global___BatchListExecutePlanRequest.PlanSequence]
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
...
global___BatchListExecutePlanRequest = BatchListExecutePlanRequest

class BatchListExecutePlanResponse(google.protobuf.message.Message):
    """Response for batch list execute plan request."""

    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    class SequenceResult(google.protobuf.message.Message):
        """Result for a single sequence execution"""
        ...
        SUCCESS_FIELD_NUMBER: builtins.int
        ERROR_MESSAGE_FIELD_NUMBER: builtins.int
        QUERY_OPERATION_IDS_FIELD_NUMBER: builtins.int
        sequence_operation_id: builtins.str
        """(Required) Operation ID for the entire sequence (reattach to this)"""
        success: builtins.bool
        """(Required) Whether the sequence was successfully submitted"""
        error_message: builtins.str
        """(Optional) Error message if submission failed"""
        @property
        def query_operation_ids(
            self,
        ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
            global___BatchListExecutePlanResponse.QueryOperationId
        ]:
            """(Required) Operation IDs for individual queries within the sequence"""
        def __init__(
            self,
            *,
            sequence_operation_id: builtins.str = ...,
            success: builtins.bool = ...,
            error_message: builtins.str | None = ...,
            query_operation_ids: collections.abc.Iterable[
                global___BatchListExecutePlanResponse.QueryOperationId
            ]
            | None = ...,
        ) -> None: ...
    ...
    class QueryOperationId(google.protobuf.message.Message):
        """Query operation ID with its index in the sequence"""
        ...
        operation_id: builtins.str
        """(Required) Operation ID for this individual query"""
        query_index: builtins.int
        """(Required) Index of this query in the sequence (0-based)"""
        def __init__(
            self,
            *,
            operation_id: builtins.str = ...,
        ...
        def ClearField(
            self,
            field_name: typing_extensions.Literal[
                "operation_id", b"operation_id", "query_index", b"query_index"
            ],
        ) -> None: ...

    SESSION_ID_FIELD_NUMBER: builtins.int
    SERVER_SIDE_SESSION_ID_FIELD_NUMBER: builtins.int
    SEQUENCE_RESULTS_FIELD_NUMBER: builtins.int
    session_id: builtins.str
    """Session id in which the batch was executed."""
    server_side_session_id: builtins.str
    """Server-side generated idempotency key for the session."""
    ...
    def sequence_results(
        ...
        global___BatchListExecutePlanResponse.SequenceResult
    ]:
        """Results for each sequence in the same order as the request"""
    def __init__(
        self,
        *,
        session_id: builtins.str = ...,
        server_side_session_id: builtins.str = ...,
        sequence_results: collections.abc.Iterable[
            global___BatchListExecutePlanResponse.SequenceResult
        ]
        | None = ...,
    ) -> None: ...
...
global___BatchListExecutePlanResponse = BatchListExecutePlanResponse

...
class Plan(google.protobuf.message.Message):
    ...
    ) -> typing.Literal["root", "command", "compressed_operation"] | None: ...
...
class AnalyzePlanRequest(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["analyze", b"analyze"]) -> (
        typing.Literal[
            "schema",
            "explain",
            "tree_string",
...
class AnalyzePlanResponse(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing.Literal["result", b"result"]) -> (
        typing.Literal[
            "schema",
            "explain",
            "tree_string",
...
class ExecutePlanRequest(google.protobuf.message.Message):
    ...
    class RequestOption(google.protobuf.message.Message):
        ...
        ) -> typing.Literal["reattach_options", "result_chunking_options", "extension"] | None: ...
...
class ExecutePlanResponse(google.protobuf.message.Message):
    ...
    class ArrowBatch(google.protobuf.message.Message):
        ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_chunk_index", b"_chunk_index"]
        ) -> typing.Literal["chunk_index"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_num_chunks_in_batch", b"_num_chunks_in_batch"]
        ) -> typing.Literal["num_chunks_in_batch"] | None: ...
        @typing.overload
        def WhichOneof(
    ...
    def WhichOneof(self, oneof_group: typing.Literal["response_type", b"response_type"]) -> (
        typing.Literal[
            "arrow_batch",
            "sql_command_result",
            "write_stream_operation_start_result",
...
class ResultChunkingOptions(google.protobuf.message.Message):
    ...
    def WhichOneof(
        self,
        oneof_group: typing.Literal["_preferred_arrow_chunk_size", b"_preferred_arrow_chunk_size"],
    ) -> typing.Literal["preferred_arrow_chunk_size"] | None: ...
...
class FetchErrorDetailsResponse(google.protobuf.message.Message):
    ...
    class SparkThrowable(google.protobuf.message.Message):
        ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_breaking_change_info", b"_breaking_change_info"]
        ) -> typing.Literal["breaking_change_info"] | None: ...
        @typing.overload
        def WhichOneof(
    ...
    class BreakingChangeInfo(google.protobuf.message.Message):
        ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_mitigation_config", b"_mitigation_config"]
        ) -> typing.Literal["mitigation_config"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_needs_audit", b"_needs_audit"]
        ) -> typing.Literal["needs_audit"] | None: ...
...
class CloneSessionRequest(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_new_session_id", b"_new_session_id"]
    ) -> typing.Literal["new_session_id"] | None: ...
...
class GetStatusRequest(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_operation_status", b"_operation_status"]
    ) -> typing.Literal["operation_status"] | None: ...

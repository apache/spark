...
class ExecutePlanRequest(google___protobuf___message___Message):
    ...
    class RequestOption(google___protobuf___message___Message):
        DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
        ...
        def WhichOneof(
            self, oneof_group: typing_extensions___Literal["request_option", b"request_option"]
        ) -> typing_extensions___Literal["extension"]: ...
    type___RequestOption = RequestOption
    ...
    def request_options(
        ...
        type___ExecutePlanRequest.RequestOption
    ]: ...
    def __init__(
        self,
        *,
        ...
        plan: typing___Optional[type___Plan] = None,
        client_type: typing___Optional[typing___Text] = None,
        request_options: typing___Optional[
            typing___Iterable[type___ExecutePlanRequest.RequestOption]
        ] = None,
    ) -> None: ...
    def HasField(
        self,

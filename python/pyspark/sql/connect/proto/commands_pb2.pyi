...
class CreateScalarFunction(google.protobuf.message.Message):
    ...
    def argument_types(
        ...
        spark.connect.types_pb2.Type
    ]: ...
    @property
    def return_type(self) -> spark.connect.types_pb2.Type: ...
    ...
    def __init__(
        ...
        *,
        ...
        language: global___CreateScalarFunction.FunctionLanguage.ValueType = ...,
        temporary: builtins.bool = ...,
        argument_types: collections.abc.Iterable[spark.connect.types_pb2.Type] | None = ...,
        return_type: spark.connect.types_pb2.Type | None = ...,
        serialized_function: builtins.bytes = ...,
        literal_string: builtins.str = ...,
    ) -> None: ...
    def HasField(

...
class Command(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        register_function: typing.Optional[
            pyspark.sql.connect.proto.expressions_pb2.CommonInlineUserDefinedFunction
        ] = ...,
        write_operation: typing.Optional[global___WriteOperation] = ...,
        create_dataframe_view: typing.Optional[global___CreateDataFrameViewCommand] = ...,
        write_operation_v2: typing.Optional[global___WriteOperationV2] = ...,
        sql_command: typing.Optional[global___SqlCommand] = ...,
        write_stream_operation_start: typing.Optional[global___WriteStreamOperationStart] = ...,
        streaming_query_command: typing.Optional[global___StreamingQueryCommand] = ...,
        get_resources_command: typing.Optional[global___GetResourcesCommand] = ...,
        streaming_query_manager_command: typing.Optional[
            global___StreamingQueryManagerCommand
        ] = ...,
        register_table_function: typing.Optional[
            pyspark.sql.connect.proto.relations_pb2.CommonInlineUserDefinedTableFunction
        ] = ...,
        streaming_query_listener_bus_command: typing.Optional[
            global___StreamingQueryListenerBusCommand
        ] = ...,
        register_data_source: typing.Optional[
            pyspark.sql.connect.proto.relations_pb2.CommonInlineUserDefinedDataSource
        ] = ...,
        create_resource_profile_command: typing.Optional[
            global___CreateResourceProfileCommand
        ] = ...,
        checkpoint_command: typing.Optional[global___CheckpointCommand] = ...,
        remove_cached_remote_relation_command: typing.Optional[
            global___RemoveCachedRemoteRelationCommand
        ] = ...,
        merge_into_table_command: typing.Optional[global___MergeIntoTableCommand] = ...,
        ml_command: typing.Optional[pyspark.sql.connect.proto.ml_pb2.MlCommand] = ...,
        execute_external_command: typing.Optional[global___ExecuteExternalCommand] = ...,
        pipeline_command: typing.Optional[
            pyspark.sql.connect.proto.pipelines_pb2.PipelineCommand
        ] = ...,
...
class SqlCommand(google.protobuf.message.Message):
    ...
    class NamedArgumentsEntry(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            key: typing.Text = ...,
            value: typing.Optional[pyspark.sql.connect.proto.expressions_pb2.Expression] = ...,
        ) -> None: ...
        def HasField(
            self, field_name: typing_extensions.Literal["value", b"value"]
        ) -> builtins.bool: ...
    ...
    def named_arguments(
        ...
        typing.Text, pyspark.sql.connect.proto.expressions_pb2.Expression
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        pos_args: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression.Literal]
        ] = ...,
        named_arguments: typing.Optional[
            typing.Mapping[typing.Text, pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
        pos_arguments: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
...
class WriteOperation(google.protobuf.message.Message):
    ...
    class BucketBy(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            bucket_column_names: typing.Optional[typing.Iterable[typing.Text]] = ...,
            num_buckets: builtins.int = ...,
        ) -> None: ...
        def ClearField(
            self,
    ...
    def __init__(
        ...
        *,
        ...
        path: typing.Text = ...,
        table: typing.Optional[global___WriteOperation.SaveTable] = ...,
        mode: global___WriteOperation.SaveMode.ValueType = ...,
        sort_column_names: typing.Optional[typing.Iterable[typing.Text]] = ...,
        partitioning_columns: typing.Optional[typing.Iterable[typing.Text]] = ...,
        bucket_by: typing.Optional[global___WriteOperation.BucketBy] = ...,
    ...
    ) -> typing.Optional[typing_extensions.Literal["path", "table"]]: ...
...
class WriteOperationV2(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        partitioning_columns: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
        options: typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        table_properties: typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        mode: global___WriteOperationV2.Mode.ValueType = ...,
        overwrite_condition: typing.Optional[
            pyspark.sql.connect.proto.expressions_pb2.Expression
        ] = ...,
        clustering_columns: typing.Optional[typing.Iterable[typing.Text]] = ...,
        with_schema_evolution: builtins.bool = ...,
    ...
    ) -> typing.Optional[typing_extensions.Literal["provider"]]: ...
...
class WriteStreamOperationStart(google.protobuf.message.Message):
    ...
    processing_time_interval: typing.Text
    available_now: builtins.bool
    once: builtins.bool
    continuous_checkpoint_interval: typing.Text
    real_time_batch_duration: typing.Text
    output_mode: typing.Text
    query_name: typing.Text
    path: typing.Text
    table_name: typing.Text
    @property
    ...
    def __init__(
        ...
        *,
        ...
        format: typing.Text = ...,
        options: typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        partitioning_column_names: typing.Optional[typing.Iterable[typing.Text]] = ...,
        processing_time_interval: typing.Text = ...,
        available_now: builtins.bool = ...,
        once: builtins.bool = ...,
        continuous_checkpoint_interval: typing.Text = ...,
        ...
        path: typing.Text = ...,
        table_name: typing.Text = ...,
        foreach_writer: typing.Optional[global___StreamingForeachFunction] = ...,
        foreach_batch: typing.Optional[global___StreamingForeachFunction] = ...,
        clustering_column_names: typing.Optional[typing.Iterable[typing.Text]] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["path", "table_name"]]: ...
    @typing.overload
    def WhichOneof(
...
class StreamingForeachFunction(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        python_function: typing.Optional[pyspark.sql.connect.proto.expressions_pb2.PythonUDF] = ...,
        scala_function: typing.Optional[
    ...
    ) -> typing.Optional[typing_extensions.Literal["python_function", "scala_function"]]: ...
...
class WriteStreamOperationStartResult(google.protobuf.message.Message):
    ...
    query_started_event_json: typing.Text
    """Optional query started event if there is any listener registered on the client side."""

    def __init__(
        self,
        *,
        query_id: typing.Optional[global___StreamingQueryInstanceId] = ...,
        name: typing.Text = ...,
        query_started_event_json: typing.Optional[typing.Text] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["query_started_event_json"]]: ...
...
class StreamingQueryCommand(google.protobuf.message.Message):
    ...
    class AwaitTerminationCommand(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            timeout_ms: typing.Optional[builtins.int] = ...,
        ) -> None: ...
        def HasField(
            self,
            field_name: typing_extensions.Literal[
        ...
        ) -> typing.Optional[typing_extensions.Literal["timeout_ms"]]: ...
    ...
    def __init__(
        ...
        *,
        ...
        stop: builtins.bool = ...,
        process_all_available: builtins.bool = ...,
        explain: typing.Optional[global___StreamingQueryCommand.ExplainCommand] = ...,
        exception: builtins.bool = ...,
        await_termination: typing.Optional[
            global___StreamingQueryCommand.AwaitTerminationCommand
        ] = ...,
    ) -> None: ...
    def HasField(
        self,
...
class StreamingQueryCommandResult(google.protobuf.message.Message):
    ...
    class RecentProgressResult(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            recent_progress_json: typing.Optional[typing.Iterable[typing.Text]] = ...,
        ) -> None: ...
        def ClearField(
            self,
    ...
    class ExceptionResult(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            exception_message: typing.Optional[typing.Text] = ...,
            error_class: typing.Optional[typing.Text] = ...,
            stack_trace: typing.Optional[typing.Text] = ...,
        ) -> None: ...
        def HasField(
            self,
            field_name: typing_extensions.Literal[
        ...
        ) -> typing.Optional[typing_extensions.Literal["exception_message"]]: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing_extensions.Literal["_stack_trace", b"_stack_trace"]
        ) -> typing.Optional[typing_extensions.Literal["stack_trace"]]: ...
    ...
    def __init__(
        ...
        *,
        query_id: typing.Optional[global___StreamingQueryInstanceId] = ...,
        status: typing.Optional[global___StreamingQueryCommandResult.StatusResult] = ...,
        recent_progress: typing.Optional[
            global___StreamingQueryCommandResult.RecentProgressResult
        ] = ...,
        explain: typing.Optional[global___StreamingQueryCommandResult.ExplainResult] = ...,
        exception: typing.Optional[global___StreamingQueryCommandResult.ExceptionResult] = ...,
        await_termination: typing.Optional[
            global___StreamingQueryCommandResult.AwaitTerminationResult
        ] = ...,
    ) -> None: ...
    def HasField(
        self,
...
class StreamingQueryManagerCommand(google.protobuf.message.Message):
    ...
    class StreamingQueryListenerCommand(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            listener_payload: builtins.bytes = ...,
            python_listener_payload: typing.Optional[
                pyspark.sql.connect.proto.expressions_pb2.PythonUDF
            ] = ...,
            id: typing.Text = ...,
        ) -> None: ...
        ...
        ) -> typing.Optional[typing_extensions.Literal["python_listener_payload"]]: ...
    ...
    def __init__(
        ...
        *,
        active: builtins.bool = ...,
        get_query: typing.Text = ...,
        await_any_termination: typing.Optional[
            global___StreamingQueryManagerCommand.AwaitAnyTerminationCommand
        ] = ...,
        reset_terminated: builtins.bool = ...,
        add_listener: typing.Optional[
            global___StreamingQueryManagerCommand.StreamingQueryListenerCommand
        ] = ...,
        remove_listener: typing.Optional[
            global___StreamingQueryManagerCommand.StreamingQueryListenerCommand
        ] = ...,
        list_listeners: builtins.bool = ...,
    ) -> None: ...
...
class StreamingQueryManagerCommandResult(google.protobuf.message.Message):
    ...
    class ActiveResult(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            active_queries: typing.Optional[
                typing.Iterable[global___StreamingQueryManagerCommandResult.StreamingQueryInstance]
            ] = ...,
        ) -> None: ...
        def ClearField(
    ...
    class StreamingQueryInstance(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            id: typing.Optional[global___StreamingQueryInstanceId] = ...,
        ...
        ) -> typing.Optional[typing_extensions.Literal["name"]]: ...
    ...
    class ListStreamingQueryListenerResult(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            listener_ids: typing.Optional[typing.Iterable[typing.Text]] = ...,
        ) -> None: ...
        def ClearField(
    ...
    def __init__(
        self,
        *,
        active: typing.Optional[global___StreamingQueryManagerCommandResult.ActiveResult] = ...,
        ...
        add_listener: builtins.bool = ...,
        remove_listener: builtins.bool = ...,
        list_listeners: typing.Optional[
            global___StreamingQueryManagerCommandResult.ListStreamingQueryListenerResult
        ] = ...,
    ) -> None: ...
    def HasField(
...
class StreamingQueryListenerEventsResult(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        events: typing.Optional[typing.Iterable[global___StreamingQueryListenerEvent]] = ...,
        listener_bus_listener_added: typing.Optional[builtins.bool] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["listener_bus_listener_added"]]: ...
...
class GetResourcesCommandResult(google.protobuf.message.Message):
    ...
    class ResourcesEntry(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            key: typing.Text = ...,
            value: typing.Optional[pyspark.sql.connect.proto.common_pb2.ResourceInformation] = ...,
        ) -> None: ...
        def HasField(
            self, field_name: typing_extensions.Literal["value", b"value"]
        ) -> builtins.bool: ...
    ...
    def resources(
        ...
        typing.Text, pyspark.sql.connect.proto.common_pb2.ResourceInformation
    ]: ...
    def __init__(
        self,
        *,
        resources: typing.Optional[
            typing.Mapping[typing.Text, pyspark.sql.connect.proto.common_pb2.ResourceInformation]
        ] = ...,
    ) -> None: ...
    def ClearField(
...
class CreateResourceProfileCommand(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        profile: typing.Optional[pyspark.sql.connect.proto.common_pb2.ResourceProfile] = ...,
    ) -> None: ...
    def HasField(
...
class MergeIntoTableCommand(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        target_table_name: typing.Text = ...,
        source_table_plan: typing.Optional[pyspark.sql.connect.proto.relations_pb2.Relation] = ...,
        merge_condition: typing.Optional[
            pyspark.sql.connect.proto.expressions_pb2.Expression
        ] = ...,
        match_actions: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
        not_matched_actions: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
        not_matched_by_source_actions: typing.Optional[
            typing.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        ] = ...,
        with_schema_evolution: builtins.bool = ...,
    ) -> None: ...

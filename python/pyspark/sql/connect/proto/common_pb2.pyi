...
class ExecutorResourceRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        resource_name: typing.Text = ...,
        amount: builtins.int = ...,
        discovery_script: typing.Optional[typing.Text] = ...,
    ...
    ) -> typing.Optional[typing_extensions.Literal["discovery_script"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_vendor", b"_vendor"]
    ) -> typing.Optional[typing_extensions.Literal["vendor"]]: ...
...
class ResourceProfile(google.protobuf.message.Message):
    ...
    class ExecutorResourcesEntry(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            key: typing.Text = ...,
            value: typing.Optional[global___ExecutorResourceRequest] = ...,
        ) -> None: ...
        def HasField(
    ...
    class TaskResourcesEntry(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            key: typing.Text = ...,
            value: typing.Optional[global___TaskResourceRequest] = ...,
        ) -> None: ...
        def HasField(
            self, field_name: typing_extensions.Literal["value", b"value"]
        ) -> builtins.bool: ...
    ...
    def executor_resources(
        ...
        typing.Text, global___ExecutorResourceRequest
    ]:
    ...
    def task_resources(
        self,
    ) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___TaskResourceRequest]:
    ...
    def __init__(
        self,
        *,
        executor_resources: typing.Optional[
            typing.Mapping[typing.Text, global___ExecutorResourceRequest]
        ] = ...,
        task_resources: typing.Optional[
            typing.Mapping[typing.Text, global___TaskResourceRequest]
        ] = ...,
    ) -> None: ...
    def ClearField(
        self,
...
class Origin(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        python_origin: typing.Optional[global___PythonOrigin] = ...,
        jvm_origin: typing.Optional[global___JvmOrigin] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["python_origin", "jvm_origin"]]: ...
...
class JvmOrigin(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        start_position: typing.Optional[builtins.int] = ...,
        start_index: typing.Optional[builtins.int] = ...,
        stop_index: typing.Optional[builtins.int] = ...,
        sql_text: typing.Optional[typing.Text] = ...,
        object_type: typing.Optional[typing.Text] = ...,
        object_name: typing.Optional[typing.Text] = ...,
        stack_trace: typing.Optional[typing.Iterable[global___StackTraceElement]] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    ) -> typing.Optional[typing_extensions.Literal["line"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_object_name", b"_object_name"]
    ) -> typing.Optional[typing_extensions.Literal["object_name"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_object_type", b"_object_type"]
    ) -> typing.Optional[typing_extensions.Literal["object_type"]]: ...
    @typing.overload
    def WhichOneof(
    ...
    ) -> typing.Optional[typing_extensions.Literal["start_index"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_start_position", b"_start_position"]
    ) -> typing.Optional[typing_extensions.Literal["start_position"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_stop_index", b"_stop_index"]
    ) -> typing.Optional[typing_extensions.Literal["stop_index"]]: ...
...
class StackTraceElement(google.protobuf.message.Message):
    ...
    class_loader_name: typing.Text
    """(Optional) Class loader name"""

    module_name: typing.Text
    """(Optional) Module name"""

    module_version: typing.Text
    ...
    def __init__(
        self,
        *,
        class_loader_name: typing.Optional[typing.Text] = ...,
        module_name: typing.Optional[typing.Text] = ...,
        module_version: typing.Optional[typing.Text] = ...,
        declaring_class: typing.Text = ...,
        method_name: typing.Text = ...,
    ...
    ) -> typing.Optional[typing_extensions.Literal["class_loader_name"]]: ...
    @typing.overload
    def WhichOneof(
    ...
    ) -> typing.Optional[typing_extensions.Literal["module_name"]]: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_module_version", b"_module_version"]
    ) -> typing.Optional[typing_extensions.Literal["module_version"]]: ...
...
class ResolvedIdentifier(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        catalog_name: typing.Text = ...,
        namespace: typing.Optional[typing.Iterable[typing.Text]] = ...,
        table_name: typing.Text = ...,
    ) -> None: ...
    def ClearField(
        self,

...
class LogicalPlan(object):
    ...
    def to_attr_or_expression(
        self, col: "ColumnOrName", session: "SparkSession"
    ) -> proto.Expression:
    ...
    def plan(self, session: "SparkSession") -> proto.Relation:
        ...

    def command(self, session: "SparkSession") -> proto.Command:
        ...

    def _verify(self, session: "SparkSession") -> bool:
    ...
    def to_proto(self, session: "SparkSession", debug: bool = False) -> proto.Plan:
        """
        Generates connect proto plan based on this LogicalPlan.

        Parameters
        ----------
        session : :class:`SparkSession`, optional.
...
class Sort(LogicalPlan):
    ...
    def col_to_sort_field(
        self, col: Union[SortOrder, Column, str], session: "SparkSession"
...
class Drop(LogicalPlan):
    ...
    def _convert_to_expr(
        self, col: Union[Column, str], session: "SparkSession"
    ) -> proto.Expression:
...
class Aggregate(LogicalPlan):
    ...
    def _convert_measure(self, m: MeasureType, session: "SparkSession") -> proto.Expression:
        exp, fun = m

...
from pyspark.sql.connect.plan import DataSource, LogicalPlan, Read, ReadChanges, WriteStreamOperation
...
class DataStreamReader(OptionUtils):
    ...
    def changes(self, tableName: str) -> "DataFrame":
        return self._df(ReadChanges(tableName, self._options, is_streaming=True))

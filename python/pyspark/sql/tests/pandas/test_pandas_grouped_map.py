...
class ApplyInPandasWithWorkerOutputBatchSlicingTests(ApplyInPandasTests):
    ...
    def setUpClass(cls):
        ...
        # Deliberately tiny so every non-trivial group's output batch is split by the worker
        # before it is sent to the JVM. Re-running the suite verifies the split preserves results.

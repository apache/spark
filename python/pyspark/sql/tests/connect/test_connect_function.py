...
class SparkConnectFunctionTests(ReusedMixedTestCase, PandasOnSparkTestUtils):
    ...
    def test_window_functions(self):
        ...
        for ccol, scol in [
            ...
            # NaN defaults require a floating-point column; c is decimal.
            (CF.lag(cdf.b, -1, float("nan")), SF.lag(sdf.b, -1, float("nan"))),
            (CF.lead("c", 1), SF.lead("c", 1)),
            (CF.lead("c", 1, -1.0), SF.lead("c", 1, -1.0)),
            (CF.lead(cdf.c, -1), SF.lead(sdf.c, -1)),
            (CF.lead(cdf.b, -1, float("nan")), SF.lead(sdf.b, -1, float("nan"))),

...
class Window(object):
    ...
    def partitionBy(*cols: Union["ColumnOrName", List["ColumnOrName"]]) -> "WindowSpec":
        ...
        sc = SparkContext._active_spark_context  # type: ignore[attr-defined]
        jspec = \
            sc._jvm.org.apache.spark.sql.expressions.Window.partitionBy(  # type: ignore[union-attr]
                _to_java_cols(cols))
    ...
    def orderBy(*cols: Union["ColumnOrName", List["ColumnOrName"]]) -> "WindowSpec":
        ...
        """
        sc = SparkContext._active_spark_context  # type: ignore[attr-defined]
        jspec = sc._jvm.org.apache.spark.sql.expressions.Window.orderBy(  # type: ignore[union-attr]
            _to_java_cols(cols))
        return WindowSpec(jspec)
    ...
    def rowsBetween(start: int, end: int) -> "WindowSpec":
        ...
        sc = SparkContext._active_spark_context  # type: ignore[attr-defined]
        jspec = \
            sc._jvm.org.apache.spark.sql.expressions.Window.rowsBetween(  # type: ignore[union-attr]
                start, end)
        return WindowSpec(jspec)
    ...
    def rangeBetween(start: int, end: int) -> "WindowSpec":
        ...
        sc = SparkContext._active_spark_context  # type: ignore[attr-defined]
        jspec = (
            sc._jvm  # type: ignore[union-attr]

...
class HasCheckpointInterval(Params):
    ...
    # a placeholder to make it appear in the generated doc
    checkpointInterval = Param(Params._dummy(), "checkpointInterval", "checkpoint interval (>= 1).", int)

    def __init__(self):
        super(HasCheckpointInterval, self).__init__()
        #: param for checkpoint interval (>= 1).
        self.checkpointInterval = Param(self, "checkpointInterval", "checkpoint interval (>= 1).", int)

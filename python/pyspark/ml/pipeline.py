...
class Pipeline(Estimator, MLReadable, MLWritable):
    ...
    def _from_java(cls, java_stage):
        ...
        py_stages = [JavaWrapperParams._from_java(s) for s in java_stage.getStages()]
    ...
    def _to_java(self):
        ...
        _java_obj = JavaWrapperParams._new_java_obj("org.apache.spark.ml.Pipeline", self.uid)
...
class PipelineModel(Model, MLReadable, MLWritable):
    ...
    def _from_java(cls, java_stage):
        ...
        """
        # Load information from java_stage to the instance.
        py_stages = [JavaWrapperParams._from_java(s) for s in java_stage.stages()]
        # Create a new instance of this stage.
    ...
    def _to_java(self):
        ...
        _java_obj = JavaWrapperParams._new_java_obj("org.apache.spark.ml.PipelineModel",
                                                    self.uid,
                                                    java_stages)

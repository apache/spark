...
class CrossValidatorTestsMixin:
    ...
    def test_crossvalidator_on_pipeline(self):
        ...
        grid2 = ParamGridBuilder().addGrid(lorv2.maxIter, [2, 20]).build()
        cv = CrossValidator(
            estimator=pipeline,
        ...
        assert cv_model.bestModel.stages[1].getMaxIter() == 20
        ...
        with tempfile.TemporaryDirectory(prefix="test_crossvalidator_on_pipeline") as tmp_dir:
            ...
            assert loaded_cv_model.bestModel.stages[1].getMaxIter() == 20

...
class Bucketizer(
    ...
    @since("3.4.1")
    def setIncludeLowest(self, value: bool) -> "Bucketizer":
        """
        Sets the value of :py:attr:`includeLowest`.
        """
        return self._set(includeLowest=value)

    @since("3.4.1")
    def getIncludeLowest(self) -> bool:
        """
        Gets the value of include lowest or its default value.
        """

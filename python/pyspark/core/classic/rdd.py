...
from pyspark.core.rdd import RDD as RDDFacade, RDDBarrier
...
class RDD(RDDFacade, Generic[T_co]):
    """
    ...
    def __new__(cls, *args: Any, **kwargs: Any) -> Any:
        # Parent RDD by default dispatches to this classic implementation. Use object.__new__
    ...
    def randomSplit(
        ...
        return cast(List[RDDFacade[Any]], splits)
    ...
    def union(self: "RDD[T]", other: "RDDFacade[U]") -> "RDD[Union[T, U]]":
        """
    ...
    def intersection(self: "RDD[T]", other: "RDDFacade[T]") -> "RDD[T]":
        """
    ...
    def __add__(self: "RDD[T]", other: "RDDFacade[U]") -> "RDD[Union[T, U]]":
        """
        Return the union of this RDD and another one.
    ...
    def cartesian(self: "RDD[T]", other: "RDDFacade[U]") -> "RDD[Tuple[T, U]]":
        """
    ...
    @overload
    def groupWith(
        self: "RDD[Tuple[Any, V]]", other: "RDDFacade[Tuple[Any, V1]]", /
    ) -> "RDD[Tuple[Any, Tuple[ResultIterable[V], ResultIterable[V1]]]]": ...

    @overload
    def groupWith(
        self: "RDD[Tuple[Any, V]]",
        other: "RDDFacade[Tuple[Any, V1]]",
        __o1: "RDDFacade[Tuple[Any, V2]]",
        /,
    ) -> "RDD[Tuple[Any, Tuple[ResultIterable[V], ResultIterable[V1], ResultIterable[V2]]]]": ...

    @overload
    def groupWith(
        self: "RDD[Tuple[Any, V]]",
        other: "RDDFacade[Tuple[Any, V1]]",
        _o1: "RDDFacade[Tuple[Any, V2]]",
        _o2: "RDDFacade[Tuple[Any, V3]]",
        /,
    ) -> """RDD[
        Tuple[
            Any,
    ...
    def groupWith(
        self: "RDD[Tuple[Any, Any]]",
        other: "RDDFacade[Tuple[Any, Any]]",
        /,
        *others: "RDDFacade[Tuple[Any, Any]]",
    ...
    def subtract(
        self: "RDD[T]", other: "RDDFacade[T]", numPartitions: Optional[int] = None
    ) -> "RDD[T]":
        """
    ...
    def zip(self: "RDD[T]", other: "RDDFacade[U]") -> "RDD[Tuple[T, U]]":
        """
        ...
        def batch_as(rdd: "RDDFacade[Any]", batchSize: int) -> "RDD[Any]":
            return cast(
                "RDD[Any]",
                rdd._reserialize(BatchedSerializer(CPickleSerializer(), batchSize)),
            )
...
class ClassicRDDBarrier(RDDBarrier[T]):
    """RDD barrier stage implementation for Spark Classic (JVM / PythonRDD pipeline)."""
    ...
    def mapPartitions(
        ...
        ...
        >>> barrier = rdd.barrier()
        >>> isinstance(barrier, RDDBarrier)
        True
        >>> barrier.mapPartitions(f).collect()
        [3, 7]
        """

        def func(_split: int, iterator: Iterable[T]) -> Iterable[U]:
            return f(iterator)

        if not isinstance(self.rdd, RDD):
            raise TypeError(f"RDD barrier not supported for {type(self.rdd)!r}")
...
# Preserve classic RDD repr/import path pyspark.core.rdd.
RDD.__module__ = "pyspark.core.rdd"

...
from pyspark.pandas.tests.frame.test_frame_compute import FrameComputeMixin
...
if __name__ == "__main__":
    from pyspark.pandas.tests.connect.frame.test_parity_frame_compute import *  # noqa: F401

...
from pyspark.pandas.tests.frame.test_frame_indexing import FrameIndexingMixin
...
if __name__ == "__main__":
    from pyspark.pandas.tests.connect.frame.test_parity_frame_indexing import *  # noqa: F401

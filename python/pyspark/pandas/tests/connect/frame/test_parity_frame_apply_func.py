...
from pyspark.pandas.tests.frame.test_frame_apply_func import FrameApplyFunctionMixin
...
if __name__ == "__main__":
    from pyspark.pandas.tests.connect.frame.test_parity_frame_apply_func import *  # noqa: F401

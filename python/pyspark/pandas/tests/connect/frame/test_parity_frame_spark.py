...
from pyspark.pandas.tests.frame.test_frame_spark import FrameSparkMixin
...
if __name__ == "__main__":
    from pyspark.pandas.tests.connect.frame.test_parity_frame_spark import *  # noqa: F401

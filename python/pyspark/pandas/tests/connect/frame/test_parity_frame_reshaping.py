...
from pyspark.pandas.tests.frame.test_frame_reshaping import FrameReshapingMixin
...
if __name__ == "__main__":
    from pyspark.pandas.tests.connect.frame.test_parity_frame_reshaping import *  # noqa: F401

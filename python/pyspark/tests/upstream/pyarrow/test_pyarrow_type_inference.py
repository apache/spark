...
2. Python list - Plain Python lists (includes edge cases: non-English, boundaries, NaN/Inf)
3. Python tuple - Plain Python tuples
4. Python dict - Plain Python dicts (inferred as struct)
5. Pandas Series (numpy-backed, includes edge cases)
6. Pandas nullable extension types
7. Pandas ArrowDtype
8. NumPy array (includes boundary values)
9. Nested list types
10. Explicit type specification

Edge cases tested within normal tests:
- String: Non-English (CJK, Emoji, Arabic, etc.), Unicode special chars
- Integer: Min/max values, boundaries, overflow behavior
- Float: NaN, Inf, -Inf, epsilon, max/min
- Temporal: Unix epoch, date/time min/max
"""

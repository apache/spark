...
class SerializationTestCase(unittest.TestCase):
    ...
    def test_compressed_serializer(self):
        ...
        io = StringIO()
        ser.dump_stream(["abc", u"123", list(range(5))], io)
        io.seek(0)
        self.assertEqual(["abc", u"123", list(range(5))], list(ser.load_stream(io)))
        ser.dump_stream(range(1000), io)
        io.seek(0)
        self.assertEqual(["abc", u"123", list(range(5))] + list(range(1000)), list(ser.load_stream(io)))
        io.close()

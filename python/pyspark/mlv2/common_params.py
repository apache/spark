...
class HasUseGPU(Params):
    """
    Mixin for param useGPU
    """

    useGPU: "Param[bool]" = Param(
        Params._dummy(),
        "useGPU",
        "use GPU or not",
    ...
    def __init__(self) -> None:
        super(HasUseGPU, self).__init__()

    def getUseGPU(self) -> int:
        """
        Gets the value of useGPU or its default value.
        """
        return self.getOrDefault(self.useGPU)

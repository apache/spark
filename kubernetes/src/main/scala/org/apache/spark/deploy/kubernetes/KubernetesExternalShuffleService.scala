...
/**
  ...
  */
private[kubernetes] class KubernetesExternalShuffleBlockHandler(
...
/**
  ...
  */
private[kubernetes] class KubernetesExternalShuffleService(
    conf: SparkConf,
...
private[spark] object KubernetesExternalShuffleService extends Logging {
  def main(args: Array[String]): Unit = {
    ExternalShuffleService.main(
      args,
      (conf: SparkConf,
       sm: SecurityManager) => new KubernetesExternalShuffleService(conf, sm))
  }
}

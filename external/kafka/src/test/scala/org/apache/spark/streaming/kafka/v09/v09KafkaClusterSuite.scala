...
import org.apache.spark.streaming.kafka.{KafkaTestUtils, v09}
import org.scalatest.BeforeAndAfterAll

import scala.util.Random

class v09KafkaClusterSuite extends SparkFunSuite with BeforeAndAfterAll {
  private val topic = "new_kcsuitetopic" + Random.nextInt(10000)
  private val topicPartition = TopicAndPartition(topic, 0)
  private var newKc: v09.KafkaCluster[_, _] = null

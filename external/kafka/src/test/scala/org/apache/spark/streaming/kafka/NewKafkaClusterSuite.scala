...
class NewKafkaClusterSuite extends SparkFunSuite with BeforeAndAfterAll {
  private val topic = "kcsuitetopic" + Random.nextInt(10000)
  private val topicPartition = new TopicPartition(topic, 0)
  private var newKc: NewKafkaCluster[_, _] = null
  ...
  override def beforeAll() {
    ...
    val kafkaParams = Map(
      ...
      ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG ->
        "org.apache.kafka.common.serialization.StringDeserializer")
    newKc = new NewKafkaCluster(kafkaParams)
  }

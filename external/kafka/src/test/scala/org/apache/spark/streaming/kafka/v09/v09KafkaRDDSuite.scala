...
import org.apache.spark.streaming.kafka.{HasOffsetRanges, KafkaTestUtils, KafkaUtils, OffsetRange}
import org.scalatest.BeforeAndAfterAll

import scala.util.Random

class v09KafkaRDDSuite extends SparkFunSuite with BeforeAndAfterAll {

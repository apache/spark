...
class KafkaDataConsumerSuite
  ...
  test("new KafkaDataConsumer instance in case of Task retry") {
    try {
      ...
      val context1 = new TaskContextImpl(0, 0, 0, 0, 0, "testTask", null, null, null)
      TaskContext.setTaskContext(context1)
      val consumer1Underlying = initSingleConsumer(kafkaParams, key)

      val context2 = new TaskContextImpl(0, 0, 0, 0, 1, "testTask", null, null, null)
  ...
  test("same KafkaDataConsumer instance in case of same token") {
    try {
      ...
      val context = new TaskContextImpl(0, 0, 0, 0, 0, "testTask", null, null, null)

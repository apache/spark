 ...
 * Usage: JavaDirectNewKafkaWordCount <brokers> <topics>
 *   <brokers> is a list of one or more Kafka brokers
 *   <topics> is a list of one or more kafka topics to consume from
 *   <poll time> time, in milliseconds, spent waiting in Kafka consumer poll if data isn't available
 *
 * Example:
 *    $ bin/run-example streaming.kafka.newapi.examples.JavaDirectNewKafkaWordCount
 *    broker1-host:port,broker2-host:port topic1,topic2 pollTime
 */

public final class JavaDirectNewKafkaWordCount {
  private static final Pattern SPACE = Pattern.compile(" ");

  public static void main(String[] args) {
    if (args.length < 2) {
      System.err.println("Usage: JavaDirectNewKafkaWordCount <brokers> <topics>\n" +
          "  <brokers> is a list of one or more Kafka brokers\n" +
          "  <topics> is a list of one or more kafka topics to consume from\n" +

...
class TestGoogleSheetsToGCSOperator:
    @mock.patch("airflow.providers.google.cloud.operators.sheets_to_gcs.csv.writer")
    @mock.patch("airflow.providers.google.cloud.operators.sheets_to_gcs.NamedTemporaryFile")
    ...
    @mock.patch("airflow.providers.google.cloud.operators.sheets_to_gcs.GCSHook")
    @mock.patch("airflow.providers.google.cloud.operators.sheets_to_gcs.GSheetsHook")
    @mock.patch(
        "airflow.providers.google.cloud.operators.sheets_to_gcs.GoogleSheetsToGCSOperator.xcom_push"
    )
    @mock.patch(
        "airflow.providers.google.cloud.operators.sheets_to_gcs.GoogleSheetsToGCSOperator._upload_data"
    )

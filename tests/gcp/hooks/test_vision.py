...
class TestGcpVisionHook(unittest.TestCase):
    def setUp(self):
        with mock.patch(
            'airflow.gcp.hooks.vision.CloudVisionHook.__init__',
    ...
    @mock.patch(
        'airflow.gcp.hooks.vision.CloudVisionHook.get_conn',
    ...
    @mock.patch('airflow.gcp.hooks.vision.CloudVisionHook.annotator_client')

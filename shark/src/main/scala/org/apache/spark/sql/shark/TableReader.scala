 ...
 */
private[shark] sealed trait TableReader {
 ...
 */
private[shark]
class HadoopTableReader(@transient _tableDesc: TableDesc, @transient sc: SharkContext)
  extends TableReader {
...
private[shark] object HadoopTableReader {

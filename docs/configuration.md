...
<tr>
  <td><code>spark.memory.useOffHeap</code></td>
  <td>true</td>
  <td>
    If true, Spark will attempt to use off-heap memory for certain operations. If off-heap memory use is enabled, then <code>spark.memory.offHeapSize</code> must be positive.
  </td>
</tr>
<tr>
  <td><code>spark.memory.offHeapSize</code></td>
  <td>0</td>
  <td>
    ...
    This must be set to a positive value when <code>spark.memory.useOffHeap=true</code>.
  </td>
</tr>
<tr>

...
<tr>
  ...
  <td><code>false</code></td>
  <td>
    Set to 'true' to enable push-based shuffle on the client side and works in conjunction with the server side flag spark.shuffle.server.mergedShuffleFileManagerImpl.
  </td>
  <td>3.2.0</td>
</tr>
<tr>

...
<tr>
  ...
  <td>
    ...
    config is from 0 to (Int.MaxValue - 1), so the invalid config like negative and greater than (Int.MaxValue - 1) will
    be normalized to 0 and (Int.MaxValue - 1).
  </td>
</tr>
<tr>
  ...
  <td>
    ...
    plain text, this only takes effect when <code>spark.sql.repl.eagerEval.enabled</code> set to true.
  </td>
</tr>
<tr>

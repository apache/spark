...
## Upgrading From Spark SQL 2.2 to 2.3
  ...
  - In PySpark, `na.fill()` or `fillna` also allow repace of NAs with booleans. In prior Spark versions, PySpark just ignore it and return the original Dataset/DataFrame.  

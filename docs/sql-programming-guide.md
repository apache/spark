...
Configuration of Hive is done by placing your `hive-site.xml`, `core-site.xml` (in order to security parameters,
 like Kerberos), `hdfs-site.xml` (parameters of HDFS HA, etc.) file in `conf/`. Please note when running

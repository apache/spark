...
## Upgrading From Spark SQL 2.3 to 2.4
  ...
  - Since Spark 2.4, File listing for compute statistics is done in parallel. This can be disabled by setting `spark.sql.execution.computeStatsListFilesInParallel` to `False`.

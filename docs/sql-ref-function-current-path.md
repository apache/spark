...
qualified namespace names. See [Name Resolution](sql-ref-name-resolution.html#sql-path) for a
description of how the path drives unqualified name resolution and
[`SET PATH`](sql-ref-syntax-aux-conf-mgmt-set-path.html) for how to change it.

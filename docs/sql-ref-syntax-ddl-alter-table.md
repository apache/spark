...
* **partition_spec**
    ...
    Partition to be dropped. Note that one can use a typed literal (e.g., date'2019-01-02') for a partition column value.
...
* **partition_spec**
    ...
    Specifies the partition on which the property has to be set. Note that one can use a typed literal (e.g., date'2019-01-02') for a partition column value.

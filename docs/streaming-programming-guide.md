...
approximately (batch interval / block interval). For example, block interval of 200ms will
...
block interval. However, the recommended minimum value of block interval is about 50ms,

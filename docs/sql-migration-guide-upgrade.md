...
## Upgrading From Spark SQL 2.4 to 3.0
  ...
  - Since Spark 3.0, substitution order of nested WITH clauses is changed and an inner CTE definition takes precedence over an outer. The previous behaviour can be restored by setting `spark.sql.legacy.cte.substitution.enabled` to `true`.

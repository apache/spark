...
## Upgrading From Spark SQL 2.4 to 3.0
  - Since Spark 3.0, configuration `spark.sql.crossJoin.enabled` is true by default, so by default spark won't raise exception on sql with implicit cross join.

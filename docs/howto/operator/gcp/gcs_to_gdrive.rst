...
:class:`~airflow.providers.google.suite.operators.gcs_to_gdrive_operator.GCSToGoogleDriveOperator` operator.

You can use :ref:`Jinja templating <jinja-templating>` with
:template-fields:`airflow.providers.google.suite.operators.gcs_to_gdrive_operator.GCSToGoogleDriveOperator`

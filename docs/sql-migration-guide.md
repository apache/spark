...
- Since Spark 4.0, queries of hive table respect the SQL config `spark.sql.files.ignoreMissingFiles` instead of the core config `spark.files.ignoreMissingFiles`.

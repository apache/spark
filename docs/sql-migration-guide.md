...
- Since Spark 4.0, any read of SQL tables takes into the SQL config `spark.sql.files.ignoreMissingFiles` instead of the core config `spark.files.ignoreMissingFiles`.

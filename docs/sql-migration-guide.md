...
## Upgrading from Spark SQL 3.3 to 3.4
  ...
  - Since Spark 3.4, database, table, permanent view and function identifier will output the catalog name, e.g. a table identifier will be: `spark_catalog.default.t`. To restore the legacy behavior, set `spark.sql.legacy.nonIdentifierOutputCatalogName` to `true`.

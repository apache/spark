...
## Upgrading from Spark SQL 3.2 to 3.3
  ...
  - Since Spark 3.3, the null values are saved as nothing by default as the bug fixed. Before Spark 3.3, the null values are saved as quoted empty strings, "", which is not expected behavior.

...
## Upgrading from Spark SQL 2.4 to 3.0
  ...
  - Since Spark 3.0, `SHOW CREATE TABLE` will return Spark DDL if the given table is a Hive serde table. For Hive DDL, please use `SHOW CREATE TABLE AS SERDE` command instead.

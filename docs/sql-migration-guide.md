...
## Upgrading from Spark SQL 3.0 to 3.1
  ...
  - In Spark 3.1, refreshing a table will trigger a uncache operation for all other caches that reference the table, even if the table itself is not cached. In Spark 3.0 the operation will only be triggered if the table itself is cached.

...
The production deployment of Spark with Parquet encryption requires implementation of a client class for the user’s KMS server. An [example](https://github.com/apache/parquet-mr/blob/apache-parquet-1.12.0/parquet-hadoop/src/test/java/org/apache/parquet/crypto/keytools/samples/VaultClient.java) of such class can be found in parquet-mr repository.

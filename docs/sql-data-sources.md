...
* [Generic Load/Save Functions](sql-data-sources-load-save-functions.html)
  ...
  * [Bucketing, Sorting and Partitioning](sql-data-sources-load-save-functions.html#run-sql-on-files-directly)
...
* [ORC Files](sql-data-sources-other.html#orc-files)
* [JSON Datasets](sql-data-sources-other.html#json-datasets)
...
* [Troubleshooting](sql-data-sources-other.html#troubleshooting)
...
<tr>
  ...
  for renewing the login tickets and the delegation tokens periodically. (Works also in `LOCAL` mode)
  </td>
</tr>
<tr>
  ...
  <td>(none)</td>
  <td>
  Principal to be used to login to KDC, while running on secure HDFS. (Works also in `LOCAL` mode)
  </td>
</tr>
<tr>

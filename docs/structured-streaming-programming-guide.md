...
<table class="table">
  ...
  <tr>
    ...
    <td>
        ...
        When "archive" is provided, additional option <code>sourceArchiveDir</code> must be provided as well. The value of "sourceArchiveDir" should ensure some condition to ensure archived files are never included as new source files:
        The value of "sourceArchiveDir" doesn't match with source pattern in depth, where the depth is minimum of depth on both paths.<br/>

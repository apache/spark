...
- Since Spark 3.2, fair scheduler also supports read a configuration file from the remote node. `spark.scheduler.allocation.file` can either be a local file path or HDFS file path.

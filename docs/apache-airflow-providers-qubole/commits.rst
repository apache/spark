...
This is detailed commit list of changes for versions provider package: ``qubole``.
...
`c58d60635 <https://github.com/apache/airflow/commit/c58d60635dbab1a91f38e989f72f91645cb7eb62>`_  2020-09-11   ``Update qubole_hook to not remove pool as an arg for qubole_operator (#10820)``
...
`36aa88ffc <https://github.com/apache/airflow/commit/36aa88ffc1e3feb5c6f4520871a4f6e3196c0804>`_  2020-09-03   ``Add jupytercmd and fix task failure when notify set as true in qubole operator (#10599)``
...
`3190db524 <https://github.com/apache/airflow/commit/3190db52469f9d9a338231a9e8e7f333a6fbb638>`_  2020-06-24   ``[AIRFLOW-9347] Fix QuboleHook unable to add list to tags (#9349)``
...
`a2d6a2f85 <https://github.com/apache/airflow/commit/a2d6a2f85e07c38be479e91e4a27981f308f4711>`_  2020-01-31   ``[AIRFLOW-6687] Switch kubernetes tests to example_dags (#7299)``

...
see (Dropwizard libary documentation for details)[https://metrics.dropwizard.io/4.0.0/manual/core.html].
...
Provides information from JVM metrics, notably including memory usage.

...
2. **Programming:** In the streaming application code, import `KinesisInputDStream` and create the input DStream of byte array as follows:
	...
	and the [example]({{site.SPARK_GITHUB_URL}}/tree/master/vendor/kinesis-asl/src/main/scala/org/apache/spark/examples/streaming/KinesisWordCountASL.scala). Refer to the [Running the Example](#running-the-example) subsection for instructions on how to run the example.
	...
	and the [example]({{site.SPARK_GITHUB_URL}}/tree/master/vendor/kinesis-asl/src/main/java/org/apache/spark/examples/streaming/JavaKinesisWordCountASL.java). Refer to the [Running the Example](#running-the-example) subsection for instructions to run the example.
	...
	and the [example]({{site.SPARK_GITHUB_URL}}/tree/master/vendor/kinesis-asl/src/main/python/examples/streaming/kinesis_wordcount_asl.py). Refer to the [Running the Example](#running-the-example) subsection for instructions to run the example.
...
- In the Spark root directory, run the example as
	...
	<div data-lang="python" markdown="1">
        ...
        ./bin/spark-submit --jars 'vendor/kinesis-asl-assembly/target/spark-streaming-kinesis-asl-assembly_*.jar' \
            vendor/kinesis-asl/src/main/python/examples/streaming/kinesis_wordcount_asl.py \

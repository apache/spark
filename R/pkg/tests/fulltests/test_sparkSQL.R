...
test_that("No extra files are created in SPARK_HOME by starting session and making calls", {
  ...
  compare_list(sparkRFilesBefore, setdiff(filesBefore, sparkRIncludedSQLDirs[[1]]))
  ...
  # check the list of files again. This time we allow both included dirs to be in the diff.
  compare_list(sparkRFilesBefore, setdiff(filesAfter, sparkRIncludedSQLDirs))
})

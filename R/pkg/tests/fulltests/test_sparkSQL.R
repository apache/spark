...
test_that("Call DataFrameWriter.load() API in Java without path and check argument types", {
  ...
  expect_error(read.df("arbitrary_path"),
               "Error in load : analysis error - [PATH_NOT_FOUND] Path does not exist:\s+.*")
  expect_error(read.json("arbitrary_path"),
               "Error in json : analysis error - [PATH_NOT_FOUND] Path does not exist:\s+.*")
  expect_error(read.text("arbitrary_path"),
               "Error in text : analysis error - [PATH_NOT_FOUND] Path does not exist:\s+.*")
  expect_error(read.orc("arbitrary_path"),
               "Error in orc : analysis error - [PATH_NOT_FOUND] Path does not exist:\s+.*")
  expect_error(read.parquet("arbitrary_path"),
               "Error in parquet : analysis error - [PATH_NOT_FOUND] Path does not exist:\s+.*")

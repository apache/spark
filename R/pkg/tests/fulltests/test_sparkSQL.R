...
test_that("column functions", {
  ...
  c3 <- cosh(c) + acosh(c) + count(c) + crc32(c) + hash(c) + exp(c)
  ...
  c9 <- signum(c) + sin(c) + sinh(c) + asinh(c) + size(c) + stddev(c) + soundex(c) + sqrt(c) + sum(c)
  c10 <- sumDistinct(c) + tan(c) + tanh(c) + atanh(c) + degrees(c) + radians(c)

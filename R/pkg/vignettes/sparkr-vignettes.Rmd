...
topic <- read.stream("kafka",
                     ...
                     subscribe = "topic1")
keyvalue <- selectExpr("CAST(key AS STRING)", "CAST(value AS STRING)")
```
...
A streaming `SparkDataFrame` can be written for debugging to the console, to a temporary in-memory table, or for further processing in a fault-tolerant manner to the File Sink in different formats.

...
If you don't have a Spark package on the computer, you may download it from [Apache Spark Website](http://spark.apache.org/downloads.html). Alternatively, we provide an easy-to-use function `install.spark` to complete this process.
...
```{r, echo=FALSE}
# Set to your own spark folder if you want to knit this Rmd.
...
For example, to connect to a local cluster master, we can call
...
* [SparkR: Scaling R Programs with Spark](SparkR: Scaling R Programs with Spark), Shivaram Venkataraman, Zongheng Yang, Davies Liu, Eric Liang, Hossein Falaki, Xiangrui Meng, Reynold Xin, Ali Ghodsi, Michael Franklin, Ion Stoica, and Matei Zaharia. SIGMOD 2016. June 2016.

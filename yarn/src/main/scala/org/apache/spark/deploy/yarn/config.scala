...
package object config {
  ...
  private[spark] val GATEWAY_ROOT_PATH = stringConf("spark.yarn.config.gatewayPath",
  ...
  private[spark] val REPLACEMENT_ROOT_PATH = stringConf("spark.yarn.config.replacementPath",
    defaultValue = Some(null),
  ...
  private[spark] val INITIAL_HEARTBEAT_INTERVAL =
    timeConf("spark.yarn.scheduler.initial-allocation.interval",
      unit = TimeUnit.MILLISECONDS,
  ...
  private[spark] val AM_LIBRARY_PATH = stringConf("spark.yarn.am.extraLibraryPath",
    doc = "Extra native library path for the client-mode AM.")
    .optional

  private[spark] val AM_MEMORY_OVERHEAD = bytesConf("spark.yarn.am.memoryOverhead",
    unit = ByteUnit.MiB)
    .optional

  private[spark] val AM_MEMORY = bytesConf("spark.yarn.am.memory",
    unit = ByteUnit.MiB,
  ...
  private[spark] val CREDENTIALS_FILE_PATH = stringConf("spark.yarn.credentials.file",
    isPublic = false)

  // Internal config to propagate the location of the user's jar to the driver/executors
  private[spark] val APP_JAR = stringConf("spark.yarn.user.jar",
    isPublic = false)
    .optional

  // Internal config to propagate the locations of any extra jars to add to the classpath
  // of the executors
  private[spark] val SECONDARY_JARS = stringSeqConf("spark.yarn.secondary.jars",
    isPublic = false)
    .optional

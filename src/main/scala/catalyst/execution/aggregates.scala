...
case class Aggregate(
    ...
    (override val outputPartitioningScheme: Partitioned =
       HashPartitioned(groupingExpressions))
  extends UnaryNode {

  override val requiredPartitioningScheme: Partitioned = HashPartitioned(groupingExpressions)
...
case class SparkAggregate(aggregateExprs: Seq[NamedExpression], child: SharkPlan)
  ...
  override val requiredPartitioningScheme: Partitioned = HashPartitioned(Nil)

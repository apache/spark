...
/**
 * A set of classes that can be used to represent trees of relational expressions.  A key goal of the expression library
 * is to hide the details of naming and scoping from developers who want to manipulate trees of relational operators. As
 * such, the library defines a special type of expression, a [[NamedExpression]] in addition to the standard collection
 * of expressions.
 *

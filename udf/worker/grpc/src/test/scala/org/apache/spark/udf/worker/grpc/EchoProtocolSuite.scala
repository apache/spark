...
// scalastyle:on funsuite
  ...
  protected var stub: UdfWorkerGrpc.UdfWorkerStub = _

  /** Overridable so another implementation can run the shared protocol cases. */
  protected def workerService: UdfWorkerGrpc.UdfWorkerImplBase = new EchoWorkerService
   ...
   */
  protected class EngineClient(stub: UdfWorkerGrpc.UdfWorkerStub) {

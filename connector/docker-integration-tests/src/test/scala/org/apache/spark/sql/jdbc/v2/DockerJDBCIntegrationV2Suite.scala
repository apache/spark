...
abstract class DockerJDBCIntegrationV2Suite extends DockerJDBCIntegrationSuite {
  ...
  override def dataPreparation(connection: Connection): Unit = {
    ...
    connection.prepareStatement("INSERT INTO pattern_testing_table VALUES ('special_character_quote''_present')")
      .executeUpdate()
    connection.prepareStatement("INSERT INTO pattern_testing_table VALUES ('special_character_quote_not_present')")
      .executeUpdate()
    connection.prepareStatement("INSERT INTO pattern_testing_table VALUES ('special_character_percent%_present')")
      .executeUpdate()
    connection.prepareStatement("INSERT INTO pattern_testing_table VALUES ('special_character_percent_not_present')")
      .executeUpdate()
    connection.prepareStatement("INSERT INTO pattern_testing_table VALUES ('special_character_underscore_present')")
      .executeUpdate()

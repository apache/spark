...
// scalastyle:on
   ...
   * Union instance. Throws an exception if sketches have different lgConfigK values and
   ...
   * Aggregate function: returns the compact binary representation of the Datasketches HllSketch,
   * generated by merging previously created Datasketches HllSketch instances via a Datasketches
   * Union instance. Throws an exception if sketches have different lgConfigK values.
   *
   * @group agg_funcs
   * @since 3.5.0
   */

...
// scalastyle:on
   ...
   * @since 3.5.0
   */
  def hllsketch_estimate(e: Column): Column = {
    Column.fn("hllsketch_estimate", e)
  }
  ...
  def hllsketch_estimate(columnName: String): Column = {
    Column.fn("hllsketch_estimate", Column(columnName))
  }
  ...
  def hllsketch_binary(e: Column, lgConfigK: Int, tgtHllType: String): Column = {
    Column.fn("hllsketch_binary", e, lit(lgConfigK), lit(tgtHllType))
  }
  ...
  def hllsketch_binary(columnName: String, lgConfigK: Int, tgtHllType: String): Column = {
    Column.fn("hllsketch_binary", Column(columnName), lit(lgConfigK), lit(tgtHllType))
  }
   ...
   * @since 3.5.0
   */
  def hllsketch_binary(e: Column): Column = {
    Column.fn("hllsketch_binary", e)
  }
  ...
  def hllsketch_binary(columnName: String): Column = {
    Column.fn("hllsketch_binary", Column(columnName))
  }
   ...
   * @since 3.5.0
   */
  def hllsketch_union_estimate(e: Column, lgMaxK: Int): Column = {
    Column.fn("hllsketch_union_estimate", e, lit(lgMaxK))
  }
  ...
  def hllsketch_union_estimate(columnName: String, lgMaxK: Int): Column = {
    Column.fn("hllsketch_union_estimate", Column(columnName), lit(lgMaxK))
  }
   ...
   * @since 3.5.0
   */
  def hllsketch_union_estimate(e: Column): Column = {
    Column.fn("hllsketch_union_estimate", e)
  }
  ...
  def hllsketch_union_estimate(columnName: String): Column = {
    Column.fn("hllsketch_union_estimate", Column(columnName))
  }
   ...
   * Union object configured with an lgMaxK equal to the min of the HllSketch object's lgConfigK
   * values.
   *
   * @group misc_funcs
   * @since 3.5.0

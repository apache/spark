  ...
  private[client] val errorFactory = Map(
    errorConstructor(params =>
      new StreamingQueryException(
        params.message,
        params.cause.orNull,
        params.errorClass.getOrElse("_LEGACY_ERROR_UNKNOWN"),
    ...
    errorConstructor(params =>
      new ParseException(
        ...
        Origin(),
        Origin(),
        errorClass = params.errorClass.getOrElse("_LEGACY_ERROR_UNKNOWN"),
    ...
    errorConstructor(params =>
      new NamespaceAlreadyExistsException(
        params.errorClass.getOrElse("_LEGACY_ERROR_UNKNOWN"), params.messageParameters)),
    errorConstructor(params =>

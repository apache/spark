...
/**
 * This object provides a global list of configured relation, expression and command plugins
 * for Spark Connect. The plugins are used to handle custom message types.
 */

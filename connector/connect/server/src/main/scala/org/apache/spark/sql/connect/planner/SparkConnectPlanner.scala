  ...
  def process(
    ...
    command.getCommandTypeCase match {
      ...
      case proto.Command.CommandTypeCase.WRITE_STREAM_OPERATION =>
        handleWriteStreamOperation(command.getWriteStreamOperation, clientId, responseObserver)
      case proto.Command.CommandTypeCase.STREAMING_QUERY_COMMAND =>
        handleStreanungQyeryCommand(command.getStreamingQueryCommand, clientId, responseObserver)

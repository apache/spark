...
import org.apache.spark.sql.execution.{CodegenMode, CostMode, ExtendedMode, FormattedMode, SimpleMode, ValidationMode}
    ...
    request.getAnalyzeCase match {
      ...
      case proto.AnalyzePlanRequest.AnalyzeCase.EXPLAIN =>
        ...
        val explainString = request.getExplain.getExplainMode match {
          ...
          case proto.AnalyzePlanRequest.Explain.ExplainMode.EXPLAIN_MODE_VALIDATION =>
            queryExecution.explainString(ValidationMode)

...
import org.apache.spark.sql.connect.service.{SessionHolder, SparkConnectAnalyzeHandler, SparkConnectService}
...
class SparkConnectServiceSuite extends SharedSparkSession {
  ...
  test("Test schema in analyze response") {
    withTable("test") {
      ...
      val request1 = proto.AnalyzePlanRequest
        ...
        .build()
      val response1 = handler.process(request1, sessionHolder)
      ...
      val request2 = proto.AnalyzePlanRequest
        ...
        .setExplain(
          proto.AnalyzePlanRequest.Explain
            ...
            .build())
        .build()
      val response2 = handler.process(request2, sessionHolder)
      ...
      val request3 = proto.AnalyzePlanRequest
        ...
        .build()
      val response3 = handler.process(request3, sessionHolder)
      ...
      val request4 = proto.AnalyzePlanRequest
        ...
        .build()
      val response4 = handler.process(request4, sessionHolder)
      ...
      val request5 = proto.AnalyzePlanRequest
        ...
        .build()
      val response5 = handler.process(request5, sessionHolder)
      ...
      val request6 = proto.AnalyzePlanRequest
        ...
        .build()
      val response6 = handler.process(request6, sessionHolder)
  ...
  test("Test explain mode in analyze response") {
    withTable("test") {
      ...
      val response = handler.process(request, sessionHolder)

...
@ExtendedSQLTest
class TPCDSIcebergModifiedPlanStabilitySuite
  ...
  override protected def getAppropriateFileName(
      queryName: String,
      suggestedFileName: String): String = if (conf.pushBroadcastedJoinKeysASFilterToScan &&
...
@ExtendedSQLTest
class TPCDSIcebergV1_4_PlanStabilitySuite
  ...
  val queriesAffectedByBroadcastVarPush =
    Set("q2", "q23b", "q31", "q33", "q39a", "q39b", "q56", "q58", "q59", "q60", "q61", "q83")
...
@ExtendedSQLTest
class TPCDSIcebergV2_7_PlanStabilitySuite

 ...
 *
 * This suite creates a temporary directory for each test case, writes the necessary
 * pipeline specification and source files, and invokes the CLI as a separate process.
 * It captures the output and error streams for verification.
 */

...
class ClientE2ETestSuite
  ...
  test("SPARK-53883: GrpcExceptionConverter ensures all exceptions have errorClass and sqlState") {
    ...
    assert(analysisEx.getCondition != null,
    ...
    assert(analysisEx.getCondition == "UNRESOLVED_COLUMN.WITHOUT_SUGGESTION",
    ...
    assert(parseEx.getCondition != null,
    ...
    assert(parseEx.getCondition.startsWith("PARSE_SYNTAX_ERROR"),
    ...
    assert(runtimeEx.getCondition != null,

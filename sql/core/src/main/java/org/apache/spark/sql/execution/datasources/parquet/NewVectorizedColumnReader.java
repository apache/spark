...
public class NewVectorizedColumnReader {
   ...
   */
  private NewVectorizedRleValuesReader defColumn;
  ...
  private ParquetVectorUpdaterFactory updaterFactory;
  ...
  public NewVectorizedColumnReader(
  ...
  private void initDataReader(Encoding dataEncoding, ByteBufferInputStream in) throws IOException {
    ...
    if (dataEncoding.usesDictionary()) {
      ...
      this.dataColumn = new NewVectorizedRleValuesReader();
      this.isCurrentPageDictionaryEncoded = true;
    } else {
  ...
  private void readPageV1(DataPageV1 page) throws IOException {
    ...
    this.defColumn = new NewVectorizedRleValuesReader(bitWidth);
    try {
  ...
  private void readPageV2(DataPageV2 page) throws IOException {
    ...
    defColumn = new NewVectorizedRleValuesReader(bitWidth, false);

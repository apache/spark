...
/**
 * A data writer returned by {@link DataWriterFactory#createWriter(int, long, long)} and is
 ...
 * In each retry, {@link DataWriterFactory#createWriter(int, long, long)} will receive a

  ...
  protected void reserveInternal(int newCapacity) {
    if (this.resultArray != null || DecimalType.isByteArrayDecimalType(type)) {
      ...
      if (this.arrayLengths != null) {
        System.arraycopy(this.arrayLengths, 0, newLengths, 0, this.arrayLengths.length);
        System.arraycopy(this.arrayOffsets, 0, newOffsets, 0, this.arrayOffsets.length);
      }
      ...
      if (byteData == null || byteData.length < newCapacity) {
        ...
        if (byteData != null) System.arraycopy(byteData, 0, newData, 0, byteData.length);
        byteData = newData;
      }
      ...
      if (shortData == null || shortData.length < newCapacity) {
        ...
        if (shortData != null) System.arraycopy(shortData, 0, newData, 0, shortData.length);
        shortData = newData;
      }
      ...
      if (longData == null || longData.length < newCapacity) {
        ...
        if (longData != null) System.arraycopy(longData, 0, newData, 0, longData.length);
        longData = newData;
      }
    } else if (type instanceof FloatType) {
      if (floatData == null || floatData.length < newCapacity) {
        float[] newData = new float[newCapacity];
        if (floatData != null) System.arraycopy(floatData, 0, newData, 0, floatData.length);
        floatData = newData;
      }
    } else if (type instanceof DoubleType) {
      if (doubleData == null || doubleData.length < newCapacity) {
        double[] newData = new double[newCapacity];
        if (doubleData != null) System.arraycopy(doubleData, 0, newData, 0, doubleData.length);
        doubleData = newData;
      }

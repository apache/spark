 ...
 *  - Dictionary ids.
 */
public final class NewVectorizedRleValuesReader extends ValuesReader
  ...
  public NewVectorizedRleValuesReader() {
    this.fixedWidth = false;
    this.readLength = false;
  }

  public NewVectorizedRleValuesReader(int bitWidth) {
    this.fixedWidth = true;
    this.readLength = bitWidth != 0;
    init(bitWidth);
  }

  public NewVectorizedRleValuesReader(int bitWidth, boolean readLength) {
    this.fixedWidth = true;

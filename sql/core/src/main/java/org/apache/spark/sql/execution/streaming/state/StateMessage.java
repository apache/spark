...
public final class StateMessage {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ution.streaming.state.ListStateCallH\000\022T\n" +
      "\014mapStateCall\030\003 \001(\0132<.org.apache.spark.s" +
      "ql.execution.streaming.state.MapStateCal" +
      "lH\000B\010\n\006method\"\340\001\n\032ImplicitGroupingKeyReq" +
      "uest\022X\n\016setImplicitKey\030\001 \001(\0132>.org.apach" +
      "e.spark.sql.execution.streaming.state.Se" +
      "tImplicitKeyH\000\022^\n\021removeImplicitKey\030\002 \001(" +
      "\0132A.org.apache.spark.sql.execution.strea" +
      "ming.state.RemoveImplicitKeyH\000B\010\n\006method" +
      "\"\232\001\n\020StateCallCommand\022\021\n\tstateName\030\001 \001(\t" +
      "\022\016\n\006schema\030\002 \001(\t\022\033\n\023mapStateValueSchema\030" +
      "\003 \001(\t\022F\n\003ttl\030\004 \001(\01329.org.apache.spark.sq" +
      "l.execution.streaming.state.TTLConfig\"\341\002" +
      "\n\016ValueStateCall\022\021\n\tstateName\030\001 \001(\t\022H\n\006e" +
      "xists\030\002 \001(\01326.org.apache.spark.sql.execu" +
      "tion.streaming.state.ExistsH\000\022B\n\003get\030\003 \001" +
      "(\01323.org.apache.spark.sql.execution.stre" +
      "aming.state.GetH\000\022\\\n\020valueStateUpdate\030\004 " +
      "\001(\0132@.org.apache.spark.sql.execution.str" +
      "eaming.state.ValueStateUpdateH\000\022F\n\005clear" +
      "\030\005 \001(\01325.org.apache.spark.sql.execution." +
      "streaming.state.ClearH\000B\010\n\006method\"\220\004\n\rLi" +
      "stStateCall\022\021\n\tstateName\030\001 \001(\t\022H\n\006exists" +
      "\030\002 \001(\01326.org.apache.spark.sql.execution." +
      "streaming.state.ExistsH\000\022T\n\014listStateGet" +
      "\030\003 \001(\0132<.org.apache.spark.sql.execution." +
      "streaming.state.ListStateGetH\000\022T\n\014listSt" +
      "atePut\030\004 \001(\0132<.org.apache.spark.sql.exec" +
      "ution.streaming.state.ListStatePutH\000\022R\n\013" +
      "appendValue\030\005 \001(\0132;.org.apache.spark.sql" +
      ".execution.streaming.state.AppendValueH\000" +
      "\022P\n\nappendList\030\006 \001(\0132:.org.apache.spark." +
      "sql.execution.streaming.state.AppendList" +
      "H\000\022F\n\005clear\030\007 \001(\01325.org.apache.spark.sql" +
      ".execution.streaming.state.ClearH\000B\010\n\006me" +
      "thod\"\341\005\n\014MapStateCall\022\021\n\tstateName\030\001 \001(\t" +
      "\022H\n\006exists\030\002 \001(\01326.org.apache.spark.sql." +
      "execution.streaming.state.ExistsH\000\022L\n\010ge" +
      "tValue\030\003 \001(\01328.org.apache.spark.sql.exec" +
      "ution.streaming.state.GetValueH\000\022R\n\013cont" +
      "ainsKey\030\004 \001(\0132;.org.apache.spark.sql.exe" +
      "cution.streaming.state.ContainsKeyH\000\022R\n\013" +
      "updateValue\030\005 \001(\0132;.org.apache.spark.sql" +
      ".execution.streaming.state.UpdateValueH\000" +
      "\022L\n\010iterator\030\006 \001(\01328.org.apache.spark.sq" +
      "l.execution.streaming.state.IteratorH\000\022D" +
      "\n\004keys\030\007 \001(\01324.org.apache.spark.sql.exec" +
      "ution.streaming.state.KeysH\000\022H\n\006values\030\010" +
      " \001(\01326.org.apache.spark.sql.execution.st" +
      "reaming.state.ValuesH\000\022N\n\tremoveKey\030\t \001(" +
      "\01329.org.apache.spark.sql.execution.strea" +
      "ming.state.RemoveKeyH\000\022F\n\005clear\030\n \001(\01325." +

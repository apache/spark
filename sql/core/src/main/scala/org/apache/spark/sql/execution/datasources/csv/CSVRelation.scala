...
object CSVRelation extends Logging {
  ...
  /**
   * Setup writing configurations into the given [[Configuration]], and then return a wrapped
   * [[CSVOptions]].
   * Both the 'batch' Datasets/DataFrames writing process and the 'streaming' Datasets/DataFrames
   * writing process would call this function.
   */
...
/**
 * A factory for generating OutputWriters for writing csv files. This implementation is different
...
/**
 * Base CSVOutputWriter class for 'batch' CSVOutputWriter and 'streaming' CSVOutputWriter.
 * This class holds the common logic on how to write data into a CSV file.
 */

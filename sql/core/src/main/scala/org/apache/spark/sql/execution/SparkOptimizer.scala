...
class SparkOptimizer(
  ...
  /**
   * Optimization batches that are executed after the regular optimization batches This hook can be
   * used to add custom optimizer batches to the Spark optimizer.
   *

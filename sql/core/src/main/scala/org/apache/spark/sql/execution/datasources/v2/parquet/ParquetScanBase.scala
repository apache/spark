...
abstract class ParquetScanBase(
  ...
  def pushedAggregate: Option[Aggregation]
  ...
  /**
   * This function should be used by the derived class to create a required ReaderFactory
   *
   * @return ReaderFactory arguments
   */
  protected def createReaderFactoryArgs(): (
    SQLConf, Broadcast[SerializableConfiguration], StructType, StructType,
      StructType, Array[Filter], Option[Aggregation], ParquetOptions
    ) = {

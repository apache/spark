...
import org.apache.spark.sql.execution.datasources.v2.{DataSourceV2ScanRelation, ExtractTable, FileTable}
...
class Dataset[T] private[sql](
  ...
  def inputFiles: Array[String] = {
    val files: Seq[String] = queryExecution.optimizedPlan.collect {
      ...
      case DataSourceV2ScanRelation(ExtractTable(table: FileTable), _, _, _, _) =>

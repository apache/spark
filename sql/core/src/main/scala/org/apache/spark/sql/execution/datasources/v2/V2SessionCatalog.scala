...
import org.apache.spark.sql.connector.catalog.{BaseSessionCatalog, CatalogManager, CatalogV2Util, Identifier, NamespaceChange, SupportsNamespaces, Table, TableCatalog, TableChange, V1Table}

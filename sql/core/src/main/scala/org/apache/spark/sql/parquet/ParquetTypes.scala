...
import parquet.schema.{MessageType, PrimitiveType => ParquetPrimitiveType, Type => ParquetType}
import parquet.schema.{ConversionPatterns, GroupType => ParquetGroupType, OriginalType => ParquetOriginalType}

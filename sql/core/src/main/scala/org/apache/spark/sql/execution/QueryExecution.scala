...
import org.apache.spark.sql.execution.exchange.{EnsureRequirements, InjectPlaceholderExchange, ReuseExchange}
...
class QueryExecution(val sparkSession: SparkSession, val logical: LogicalPlan) {
  ...
  protected def preparations: Seq[Rule[SparkPlan]] = Seq(
    ...
    InjectPlaceholderExchange(sparkSession.sessionState.conf),

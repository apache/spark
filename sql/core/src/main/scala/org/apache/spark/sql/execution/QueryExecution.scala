...
import org.apache.spark.sql.execution.exchange.{EnsureRequirements, RemoveRedundantExchange, ReuseExchange}
...
class QueryExecution(val sparkSession: SparkSession, val logical: LogicalPlan) {
  ...
  protected def preparations: Seq[Rule[SparkPlan]] = Seq(
    ...
    RemoveRedundantExchange(sparkSession.sessionState.conf),

...
class VectorizedHashMapGenerator(
   ...
   * [[org.apache.spark.sql.execution.vectorized.VectorBasedRow]] which keeps track of the
   ...
   *
   * {{{
   * public org.apache.spark.sql.execution.vectorized.VectorBasedRow findOrInsert(
  ...
  protected def generateRowIterator(): String = {
    s"""
       |public java.util.Iterator<org.apache.spark.sql.execution.vectorized.VectorBasedRow>
       |    rowIterator() {

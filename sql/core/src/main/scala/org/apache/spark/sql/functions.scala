...
// scalastyle:on
  ...
  /**
   * (Scala-specific) Parses a column containing a JSON string into a `MapType`, `StructType`
   * or `ArrayType` of `StructType`s with the specified schema. Returns `null`, in the case
  ...
  /**
   * (Java-specific) Parses a column containing a JSON string into a `MapType`, `StructType`
   * or `ArrayType` of `StructType`s with the specified schema. Returns `null`, in the case
   * of an unparseable string.
   *
   * @param e a string column containing JSON data.
  ...
  /**
   * Parses a column containing a JSON string into a `MapType`, `StructType` or `ArrayType`
  ...
  /**
   * (Java-specific) Parses a column containing a JSON string into a `MapType`, `StructType`
   * or `ArrayType` of `StructType`s with the specified schema. Returns `null`, in the case of

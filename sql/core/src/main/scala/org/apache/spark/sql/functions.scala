...
// scalastyle:on
  ...
  (0 to 10).foreach { x =>
    ...
    println(s"""
      ...
      |  val udf = UserDefinedFunction.create(f, dataType, inputSchemas)
  ...
  (0 to 10).foreach { i =>
    ...
    println(s"""
      ...
      |  UserDefinedFunction.create($funcCall, returnType, inputSchemas = None)
      |}""".stripMargin)
  }
  ...
  */
  ...
  def udf(f: UDF0[_], returnType: DataType): UserDefinedFunction = {
    ...
    UserDefinedFunction.create(() => func, returnType, inputSchemas = None)
  }
  ...
  def udf(f: AnyRef, dataType: DataType): UserDefinedFunction = {
    UserDefinedFunction.create(f, dataType, inputSchemas = None)
  }

...
// scalastyle:on
  ...
  /**
   * Aggregate function: returns the standard deviation value of the expression in a group.
   *
   * @group agg_funcs
   * @since 1.5.0
   */
  ...
  /**
   * Aggregate function: returns the standard deviation value of the column in a group.
   *
   * @group agg_funcs
   * @since 1.5.0
   */

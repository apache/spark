 ...
 * at SQL API documentation (https://spark.apache.org/docs/latest/api/sql/index.html or
 * https://spark.apache.org/docs/<version>/api/sql/index.html for older versions).
 *

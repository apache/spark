...
package org.apache.spark.sql.core.protobuf.utils
...
private[sql] object ProtobufUtils extends Logging {
  ...
  class ProtoSchemaHelper(
     ...
     */
    private[protobuf] def getFieldByName(name: String): scala.Option[FieldDescriptor] = {
   ...
   * @return
   */
  def buildDescriptor(messageName: String, binaryFileDescriptorSet: scala.Option[Array[Byte]])
  : Descriptor = {

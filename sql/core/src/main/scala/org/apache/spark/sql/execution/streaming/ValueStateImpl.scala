...
import org.apache.spark.sql.execution.streaming.state.{NoPrefixKeyStateEncoderType, StateStore}
...
class ValueStateImpl[S](
  ...
  store.createColFamilyIfAbsent(stateName, NoPrefixKeyStateEncoderType, KEY_ROW_SCHEMA,

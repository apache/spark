...
class XmlDataSourceV2 extends FileDataSourceV2 {
  ...
  override def fallbackFileFormat: Class[_ <: FileFormat] = classOf[XmlFileFormat]
  ...
  override def getTable(options: CaseInsensitiveStringMap): Table = {
    ...
    XmlTable(tableName, sparkSession, optionsWithoutPaths, paths, None, fallbackFileFormat)
  }

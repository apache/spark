...
case class XmlTable(
  ...
  override def newScanBuilder(options: CaseInsensitiveStringMap): XmlScanBuilder =
    new XmlScanBuilder(sparkSession, fileIndex, schema, dataSchema, options)
  ...
  override def newWriteBuilder(info: LogicalWriteInfo): WriteBuilder =
    new WriteBuilder {
      override def build(): Write = XmlWrite(paths, formatName, supportsDataType, info)
    }

...
import org.apache.spark.sql.catalyst.analysis.{Analyzer, EvalSubquerisForTimeTravel, FunctionRegistry, ReplaceCharWithVarchar, ResolveSessionCatalog, TableFunctionRegistry}
  ...
  protected def analyzer: Analyzer = new Analyzer(catalogManager) {
    override val extendedResolutionRules: Seq[Rule[LogicalPlan]] =
      new FindDataSourceTable(session) +:
        ...
        new EvalSubquerisForTimeTravel +:

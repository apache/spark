...
import org.apache.spark.sql.catalyst.plans.logical.{LogicalPlan, UnaryCommand, WithCTEInChildren}
 ...
 */
trait DataWritingCommand extends UnaryCommand with WithCTEInChildren {
  /**

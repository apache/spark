...
abstract class ParquetScanBuilderBase(
  ...
  /**
   * This function should be used by the derived class to create a required Scan
   *
   * @return Scan arguments
   */
  protected def buildArgs(): (
      SparkSession, Configuration, PartitioningAwareFileIndex, StructType, StructType,
      StructType, Array[Filter], CaseInsensitiveStringMap, Option[Aggregation],
    ...
    (sparkSession, hadoopConf, fileIndex, dataSchema, finalSchema,

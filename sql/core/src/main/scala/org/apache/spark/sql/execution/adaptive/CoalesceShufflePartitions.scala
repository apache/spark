...
import org.apache.spark.sql.execution.exchange.{ENSURE_REQUIREMENTS, REPARTITION, REPARTITION_BY_NONE, ShuffleExchangeLike, ShuffleOrigin}
...
case class CoalesceShufflePartitions(session: SparkSession) extends CustomShuffleReaderRule {
  ...
  override val supportedShuffleOrigins: Seq[ShuffleOrigin] =
    Seq(ENSURE_REQUIREMENTS, REPARTITION, REPARTITION_BY_NONE)

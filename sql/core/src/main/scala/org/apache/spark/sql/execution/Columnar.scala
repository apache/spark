...
case class ApplyColumnarRulesAndInsertTransitions(
  ...
  /**
   * Ensures columnar output on the input query plan. Transitions will be inserted on demand.
   */
  ...
  /**
   * Ensures row-based output on the input query plan. Transitions will be inserted on demand.
   */

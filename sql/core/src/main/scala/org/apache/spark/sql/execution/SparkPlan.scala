...
abstract class SparkPlan extends QueryPlan[SparkPlan] with Logging with Serializable {
   ...
   * can specify ClusteredDistribution(a,b) for its left child, and specify
   * ClusteredDistribution(c,d) for its right child, then it's guaranteed that left and right

...
import org.apache.spark.sql.catalyst.expressions.aggregate.{InterpretedAggregateFunction, AggregateFunction2}
...
private[sql] case class ScalaUDAF(
  ...
  extends InterpretedAggregateFunction with Logging {

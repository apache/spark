...
import org.apache.spark.sql.catalyst.expressions.aggregate.{ImperativeAggregateFunction, AggregateFunction2}
...
private[sql] case class ScalaUDAF(
  ...
  extends ImperativeAggregateFunction with Logging {

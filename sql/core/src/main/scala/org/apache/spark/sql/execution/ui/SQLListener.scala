...
case class SparkListenerSQLExecutionEnd(
    ...
    // See SparkListenerSQLExecutionStart.queryId
    queryId: Option[UUID] = None)
    extends SparkListenerEvent {
 ...
 *
 * This is necessary due to limitations in how Jackson's scala module deserializes primitives; see
 * the "Deserializing Option[Int] and other primitive challenges" section in

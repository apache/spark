 ...
 */
package org.apache.spark.sql.core.protobuf
...
import org.apache.spark.sql.core.protobuf.utils.ProtobufUtils
import org.apache.spark.sql.core.protobuf.utils.ProtobufUtils.{toFieldStr, ProtoMatchedField}
...
private[sql] class ProtobufDeserializer(
  ...
  private val converter: scala.Any => scala.Option[InternalRow] =
    try {
      rootCatalystType match {
        // A shortcut for empty schema.
        case st: StructType if st.isEmpty =>
          (_: scala.Any) => Some(InternalRow.empty)
  ...
  def deserialize(data: scala.Any): scala.Option[InternalRow] = converter(data)
  ...
  private def newArrayWriter(
      ...
      containsNull: Boolean): (CatalystDataUpdater, Int, scala.Any) => Unit = {

    val protoElementPath = protoPath :+ "element"
    val elementWriter =
      newWriter(protoField, elementType, protoElementPath, catalystPath :+ "element")
    (updater, ordinal, value) =>
      val collection = value.asInstanceOf[java.util.Collection[scala.Any]]
  ...
  private def newMapWriter(
      ...
      keyType: DataType,
      valueType: DataType,
      valueContainsNull: Boolean): (CatalystDataUpdater, Int, scala.Any) => Unit = {
  ...
  private def newWriter(
      ...
      protoPath: Seq[String],
      catalystPath: Seq[String]): (CatalystDataUpdater, Int, scala.Any) => Unit = {
  ...
  private def getRecordWriter(
    ...
    val (validFieldIndexes, fieldWriters) = protoSchemaHelper.matchedFields
      .map { case ProtoMatchedField(catalystField, ordinal, protoField) =>
        ...
        val fieldWriter = (fieldUpdater: CatalystDataUpdater, value: scala.Any) => {
          if (value == null) {
  ...
  sealed trait CatalystDataUpdater {
    def set(ordinal: Int, value: scala.Any): Unit
  ...
  final class RowUpdater(row: InternalRow) extends CatalystDataUpdater {
    override def set(ordinal: Int, value: scala.Any): Unit = row.update(ordinal, value)
  ...
  final class ArrayDataUpdater(array: ArrayData) extends CatalystDataUpdater {
    override def set(ordinal: Int, value: scala.Any): Unit = array.update(ordinal, value)

...
case class ShuffleExchangeExec(
  ...
  def createLocalShuffleRDD(partitionStartIndices: Option[Array[Int]]): LocalShuffledRowRDD = {
    new LocalShuffledRowRDD(shuffleDependency, readMetrics, partitionStartIndices)
  }

...
import org.apache.spark.sql.connector.catalog.TableCapability.{BATCH_READ, BATCH_WRITE, MICRO_BATCH_READ, TRUNCATE}
...
class PythonTable(
  ...
  override def capabilities(): java.util.Set[TableCapability] = java.util.EnumSet.of(
    BATCH_READ, BATCH_WRITE, MICRO_BATCH_READ, TRUNCATE)

...
/**
 * A TestCatalogProvider. This is in its own file because it needs to be public for Catalogs.load
 * to be able to call the constructor.
 */
public class TestCatalogProvider implements CatalogProvider {

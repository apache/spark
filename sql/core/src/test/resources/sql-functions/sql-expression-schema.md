...
| org.apache.spark.sql.catalyst.expressions.Rand | random | SELECT random() | struct<random(-630868665839061531):double> |
| org.apache.spark.sql.catalyst.expressions.Rand | rand | SELECT rand() | struct<rand(1127189071507726301):double> |
| org.apache.spark.sql.catalyst.expressions.Randn | randn | SELECT randn() | struct<randn(-7085677779435835023):double> |

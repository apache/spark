...
| org.apache.spark.sql.catalyst.expressions.variant.VariantStripNulls | variant_strip_nulls | SELECT variant_strip_nulls(parse_json('{"a":1, "b":null}')) | struct<variant_strip_nulls(parse_json({"a":1, "b":null})):variant> |

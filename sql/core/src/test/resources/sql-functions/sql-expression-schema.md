...
| org.apache.spark.sql.catalyst.expressions.aggregate.Product | product | SELECT product(col) FROM VALUES (1), (5), (2) AS tab(col) | struct<product(col):double> |

...
| org.apache.spark.sql.catalyst.expressions.aggregate.ModeBuilder | mode | SELECT mode() WITHIN GROUP (ORDER BY col) FROM VALUES (0), (10), (10) AS tab(col) | struct<mode() WITHIN GROUP (ORDER BY col DESC):int> |

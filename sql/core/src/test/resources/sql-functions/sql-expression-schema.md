...
## Summary
  - Number of queries: 371
  - Number of expressions that missing example: 13
  - Expressions missing examples: bigint,binary,boolean,date,decimal,double,float,int,smallint,string,timestamp,tinyint,try_element_at
...
| org.apache.spark.sql.catalyst.expressions.AesEncrypt | aes_encrypt | SELECT base64(aes_encrypt('Spark', 'abcdefghijklmnop')) | struct<base64(aesencrypt(Spark, abcdefghijklmnop)):string> |
...
| org.apache.spark.sql.catalyst.expressions.TryElementAt | try_element_at | N/A | N/A |

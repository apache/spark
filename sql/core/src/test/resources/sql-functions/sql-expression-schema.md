...
| org.apache.spark.sql.catalyst.expressions.Collate | collate | SELECT COLLATION('Spark SQL' collate 'UCS_BASIC_LCASE') | struct<collation(collate(Spark SQL)):string> |

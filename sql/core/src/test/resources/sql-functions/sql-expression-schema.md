...
| org.apache.spark.sql.catalyst.expressions.WithField | with_field | SELECT with_field(NAMED_STRUCT("a", 1, "b", 2), "c", 3) | struct<with_field(named_struct(a, 1, b, 2), c, 3):struct<a:int,b:int,c:int>> |

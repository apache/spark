...
| org.apache.spark.sql.catalyst.expressions.TupleDifferenceString | tuple_difference_string | SELECT tuple_sketch_estimate_string(tuple_difference_string(tuple_sketch_agg_string(col1, val1), tuple_sketch_agg_string(col2, val2))) FROM VALUES (5, 'e', 4, 'd'), (1, 'a', 4, 'd'), (2, 'b', 5, 'e'), (3, 'c', 1, 'a') tab(col1, val1, col2, val2) | struct<tuple_sketch_estimate_string(tuple_difference_string(tuple_sketch_agg_string(col1, val1, 12), tuple_sketch_agg_string(col2, val2, 12))):double> |
...
| org.apache.spark.sql.catalyst.expressions.TupleDifferenceThetaString | tuple_difference_theta_string | SELECT tuple_sketch_estimate_string(tuple_difference_theta_string(tuple_sketch_agg_string(col1, val1), theta_sketch_agg(col2))) FROM VALUES (5, 'e', 4), (1, 'a', 4), (2, 'b', 5), (3, 'c', 1) tab(col1, val1, col2) | struct<tuple_sketch_estimate_string(tuple_difference_theta_string(tuple_sketch_agg_string(col1, val1, 12), theta_sketch_agg(col2, 12))):double> |
...
| org.apache.spark.sql.catalyst.expressions.TupleIntersectionString | tuple_intersection_string | SELECT tuple_sketch_estimate_string(tuple_intersection_string(tuple_sketch_agg_string(col1, val1), tuple_sketch_agg_string(col2, val2))) FROM VALUES (1, 'a', 1, 'x'), (2, 'b', 2, 'y'), (3, 'c', 4, 'z') tab(col1, val1, col2, val2) | struct<tuple_sketch_estimate_string(tuple_intersection_string(tuple_sketch_agg_string(col1, val1, 12), tuple_sketch_agg_string(col2, val2, 12))):double> |
...
| org.apache.spark.sql.catalyst.expressions.TupleIntersectionThetaString | tuple_intersection_theta_string | SELECT tuple_sketch_estimate_string(tuple_intersection_theta_string(tuple_sketch_agg_string(col1, val1), theta_sketch_agg(col2))) FROM VALUES (1, 'a', 1), (2, 'b', 2), (3, 'c', 4) tab(col1, val1, col2) | struct<tuple_sketch_estimate_string(tuple_intersection_theta_string(tuple_sketch_agg_string(col1, val1, 12), theta_sketch_agg(col2, 12))):double> |
...
| org.apache.spark.sql.catalyst.expressions.TupleSketchEstimateString | tuple_sketch_estimate_string | SELECT tuple_sketch_estimate_string(tuple_sketch_agg_string(key, summary)) FROM VALUES (1, 'a'), (1, 'b'), (2, 'c') tab(key, summary) | struct<tuple_sketch_estimate_string(tuple_sketch_agg_string(key, summary, 12)):double> |
...
| org.apache.spark.sql.catalyst.expressions.TupleUnionDouble | tuple_union_double | SELECT tuple_sketch_estimate_double(tuple_union_double(tuple_sketch_agg_double(col1, val1), tuple_sketch_agg_double(col2, val2))) FROM VALUES (1, 1.0D, 4, 4.0D), (2, 2.0D, 5, 5.0D), (3, 3.0D, 6, 6.0D) tab(col1, val1, col2, val2) | struct<tuple_sketch_estimate_double(tuple_union_double(tuple_sketch_agg_double(col1, val1, 12, sum), tuple_sketch_agg_double(col2, val2, 12, sum), 12, sum)):double> |
| org.apache.spark.sql.catalyst.expressions.TupleUnionInteger | tuple_union_integer | SELECT tuple_sketch_estimate_integer(tuple_union_integer(tuple_sketch_agg_integer(col1, val1), tuple_sketch_agg_integer(col2, val2))) FROM VALUES (1, 1, 4, 4), (2, 2, 5, 5), (3, 3, 6, 6) tab(col1, val1, col2, val2) | struct<tuple_sketch_estimate_integer(tuple_union_integer(tuple_sketch_agg_integer(col1, val1, 12, sum), tuple_sketch_agg_integer(col2, val2, 12, sum), 12, sum)):double> |
| org.apache.spark.sql.catalyst.expressions.TupleUnionString | tuple_union_string | SELECT tuple_sketch_estimate_string(tuple_union_string(tuple_sketch_agg_string(col1, val1), tuple_sketch_agg_string(col2, val2))) FROM VALUES (1, 'a', 4, 'x'), (2, 'b', 5, 'y'), (3, 'c', 6, 'z') tab(col1, val1, col2, val2) | struct<tuple_sketch_estimate_string(tuple_union_string(tuple_sketch_agg_string(col1, val1, 12), tuple_sketch_agg_string(col2, val2, 12), 12)):double> |
| org.apache.spark.sql.catalyst.expressions.TupleUnionThetaDouble | tuple_union_theta_double | SELECT tuple_sketch_estimate_double(tuple_union_theta_double(tuple_sketch_agg_double(col1, val1), theta_sketch_agg(col2))) FROM VALUES (1, 1.0D, 4), (2, 2.0D, 5), (3, 3.0D, 6) tab(col1, val1, col2) | struct<tuple_sketch_estimate_double(tuple_union_theta_double(tuple_sketch_agg_double(col1, val1, 12, sum), theta_sketch_agg(col2, 12), 12, sum)):double> |
| org.apache.spark.sql.catalyst.expressions.TupleUnionThetaInteger | tuple_union_theta_integer | SELECT tuple_sketch_estimate_integer(tuple_union_theta_integer(tuple_sketch_agg_integer(col1, val1), theta_sketch_agg(col2))) FROM VALUES (1, 1, 4), (2, 2, 5), (3, 3, 6) tab(col1, val1, col2) | struct<tuple_sketch_estimate_integer(tuple_union_theta_integer(tuple_sketch_agg_integer(col1, val1, 12, sum), theta_sketch_agg(col2, 12), 12, sum)):double> |
| org.apache.spark.sql.catalyst.expressions.TupleUnionThetaString | tuple_union_theta_string | SELECT tuple_sketch_estimate_string(tuple_union_theta_string(tuple_sketch_agg_string(col1, val1), theta_sketch_agg(col2))) FROM VALUES (1, 'a', 4), (2, 'b', 5), (3, 'c', 6) tab(col1, val1, col2) | struct<tuple_sketch_estimate_string(tuple_union_theta_string(tuple_sketch_agg_string(col1, val1, 12), theta_sketch_agg(col2, 12), 12)):double> |
...
| org.apache.spark.sql.catalyst.expressions.aggregate.TupleIntersectionAggString | tuple_intersection_agg_string | SELECT tuple_sketch_estimate_string(tuple_intersection_agg_string(sketch)) FROM (SELECT tuple_sketch_agg_string(key, summary) as sketch FROM VALUES (1, 'a'), (2, 'b'), (3, 'c') tab(key, summary) UNION ALL SELECT tuple_sketch_agg_string(key, summary) as sketch FROM VALUES (2, 'b'), (3, 'c'), (4, 'd') tab(key, summary)) | struct<tuple_sketch_estimate_string(tuple_intersection_agg_string(sketch)):double> |
| org.apache.spark.sql.catalyst.expressions.aggregate.TupleSketchAggDouble | tuple_sketch_agg_double | SELECT tuple_sketch_estimate_double(tuple_sketch_agg_double(key, summary, 12, 'sum')) FROM VALUES (1, 5.0D), (1, 1.0D), (2, 2.0D), (2, 3.0D), (3, 2.2D) tab(key, summary) | struct<tuple_sketch_estimate_double(tuple_sketch_agg_double(key, summary, 12, sum)):double> |
| org.apache.spark.sql.catalyst.expressions.aggregate.TupleSketchAggInteger | tuple_sketch_agg_integer | SELECT tuple_sketch_estimate_integer(tuple_sketch_agg_integer(key, summary, 12, 'sum')) FROM VALUES (1, 5), (1, 1), (2, 2), (2, 3), (3, 2) tab(key, summary) | struct<tuple_sketch_estimate_integer(tuple_sketch_agg_integer(key, summary, 12, sum)):double> |
| org.apache.spark.sql.catalyst.expressions.aggregate.TupleSketchAggString | tuple_sketch_agg_string | SELECT tuple_sketch_estimate_string(tuple_sketch_agg_string(key, summary, 12)) FROM VALUES (1, 'a'), (1, 'b'), (2, 'c'), (2, 'd'), (3, 'e') tab(key, summary) | struct<tuple_sketch_estimate_string(tuple_sketch_agg_string(key, summary, 12)):double> |
| org.apache.spark.sql.catalyst.expressions.aggregate.TupleUnionAggDouble | tuple_union_agg_double | SELECT tuple_sketch_estimate_double(tuple_union_agg_double(sketch)) FROM (SELECT tuple_sketch_agg_double(key, summary) as sketch FROM VALUES (1, 5.0D), (2, 10.0D) tab(key, summary) UNION ALL SELECT tuple_sketch_agg_double(key, summary) as sketch FROM VALUES (2, 3.0D), (3, 7.0D) tab(key, summary)) | struct<tuple_sketch_estimate_double(tuple_union_agg_double(sketch, 12, sum)):double> |
| org.apache.spark.sql.catalyst.expressions.aggregate.TupleUnionAggInteger | tuple_union_agg_integer | SELECT tuple_sketch_estimate_integer(tuple_union_agg_integer(sketch)) FROM (SELECT tuple_sketch_agg_integer(key, summary) as sketch FROM VALUES (1, 5), (2, 10) tab(key, summary) UNION ALL SELECT tuple_sketch_agg_integer(key, summary) as sketch FROM VALUES (2, 3), (3, 7) tab(key, summary)) | struct<tuple_sketch_estimate_integer(tuple_union_agg_integer(sketch, 12, sum)):double> |
| org.apache.spark.sql.catalyst.expressions.aggregate.TupleUnionAggString | tuple_union_agg_string | SELECT tuple_sketch_estimate_string(tuple_union_agg_string(sketch)) FROM (SELECT tuple_sketch_agg_string(key, summary) as sketch FROM VALUES (1, 'a'), (2, 'b') tab(key, summary) UNION ALL SELECT tuple_sketch_agg_string(key, summary) as sketch FROM VALUES (2, 'c'), (3, 'd') tab(key, summary)) | struct<tuple_sketch_estimate_string(tuple_union_agg_string(sketch, 12)):double> |

...
| org.apache.spark.sql.catalyst.expressions.ParseCommand | parse_command | SELECT parse_command('SELECT a, b FROM t') | struct<parse_command(SELECT a, b FROM t):string> |

...
| org.apache.spark.sql.catalyst.expressions.ItemsSketchGetEstimate | items_sketch_get_estimate | SELECT items_sketch_get_estimate(items_sketch_agg(col), 'a') FROM VALUES ('a'), ('a'), ('a'), ('b'), ('c') tab(col) | struct<items_sketch_get_estimate(items_sketch_agg(col, 4096), a):bigint> |
| org.apache.spark.sql.catalyst.expressions.ItemsSketchGetFrequentItems | items_sketch_get_frequent_items | SELECT items_sketch_get_frequent_items(items_sketch_agg(col), 'NO_FALSE_POSITIVES') FROM VALUES ('a'), ('a'), ('a'), ('b'), ('c') tab(col) | struct<items_sketch_get_frequent_items(items_sketch_agg(col, 4096), NO_FALSE_POSITIVES):array<struct<item:string,estimate:bigint,lowerBound:bigint,upperBound:bigint>>> |
| org.apache.spark.sql.catalyst.expressions.ItemsSketchMerge | items_sketch_merge | SELECT items_sketch_get_frequent_items(items_sketch_merge(items_sketch_agg(col1), items_sketch_agg(col2)), 'NO_FALSE_POSITIVES') FROM VALUES ('a', 'b'), ('a', 'b'), ('a', 'c') tab(col1, col2) | struct<items_sketch_get_frequent_items(items_sketch_merge(items_sketch_agg(col1, 4096), items_sketch_agg(col2, 4096)), NO_FALSE_POSITIVES):array<struct<item:string,estimate:bigint,lowerBound:bigint,upperBound:bigint>>> |
| org.apache.spark.sql.catalyst.expressions.ItemsSketchToString | items_sketch_to_string | SELECT length(items_sketch_to_string(items_sketch_agg(col))) > 0 FROM VALUES ('a'), ('b') tab(col) | struct<(length(items_sketch_to_string(items_sketch_agg(col, 4096))) > 0):boolean> |
...
| org.apache.spark.sql.catalyst.expressions.aggregate.ItemsSketchAggExpressionBuilder | items_sketch_agg | SELECT items_sketch_get_frequent_items(items_sketch_agg(col), 'NO_FALSE_POSITIVES') FROM VALUES ('a'), ('a'), ('a'), ('b'), ('c') tab(col) | struct<items_sketch_get_frequent_items(items_sketch_agg(col, 4096), NO_FALSE_POSITIVES):array<struct<item:string,estimate:bigint,lowerBound:bigint,upperBound:bigint>>> |
| org.apache.spark.sql.catalyst.expressions.aggregate.ItemsSketchMergeAggExpressionBuilder | items_sketch_merge_agg | SELECT items_sketch_get_frequent_items(items_sketch_merge_agg(sketch), 'NO_FALSE_POSITIVES') FROM (SELECT items_sketch_agg(col) as sketch FROM VALUES ('a'), ('a'), ('a') tab(col) UNION ALL SELECT items_sketch_agg(col) as sketch FROM VALUES ('a'), ('a') tab(col)) | struct<items_sketch_get_frequent_items(items_sketch_merge_agg(sketch, 4096), NO_FALSE_POSITIVES):array<struct<item:string,estimate:bigint,lowerBound:bigint,upperBound:bigint>>> |

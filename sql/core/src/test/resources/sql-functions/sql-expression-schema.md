...
| org.apache.spark.sql.catalyst.expressions.ApproxFrequentItemsEstimate | approx_frequent_items_estimate | SELECT approx_frequent_items_estimate(approx_frequent_items_accumulate(expr)) FROM VALUES (0), (0), (1), (1), (2), (3), (4), (4) AS tab(expr) | struct<approx_frequent_items_estimate(approx_frequent_items_accumulate(expr, 10000), 5):array<struct<item:int,count:bigint>>> |
| org.apache.spark.sql.catalyst.expressions.ApproxFrequentItemsEstimate | approx_heavy_hitters_estimate | SELECT approx_heavy_hitters_estimate(approx_frequent_items_accumulate(expr)) FROM VALUES (0), (0), (1), (1), (2), (3), (4), (4) AS tab(expr) | struct<approx_heavy_hitters_estimate(approx_frequent_items_accumulate(expr, 10000), 5):array<struct<item:int,count:bigint>>> |
| org.apache.spark.sql.catalyst.expressions.ApproxFrequentItemsEstimate | approx_top_k_estimate | SELECT approx_top_k_estimate(approx_frequent_items_accumulate(expr)) FROM VALUES (0), (0), (1), (1), (2), (3), (4), (4) AS tab(expr) | struct<approx_top_k_estimate(approx_frequent_items_accumulate(expr, 10000), 5):array<struct<item:int,count:bigint>>> |
...
| org.apache.spark.sql.catalyst.expressions.aggregate.ApproxFrequentItems | approx_frequent_items | SELECT approx_frequent_items(expr) FROM VALUES (0), (0), (1), (1), (2), (3), (4), (4) AS tab(expr) | struct<approx_frequent_items(expr, 5, 10000):array<struct<item:int,count:bigint>>> |
| org.apache.spark.sql.catalyst.expressions.aggregate.ApproxFrequentItems | approx_heavy_hitters | SELECT approx_heavy_hitters(expr) FROM VALUES (0), (0), (1), (1), (2), (3), (4), (4) AS tab(expr) | struct<approx_heavy_hitters(expr, 5, 10000):array<struct<item:int,count:bigint>>> |
| org.apache.spark.sql.catalyst.expressions.aggregate.ApproxFrequentItems | approx_top_k | SELECT approx_top_k(expr) FROM VALUES (0), (0), (1), (1), (2), (3), (4), (4) AS tab(expr) | struct<approx_top_k(expr, 5, 10000):array<struct<item:int,count:bigint>>> |
| org.apache.spark.sql.catalyst.expressions.aggregate.ApproxFrequentItemsAccumulate | approx_frequent_items_accumulate | SELECT approx_frequent_items_estimate(approx_frequent_items_accumulate(expr)) FROM VALUES (0), (0), (1), (1), (2), (3), (4), (4) AS tab(expr) | struct<approx_frequent_items_estimate(approx_frequent_items_accumulate(expr, 10000), 5):array<struct<item:int,count:bigint>>> |
| org.apache.spark.sql.catalyst.expressions.aggregate.ApproxFrequentItemsAccumulate | approx_heavy_hitters_accumulate | SELECT approx_frequent_items_estimate(approx_heavy_hitters_accumulate(expr)) FROM VALUES (0), (0), (1), (1), (2), (3), (4), (4) AS tab(expr) | struct<approx_frequent_items_estimate(approx_heavy_hitters_accumulate(expr, 10000), 5):array<struct<item:int,count:bigint>>> |
| org.apache.spark.sql.catalyst.expressions.aggregate.ApproxFrequentItemsAccumulate | approx_top_k_accumulate | SELECT approx_frequent_items_estimate(approx_top_k_accumulate(expr)) FROM VALUES (0), (0), (1), (1), (2), (3), (4), (4) AS tab(expr) | struct<approx_frequent_items_estimate(approx_top_k_accumulate(expr, 10000), 5):array<struct<item:int,count:bigint>>> |
| org.apache.spark.sql.catalyst.expressions.aggregate.ApproxFrequentItemsCombine | approx_frequent_items_combine | SELECT approx_frequent_items_estimate(approx_frequent_items_combine(sketch, 10000), 5) FROM (SELECT approx_frequent_items_accumulate(expr) AS sketch FROM VALUES (0), (0), (1), (1) AS tab(expr) UNION ALL SELECT approx_frequent_items_accumulate(expr) AS sketch FROM VALUES (2), (3), (4), (4) AS tab(expr)) | struct<approx_frequent_items_estimate(approx_frequent_items_combine(sketch, 10000), 5):array<struct<item:int,count:bigint>>> |
| org.apache.spark.sql.catalyst.expressions.aggregate.ApproxFrequentItemsCombine | approx_heavy_hitters_combine | SELECT approx_frequent_items_estimate(approx_heavy_hitters_combine(sketch, 10000), 5) FROM (SELECT approx_frequent_items_accumulate(expr) AS sketch FROM VALUES (0), (0), (1), (1) AS tab(expr) UNION ALL SELECT approx_frequent_items_accumulate(expr) AS sketch FROM VALUES (2), (3), (4), (4) AS tab(expr)) | struct<approx_frequent_items_estimate(approx_heavy_hitters_combine(sketch, 10000), 5):array<struct<item:int,count:bigint>>> |
| org.apache.spark.sql.catalyst.expressions.aggregate.ApproxFrequentItemsCombine | approx_top_k_combine | SELECT approx_frequent_items_estimate(approx_top_k_combine(sketch, 10000), 5) FROM (SELECT approx_frequent_items_accumulate(expr) AS sketch FROM VALUES (0), (0), (1), (1) AS tab(expr) UNION ALL SELECT approx_frequent_items_accumulate(expr) AS sketch FROM VALUES (2), (3), (4), (4) AS tab(expr)) | struct<approx_frequent_items_estimate(approx_top_k_combine(sketch, 10000), 5):array<struct<item:int,count:bigint>>> |

...
| org.apache.spark.sql.catalyst.expressions.Cast | bigint | SELECT bigint(1.0) | struct<CAST(1.0 AS BIGINT):bigint> |
| org.apache.spark.sql.catalyst.expressions.Cast | binary | SELECT binary('spark') | struct<CAST(spark AS BINARY):binary> |
| org.apache.spark.sql.catalyst.expressions.Cast | boolean | SELECT boolean(1) | struct<CAST(1 AS BOOLEAN):boolean> |
| org.apache.spark.sql.catalyst.expressions.Cast | cast | SELECT cast('10' as int) | struct<CAST(10 AS INT):int> |
| org.apache.spark.sql.catalyst.expressions.Cast | date | SELECT date('1970-01-01T12') | struct<CAST(1970-01-01T12 AS DATE):date> |
| org.apache.spark.sql.catalyst.expressions.Cast | decimal | SELECT decimal(1.0) | struct<CAST(1.0 AS DECIMAL(10,0)):decimal(10,0)> |
| org.apache.spark.sql.catalyst.expressions.Cast | double | SELECT double(1) | struct<CAST(1 AS DOUBLE):double> |
| org.apache.spark.sql.catalyst.expressions.Cast | float | SELECT float(1) | struct<CAST(1 AS FLOAT):float> |
| org.apache.spark.sql.catalyst.expressions.Cast | int | SELECT int(1.0) | struct<CAST(1.0 AS INT):int> |
| org.apache.spark.sql.catalyst.expressions.Cast | smallint | SELECT smallint(1.0) | struct<CAST(1.0 AS SMALLINT):smallint> |
| org.apache.spark.sql.catalyst.expressions.Cast | string | SELECT string(1.0) | struct<CAST(1.0 AS STRING):string> |
| org.apache.spark.sql.catalyst.expressions.Cast | timestamp | SELECT timestamp('1970-01-01 12:00') | struct<CAST(1970-01-01 12:00 AS TIMESTAMP):timestamp> |
| org.apache.spark.sql.catalyst.expressions.Cast | tinyint | SELECT tinyint(1.0) | struct<CAST(1.0 AS TINYINT):tinyint> |
...
| org.apache.spark.sql.catalyst.expressions.CumeDist | cume_dist | SELECT a, b, cume_dist() OVER (PARTITION BY a ORDER BY b) FROM VALUES ('A1', 2), ('A2', 3), ('A1', 1) tab(a, b) | struct<a:string,b:int,cume_dist() OVER (PARTITION BY a ORDER BY b ASC NULLS FIRST RANGE BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW):double> |
...
| org.apache.spark.sql.catalyst.expressions.DenseRank | dense_rank | SELECT a, b, dense_rank(b) OVER (PARTITION BY a ORDER BY b) FROM VALUES ('A1', 2), ('A2', 3), ('A1', 1) tab(a, b) | struct<a:string,b:int,DENSE_RANK() OVER (PARTITION BY a ORDER BY b ASC NULLS FIRST ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW):int> |
...
| org.apache.spark.sql.catalyst.expressions.Lag | lag | SELECT a, b, lag(b) OVER (PARTITION BY a ORDER BY b) FROM VALUES ('A1', 2), ('A2', 3), ('A1', 1) tab(a, b) | struct<a:string,b:int,lag(b, 1, NULL) OVER (PARTITION BY a ORDER BY b ASC NULLS FIRST ROWS BETWEEN -1 FOLLOWING AND -1 FOLLOWING):int> |
...
| org.apache.spark.sql.catalyst.expressions.Lead | lead | SELECT a, b, lead(b) OVER (PARTITION BY a ORDER BY b) FROM VALUES ('A1', 2), ('A2', 3), ('A1', 1) tab(a, b) | struct<a:string,b:int,lead(b, 1, NULL) OVER (PARTITION BY a ORDER BY b ASC NULLS FIRST ROWS BETWEEN 1 FOLLOWING AND 1 FOLLOWING):int> |
...
| org.apache.spark.sql.catalyst.expressions.NTile | ntile | SELECT a, b, ntile(2) OVER (PARTITION BY a ORDER BY b) FROM VALUES ('A1', 2), ('A2', 3), ('A1', 1) tab(a, b) | struct<a:string,b:int,ntile(2) OVER (PARTITION BY a ORDER BY b ASC NULLS FIRST ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW):int> |
...
| org.apache.spark.sql.catalyst.expressions.PercentRank | percent_rank | SELECT a, b, percent_rank(b) OVER (PARTITION BY a ORDER BY b) FROM VALUES ('A1', 2), ('A2', 3), ('A1', 1) tab(a, b) | struct<a:string,b:int,PERCENT_RANK() OVER (PARTITION BY a ORDER BY b ASC NULLS FIRST ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW):double> |
...
| org.apache.spark.sql.catalyst.expressions.Rank | rank | SELECT a, b, rank(b) OVER (PARTITION BY a ORDER BY b) FROM VALUES ('A1', 2), ('A2', 3), ('A1', 1) tab(a, b) | struct<a:string,b:int,RANK() OVER (PARTITION BY a ORDER BY b ASC NULLS FIRST ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW):int> |
...
| org.apache.spark.sql.catalyst.expressions.RowNumber | row_number | SELECT a, b, row_number() OVER (PARTITION BY a ORDER BY b) FROM VALUES ('A1', 2), ('A2', 3), ('A1', 1) tab(a, b) | struct<a:string,b:int,row_number() OVER (PARTITION BY a ORDER BY b ASC NULLS FIRST ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW):int> |
...
| org.apache.spark.sql.catalyst.expressions.aggregate.CountMinSketchAgg | count_min_sketch | SELECT count_min_sketch(col, 0.1d, 0.9d, 0) FROM VALUES (1), (2), (1) AS tab(col) | struct<count_min_sketch(col, 0.1, 0.9, 0):binary> |

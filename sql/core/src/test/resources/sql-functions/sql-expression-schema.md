...
| org.apache.spark.sql.catalyst.expressions.TupleDifference | tuple_difference | SELECT tuple_sketch_estimate(tuple_difference(tuple_sketch_agg(struct(col1, val1)), tuple_sketch_agg(struct(col2, val2)))) FROM VALUES (5, 5.0, 4, 4.0), (1, 1.0, 4, 4.0), (2, 2.0, 5, 5.0), (3, 3.0, 1, 1.0) tab(col1, val1, col2, val2) | struct<tuple_sketch_estimate(tuple_difference(tuple_sketch_agg(struct(col1, val1), 12, double, sum), tuple_sketch_agg(struct(col2, val2), 12, double, sum), double), double):double> |
| org.apache.spark.sql.catalyst.expressions.TupleDifferenceTheta | tuple_difference_theta | SELECT tuple_sketch_estimate(tuple_difference_theta(tuple_sketch_agg(struct(col1, val1)), theta_sketch_agg(col2))) FROM VALUES (5, 5.0, 4), (1, 1.0, 4), (2, 2.0, 5), (3, 3.0, 1) tab(col1, val1, col2) | struct<tuple_sketch_estimate(tuple_difference_theta(tuple_sketch_agg(struct(col1, val1), 12, double, sum), theta_sketch_agg(col2, 12), double), double):double> |
| org.apache.spark.sql.catalyst.expressions.TupleIntersection | tuple_intersection | SELECT tuple_sketch_estimate(tuple_intersection(tuple_sketch_agg(struct(col1, val1)), tuple_sketch_agg(struct(col2, val2)))) FROM VALUES (1, 1.0, 1, 4.0), (2, 2.0, 2, 5.0), (3, 3.0, 4, 6.0) tab(col1, val1, col2, val2) | struct<tuple_sketch_estimate(tuple_intersection(tuple_sketch_agg(struct(col1, val1), 12, double, sum), tuple_sketch_agg(struct(col2, val2), 12, double, sum), double, sum), double):double> |
| org.apache.spark.sql.catalyst.expressions.TupleIntersectionTheta | tuple_intersection_theta | SELECT tuple_sketch_estimate(tuple_intersection_theta(tuple_sketch_agg(struct(col1, val1)), theta_sketch_agg(col2))) FROM VALUES (1, 1.0, 1), (2, 2.0, 2), (3, 3.0, 4) tab(col1, val1, col2) | struct<tuple_sketch_estimate(tuple_intersection_theta(tuple_sketch_agg(struct(col1, val1), 12, double, sum), theta_sketch_agg(col2, 12), double, sum), double):double> |
| org.apache.spark.sql.catalyst.expressions.TupleSketchEstimate | tuple_sketch_estimate | SELECT tuple_sketch_estimate(tuple_sketch_agg(struct(col, value))) FROM VALUES (1, 1.0), (1, 2.0), (2, 3.0) tab(col, value) | struct<tuple_sketch_estimate(tuple_sketch_agg(struct(col, value), 12, double, sum), double):double> |
| org.apache.spark.sql.catalyst.expressions.TupleSketchSummary | tuple_sketch_summary | SELECT tuple_sketch_summary(tuple_sketch_agg(struct(col, value))) FROM VALUES (1, 1.0), (1, 2.0), (2, 3.0) tab(col, value) | struct<tuple_sketch_summary(tuple_sketch_agg(struct(col, value), 12, double, sum), double, sum):double> |
| org.apache.spark.sql.catalyst.expressions.TupleUnion | tuple_union | SELECT tuple_sketch_estimate(tuple_union(tuple_sketch_agg(struct(col1, val1)), tuple_sketch_agg(struct(col2, val2)))) FROM VALUES (1, 1.0, 4, 4.0), (2, 2.0, 5, 5.0), (3, 3.0, 6, 6.0) tab(col1, val1, col2, val2) | struct<tuple_sketch_estimate(tuple_union(tuple_sketch_agg(struct(col1, val1), 12, double, sum), tuple_sketch_agg(struct(col2, val2), 12, double, sum), 12, double, sum), double):double> |
| org.apache.spark.sql.catalyst.expressions.TupleUnionTheta | tuple_union_theta | SELECT tuple_sketch_estimate(tuple_union_theta(tuple_sketch_agg(struct(col1, val1)), theta_sketch_agg(col2))) FROM VALUES (1, 1.0, 4), (2, 2.0, 5), (3, 3.0, 6) tab(col1, val1, col2) | struct<tuple_sketch_estimate(tuple_union_theta(tuple_sketch_agg(struct(col1, val1), 12, double, sum), theta_sketch_agg(col2, 12), 12, double, sum), double):double> |
...
| org.apache.spark.sql.catalyst.expressions.aggregate.TupleSketchAgg | tuple_sketch_agg | SELECT tuple_sketch_estimate(tuple_sketch_agg(struct(col, 1.0), 12, 'double', 'sum')) FROM VALUES (1), (1), (2), (2), (3) tab(col) | struct<tuple_sketch_estimate(tuple_sketch_agg(struct(col, 1.0), 12, double, sum), double):double> |

...
| org.apache.spark.sql.catalyst.expressions.WithFields | with_fields | SELECT with_fields(NAMED_STRUCT("a", 1, "b", 2), "c", 3) | struct<with_fields(named_struct(a, 1, b, 2), c, 3):struct<a:int,b:int,c:int>> |

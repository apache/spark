...
| org.apache.spark.sql.catalyst.expressions.BitmapConstructAgg | bitmap_construct_agg | SELECT bitmap_construct_agg(bitmap_bit_position(col)) FROM VALUES (1), (2), (3) AS tab(col) | struct<bitmap_construct_agg(bitmap_bit_position(col)):binary> |
...
| org.apache.spark.sql.catalyst.expressions.BitmapOrAgg | bitmap_or_agg | SELECT bitmap_or_agg(col) FROM VALUES (X '10'), (X '20'), (X '40') AS tab(col) | struct<bitmap_or_agg(col):binary> |

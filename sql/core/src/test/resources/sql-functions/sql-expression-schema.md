...
| org.apache.spark.sql.catalyst.expressions.BinaryTrim | btrim | SELECT btrim(encode('    SparkSQL   ', 'utf-8')) | struct<btrim(encode(    SparkSQL   , utf-8)):binary> |

...
SELECT IF(true, cast(1 as tinyint), cast(2 as short)) FROM t;
...
SELECT IF(true, cast(1 as smallint), cast(2 as short)) FROM t;
...
SELECT IF(true, cast(1 as short), cast(2 as tinyint)) FROM t;
SELECT IF(true, cast(1 as short), cast(2 as smallint)) FROM t;
SELECT IF(true, cast(1 as short), cast(2 as short)) FROM t;
SELECT IF(true, cast(1 as short), cast(2 as int)) FROM t;
SELECT IF(true, cast(1 as short), cast(2 as bigint)) FROM t;
SELECT IF(true, cast(1 as short), cast(2 as float)) FROM t;
SELECT IF(true, cast(1 as short), cast(2 as double)) FROM t;
SELECT IF(true, cast(1 as short), cast(2 as decimal(10, 0))) FROM t;
SELECT IF(true, cast(1 as short), cast(2 as string)) FROM t;
SELECT IF(true, cast(1 as short), cast('2' as binary)) FROM t;
SELECT IF(true, cast(1 as short), cast(2 as boolean)) FROM t;
SELECT IF(true, cast(1 as short), cast('2017-12-11 09:30:00.0' as timestamp)) FROM t;
SELECT IF(true, cast(1 as short), cast('2017-12-11 09:30:00' as date)) FROM t;

SELECT IF(true, cast(1 as int), cast(2 as tinyint)) FROM t;
SELECT IF(true, cast(1 as int), cast(2 as smallint)) FROM t;
SELECT IF(true, cast(1 as int), cast(2 as short)) FROM t;
...
SELECT IF(true, cast(1 as bigint), cast(2 as short)) FROM t;
...
SELECT IF(true, cast(1 as float), cast(2 as short)) FROM t;
...
SELECT IF(true, cast(1 as double), cast(2 as short)) FROM t;
...
SELECT IF(true, cast(1 as decimal(10, 0)), cast(2 as short)) FROM t;
...
SELECT IF(true, cast(1 as string), cast(2 as short)) FROM t;
...
SELECT IF(true, cast('1' as binary), cast(2 as short)) FROM t;
...
SELECT IF(true, cast(1 as boolean), cast(2 as short)) FROM t;
...
SELECT IF(true, cast('2017-12-12 09:30:00.0' as timestamp), cast(2 as short)) FROM t;
...
SELECT IF(true, cast('2017-12-12 09:30:00' as date), cast(2 as short)) FROM t;

...
-- Enable the lpad rpad binary breaking change
SET spark.sql.legacy.lpadRpadForBinaryType.enabled=true;
...
SET spark.sql.legacy.lpadRpadForBinaryType.enabled=false;
...
RESET spark.databricks.behaviorChange.SC90836LpadRpadForBinary.enabled;

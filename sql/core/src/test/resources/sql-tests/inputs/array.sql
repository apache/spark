...
-- -- the configuration spark.sql.ansi.strictIndexOperator doesn't control function elt
select elt(4, '123', '456');
select elt(0, '123', '456');
select elt(-1, '123', '456');

-- [] operator will throw exceptions if array index is out of bound under ANSI mode.

...
SELECT '' AS to_char_9,  to_char(q2, '0999999999999999')       FROM INT8_TBL WHERE id = 1;
SELECT '' AS to_char_10, to_char(q2, 'S0999999999999999')      FROM INT8_TBL WHERE id = 1;
...
SELECT '' AS to_char_17, to_char(q2, '999999SG9999999999')     FROM INT8_TBL WHERE id = 1;

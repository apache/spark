...
SELECT '' AS to_char_9,  to_char(val, '0999999999999999.999999999999999')       FROM num_data WHERE id = 1;
SELECT '' AS to_char_10, to_char(val, 'S0999999999999999.999999999999999')      FROM num_data WHERE id = 1;
...
SELECT '' AS to_char_21, to_char(val, '999999SG9999999999')			FROM num_data WHERE id = 1;

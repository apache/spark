...
CREATE TEMPORARY VIEW t2 AS select interval 1010 year 9 month as c;
...
CREATE TEMPORARY VIEW t3 AS select interval 8 day 7 hour 6 minute 5 second 4 millisecond 3 microsecond as c;

select date_part('millennium', c) from t3;
select date_part('millennia', c) from t3;
select date_part('mil', c) from t3;
select date_part('mils', c) from t3;

select date_part('century', c) from t3;
select date_part('centuries', c) from t3;
select date_part('c', c) from t3;
select date_part('cent', c) from t3;

select date_part('decade', c) from t3;
select date_part('decades', c) from t3;
select date_part('dec', c) from t3;
select date_part('decs', c) from t3;

select date_part('year', c) from t3;
select date_part('y', c) from t3;
select date_part('years', c) from t3;
select date_part('yr', c) from t3;
select date_part('yrs', c) from t3;

select date_part('quarter', c) from t3;
select date_part('qtr', c) from t3;

select date_part('month', c) from t3;
select date_part('mon', c) from t3;
select date_part('mons', c) from t3;
select date_part('months', c) from t3;

select date_part('day', c) from t3;
select date_part('d', c) from t3;
select date_part('days', c) from t3;

select date_part('hour', c) from t3;
select date_part('h', c) from t3;
select date_part('hours', c) from t3;
select date_part('hr', c) from t3;
select date_part('hrs', c) from t3;

select date_part('minute', c) from t3;
select date_part('m', c) from t3;
select date_part('min', c) from t3;
select date_part('mins', c) from t3;
select date_part('minutes', c) from t3;

select date_part('second', c) from t3;
select date_part('s', c) from t3;
select date_part('sec', c) from t3;
select date_part('seconds', c) from t3;
select date_part('secs', c) from t3;

select date_part('milliseconds', c) from t3;
select date_part('msec', c) from t3;
select date_part('msecs', c) from t3;
select date_part('millisecon', c) from t3;
select date_part('mseconds', c) from t3;
select date_part('ms', c) from t3;

select date_part('microseconds', c) from t3;
select date_part('usec', c) from t3;
select date_part('usecs', c) from t3;
select date_part('useconds', c) from t3;
select date_part('microsecon', c) from t3;
select date_part('us', c) from t3;

select date_part('epoch', c) from t3;

select date_part('not_supported', c) from t3;

select date_part(c, c) from t3;

select date_part(null, c) from t3;

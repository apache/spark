...
select to_timestamp_ntz(to_timestamp_ltz(null)), to_timestamp_ntz(to_timestamp_ltz('2016-12-31 00:12:00')), to_timestamp_ntz(to_timestamp_ltz('2016-12-31', 'yyyy-MM-dd'));
select to_timestamp_ntz(to_timestamp_ntz(null)), to_timestamp_ntz(to_timestamp_ntz('2016-12-31 00:12:00')), to_timestamp_ntz(to_timestamp_ntz('2016-12-31', 'yyyy-MM-dd'));

...
CREATE VIEW v1 DEFAULT COLLATION UNICODE AS SELECT 'a';
SELECT * FROM v;

DROP VIEW IF EXISTS v;
CREATE VIEW v DEFAULT COLLATION UTF8_LCASE SELECT 'a' AS c1;
...
AS SELECT 'a' AS c1, (SELECT (SELECT CASE 'a' = 'A' WHEN TRUE THEN 'a' ELSE 'b' END) WHERE (SELECT 'b' WHERE 'c' = 'C') = 'B') AS c2;
SELECT COUNT(*) FROM v WHERE c1 = 'A';
...
DROP VIEW IF EXISTS v;
CREATE TEMPORARY VIEW v1 DEFAULT COLLATION UNICODE AS SELECT 'a';
SELECT * FROM v;

DROP VIEW IF EXISTS v;
CREATE TEMPORARY VIEW v DEFAULT COLLATION UTF8_LCASE SELECT 'a' AS c1;
SELECT COUNT(*) FROM v WHERE c1 = 'A';

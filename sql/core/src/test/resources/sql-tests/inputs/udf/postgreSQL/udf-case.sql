...
-- [SPARK-33614] PostgreSQL throws an exception but Spark SQL returns correct
-- result except when using Python UDFs
-- TODO: uncomment this once we find out how to fix `ExtractPythonUDFs`
--

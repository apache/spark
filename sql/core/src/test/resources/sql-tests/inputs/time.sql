...
-- Test with ANSI mode disabled (invalid inputs return NULL)
...
SELECT time_from_seconds(-1);           -- invalid: negative
SELECT time_from_seconds(86400);        -- invalid: >= 86400
SELECT time_from_seconds(90000);        -- invalid: >= 86400
...
SELECT time_from_millis(-1);            -- invalid: negative
SELECT time_from_millis(86400000);      -- invalid: >= 86400000
...
SELECT time_from_micros(-1);            -- invalid: negative
SELECT time_from_micros(86400000000);   -- invalid: >= 86400000000
...
-- Test with ANSI mode enabled (invalid inputs throw exceptions)

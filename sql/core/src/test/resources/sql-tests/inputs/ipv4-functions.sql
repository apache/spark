...
-- try_inet_ntoa: valid and null input
select try_inet_ntoa(0L);
select try_inet_ntoa(4294967295L);
select try_inet_ntoa(null);

-- try_inet_ntoa: invalid input always returns null
select try_inet_ntoa(-1L);
select try_inet_ntoa(4294967296L);
...
select inet_ntoa(cast(1.5 as decimal(3, 1)));

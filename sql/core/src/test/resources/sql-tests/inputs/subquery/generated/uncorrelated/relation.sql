...
-- innerTable=inner_table INNER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(inner_table.a) AS aggFunctionAlias],groupingExpr=[inner_table.b])
...
-- innerTable=no_match_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 10
...
-- innerTable=null_table LEFT OUTER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(null_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=null_table LEFT OUTER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(null_table.a) AS aggFunctionAlias],groupingExpr=[null_table.b])
...
-- innerTable=inner_table LEFT OUTER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 1
...
-- innerTable=inner_table INNER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(inner_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=null_table INNER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[COUNT(null_table.a) AS aggFunctionAlias],groupingExpr=[null_table.b])
...
-- innerTable=inner_table RIGHT OUTER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[COUNT(inner_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=no_match_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=AGGREGATE(resultExpr=[SUM(no_match_table.a) AS aggFunctionAlias],groupingExpr=[no_match_table.b])
...
-- innerTable=inner_table LEFT OUTER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(inner_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=(SELECT null_table.a, null_table.b FROM null_table UNION SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 1
...
-- innerTable=null_table INNER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[COUNT(null_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=inner_table LEFT OUTER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=AGGREGATE(resultExpr=[SUM(inner_table.a) AS aggFunctionAlias],groupingExpr=[inner_table.b])
...
-- innerTable=(SELECT null_table.a, null_table.b FROM null_table UNION SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=inner_table LEFT OUTER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(inner_table.a) AS aggFunctionAlias],groupingExpr=[inner_table.b])
...
-- innerTable=(SELECT null_table.a, null_table.b FROM null_table UNION SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 10
...
-- innerTable=(SELECT no_match_table.a, no_match_table.b FROM no_match_table EXCEPT SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=null_table LEFT OUTER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 10
...
-- innerTable=inner_table RIGHT OUTER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 1
...
-- innerTable=inner_table INNER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[COUNT(inner_table.a) AS aggFunctionAlias],groupingExpr=[inner_table.b])
...
-- innerTable=null_table INNER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 10
...
-- innerTable=null_table LEFT OUTER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[COUNT(null_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=null_table LEFT OUTER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=AGGREGATE(resultExpr=[COUNT(null_table.a) AS aggFunctionAlias],groupingExpr=[null_table.b])
...
-- innerTable=inner_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=null_table LEFT OUTER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 1
...
-- innerTable=inner_table RIGHT OUTER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[COUNT(inner_table.a) AS aggFunctionAlias],groupingExpr=[inner_table.b])
...
-- innerTable=inner_table LEFT OUTER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 10
...
-- innerTable=inner_table LEFT OUTER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=AGGREGATE(resultExpr=[COUNT(inner_table.a) AS aggFunctionAlias],groupingExpr=[inner_table.b])
...
-- innerTable=null_table INNER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(null_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=null_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[COUNT(null_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=(SELECT inner_table.a, inner_table.b FROM inner_table INTERSECT SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=(SELECT inner_table.a, inner_table.b FROM inner_table EXCEPT SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=null_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 10
...
-- innerTable=inner_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[COUNT(inner_table.a) AS aggFunctionAlias],groupingExpr=[inner_table.b])
...
-- innerTable=inner_table RIGHT OUTER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=inner_table RIGHT OUTER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=AGGREGATE(resultExpr=[COUNT(inner_table.a) AS aggFunctionAlias],groupingExpr=[inner_table.b])
...
-- innerTable=(SELECT no_match_table.a, no_match_table.b FROM no_match_table INTERSECT SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 10
...
-- innerTable=inner_table INNER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 10
...
-- innerTable=null_table INNER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=AGGREGATE(resultExpr=[COUNT(null_table.a) AS aggFunctionAlias],groupingExpr=[null_table.b])
...
-- innerTable=null_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=(SELECT null_table.a, null_table.b FROM null_table UNION SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 10
...
-- innerTable=null_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 10
...
-- innerTable=no_match_table INNER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 1
...
-- innerTable=(SELECT no_match_table.a, no_match_table.b FROM no_match_table UNION SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 1
...
-- innerTable=no_match_table RIGHT OUTER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 10
...
-- innerTable=(SELECT no_match_table.a, no_match_table.b FROM no_match_table UNION SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 10
...
-- innerTable=null_table RIGHT OUTER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=AGGREGATE(resultExpr=[COUNT(null_table.a) AS aggFunctionAlias],groupingExpr=[null_table.b])
...
-- innerTable=null_table RIGHT OUTER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[COUNT(null_table.a) AS aggFunctionAlias],groupingExpr=[null_table.b])
...
-- innerTable=no_match_table INNER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(no_match_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=inner_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=AGGREGATE(resultExpr=[SUM(inner_table.a) AS aggFunctionAlias],groupingExpr=[inner_table.b])
...
-- innerTable=inner_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(inner_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=inner_table LEFT OUTER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 10
...
-- innerTable=(SELECT inner_table.a, inner_table.b FROM inner_table UNION SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 1
...
-- innerTable=(SELECT no_match_table.a, no_match_table.b FROM no_match_table EXCEPT SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 1
...
-- innerTable=null_table INNER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 10
...
-- innerTable=null_table LEFT OUTER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=no_match_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[COUNT(no_match_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=no_match_table LEFT OUTER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 1
...
-- innerTable=no_match_table LEFT OUTER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(no_match_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=null_table INNER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(null_table.a) AS aggFunctionAlias],groupingExpr=[null_table.b])
...
-- innerTable=no_match_table RIGHT OUTER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=no_match_table INNER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[COUNT(no_match_table.a) AS aggFunctionAlias],groupingExpr=[no_match_table.b])
...
-- innerTable=no_match_table INNER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=null_table RIGHT OUTER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(null_table.a) AS aggFunctionAlias],groupingExpr=[null_table.b])
...
-- innerTable=inner_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(inner_table.a) AS aggFunctionAlias],groupingExpr=[inner_table.b])
...
-- innerTable=(SELECT no_match_table.a, no_match_table.b FROM no_match_table EXCEPT SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 10
...
-- innerTable=no_match_table INNER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=AGGREGATE(resultExpr=[COUNT(no_match_table.a) AS aggFunctionAlias],groupingExpr=[no_match_table.b])
...
-- innerTable=inner_table RIGHT OUTER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(inner_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=null_table INNER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=null_table LEFT OUTER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=AGGREGATE(resultExpr=[SUM(null_table.a) AS aggFunctionAlias],groupingExpr=[null_table.b])
...
-- innerTable=(SELECT inner_table.a, inner_table.b FROM inner_table UNION SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 10
...
-- innerTable=no_match_table INNER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(no_match_table.a) AS aggFunctionAlias],groupingExpr=[no_match_table.b])
...
-- innerTable=null_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=AGGREGATE(resultExpr=[COUNT(null_table.a) AS aggFunctionAlias],groupingExpr=[null_table.b])
...
-- innerTable=no_match_table LEFT OUTER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[COUNT(no_match_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=no_match_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=AGGREGATE(resultExpr=[COUNT(no_match_table.a) AS aggFunctionAlias],groupingExpr=[no_match_table.b])
...
-- innerTable=inner_table INNER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=AGGREGATE(resultExpr=[COUNT(inner_table.a) AS aggFunctionAlias],groupingExpr=[inner_table.b])
...
-- innerTable=no_match_table INNER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 10
...
-- innerTable=(SELECT inner_table.a, inner_table.b FROM inner_table INTERSECT SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 10
...
-- innerTable=(SELECT inner_table.a, inner_table.b FROM inner_table UNION SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 10
...
-- innerTable=inner_table INNER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=no_match_table LEFT OUTER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 10
...
-- innerTable=null_table RIGHT OUTER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(null_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=null_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 1
...
-- innerTable=no_match_table RIGHT OUTER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(no_match_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=null_table RIGHT OUTER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=inner_table INNER JOIN join_table ON inner_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[COUNT(inner_table.a) AS aggFunctionAlias],groupingExpr=[])
...
-- innerTable=no_match_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=null_table INNER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 1
...
-- innerTable=(SELECT inner_table.a, inner_table.b FROM inner_table INTERSECT SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 1
...
-- innerTable=no_match_table INNER JOIN join_table ON no_match_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 10
...
-- innerTable=null_table RIGHT OUTER JOIN join_table ON null_table.a = join_table.a, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 10
...
-- innerTable=inner_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 1
...
-- innerTable=(SELECT null_table.a, null_table.b FROM null_table INTERSECT SELECT join_table.a, join_table.b FROM join_table) AS innerSubqueryAlias, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=LIMIT 1
...
-- innerTable=no_match_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=false, subqueryOperator=AGGREGATE(resultExpr=[SUM(no_match_table.a) AS aggFunctionAlias],groupingExpr=[no_match_table.b])
...
-- innerTable=no_match_table, outerTable=outer_table, subqueryLocation=FROM, subqueryType=RELATION, isCorrelated=false, subqueryDistinct=true, subqueryOperator=LIMIT 10

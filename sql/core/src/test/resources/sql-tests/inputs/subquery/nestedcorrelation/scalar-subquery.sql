...
SELECT i, (SELECT SUM(ss1.i) FROM (SELECT i FROM table_integers s1 WHERE i>ANY(SELECT i FROM table_integers WHERE i<>s1.i)) ss1) AS j FROM table_integers i1 ORDER BY i;

SELECT i, (SELECT SUM(ss2.i) FROM (SELECT i FROM table_integers s1 WHERE i=i1.i AND i=ANY(SELECT i FROM table_integers WHERE i=s1.i)) ss2) AS j FROM table_integers i1 ORDER BY i;
...
SELECT i, (SELECT SUM(ss1.i)+SUM(ss2.i) FROM (SELECT i FROM table_integers s1 WHERE i>ANY(SELECT i FROM table_integers WHERE i<>s1.i)) ss1 LEFT OUTER JOIN (SELECT i FROM table_integers s1 WHERE i=ANY(SELECT i FROM table_integers WHERE i=s1.i)) ss2 ON ss1.i=ss2.i) AS j FROM table_integers i1 ORDER BY i;
...
SELECT i, (SELECT SUM(ss2.i) FROM (SELECT i FROM table_integers s1 WHERE CASE WHEN (i=i1.i AND i=ANY(SELECT i FROM table_integers WHERE i=s1.i)) THEN true ELSE false END) ss2) AS j FROM table_integers i1 ORDER BY i;

SELECT i, (SELECT SUM(ss2.i) FROM (SELECT i FROM table_integers s1 WHERE i=i1.i AND i=ANY(SELECT i FROM table_integers WHERE i=s1.i)) ss2) AS j FROM table_integers i1 ORDER BY i;

SELECT i, (SELECT SUM(ss2.i) FROM (SELECT i FROM table_integers s1 WHERE i=i1.i) ss2) AS j FROM table_integers i1 ORDER BY i;

SELECT i, (SELECT SUM(ss2.i) FROM (SELECT i FROM table_integers s1 WHERE i=ANY(SELECT i FROM table_integers WHERE i=s1.i)) ss2) AS j FROM table_integers i1 ORDER BY i;

SELECT i, (SELECT i=ANY(SELECT i FROM table_integers WHERE i=s1.i) FROM table_integers s1 WHERE i=i1.i) AS j FROM table_integers i1 ORDER BY i;
...
SELECT i, (SELECT SUM(ss1.i) FROM (SELECT i FROM table_integers s1 WHERE i>ANY(SELECT i FROM table_integers WHERE i<>s1.i)) ss1 LEFT OUTER JOIN (SELECT i FROM table_integers s1 WHERE i=i1.i AND i=ANY(SELECT i FROM table_integers WHERE i=s1.i)) ss2 ON ss1.i=ss2.i) AS j FROM table_integers i1 ORDER BY i;

SELECT i, (SELECT SUM(ss2.i) FROM (SELECT i FROM table_integers s1 WHERE i>ANY(SELECT i FROM table_integers WHERE i<>s1.i)) ss1 LEFT OUTER JOIN (SELECT i FROM table_integers s1 WHERE i=i1.i AND i=ANY(SELECT i FROM table_integers WHERE i=s1.i)) ss2 ON ss1.i=ss2.i) AS j FROM table_integers i1 ORDER BY i;

SELECT i, (SELECT SUM(ss1.i)+SUM(ss2.i) FROM (SELECT i FROM table_integers s1 WHERE i>ANY(SELECT i FROM table_integers WHERE i<>s1.i)) ss1 LEFT OUTER JOIN (SELECT i FROM table_integers s1 WHERE i=i1.i AND i=ANY(SELECT i FROM table_integers WHERE i=s1.i)) ss2 ON ss1.i=ss2.i) AS j FROM table_integers i1 ORDER BY i;

SELECT i, (SELECT SUM(ss1.i)+SUM(ss2.i) FROM (SELECT i FROM table_integers s1 WHERE i=i1.i AND i>ANY(SELECT i FROM table_integers WHERE i<>s1.i)) ss1 LEFT OUTER JOIN (SELECT i FROM table_integers s1 WHERE i=ANY(SELECT i FROM table_integers WHERE i=s1.i)) ss2 ON ss1.i=ss2.i) AS j FROM table_integers i1 ORDER BY i;

SELECT i, (SELECT SUM(ss1.i)+SUM(ss2.i) FROM (SELECT i FROM table_integers s1 WHERE i=i1.i AND i>ANY(SELECT i FROM table_integers WHERE i<>s1.i)) ss1 LEFT OUTER JOIN (SELECT i FROM table_integers s1 WHERE i<>i1.i OR i=ANY(SELECT i FROM table_integers WHERE i=s1.i)) ss2 ON ss1.i=ss2.i) AS j FROM table_integers i1 ORDER BY i;

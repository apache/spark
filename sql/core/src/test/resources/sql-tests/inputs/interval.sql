...
select interval '中文 interval 1中文day';
...
-- intervals with alias
select interval '1';
select interval '1' as;
select interval '1' as day;
select interval '1' day as;
...
select interval 1 day day;
select interval 1 day as day;
select interval '1' day '2' hour as i;
select interval '1-2' year to month as i;
select interval '1-2' year as i;

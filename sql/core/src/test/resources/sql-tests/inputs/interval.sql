...
SELECT INTERVAL '1 02' DAY TO HOUR >= INTERVAL '1 01:59' DAY TO MINUTE;
SELECT INTERVAL '0 00:00:00.999' DAY TO SECOND < INTERVAL '1' SECOND;
SELECT INTERVAL '0 00:00:01.000' DAY TO SECOND <= INTERVAL '1' SECOND;
SELECT INTERVAL '1 00:00:01' DAY TO SECOND = INTERVAL '1 00:00' DAY TO MINUTE;
SELECT INTERVAL '02:11' HOUR TO MINUTE >= INTERVAL '02:10:55' HOUR TO SECOND;
SELECT INTERVAL '00:10:56' HOUR TO SECOND >= INTERVAL '10:55' MINUTE TO SECOND;
SELECT INTERVAL '1' DAY <= INTERVAL '1' HOUR;
...
SELECT INTERVAL '1-1' YEAR TO MONTH > INTERVAL '0' MONTH;
SELECT INTERVAL '0-0' YEAR TO MONTH > INTERVAL '-1' MONTH;
SELECT INTERVAL '-1-1' YEAR TO MONTH = INTERVAL '-13' MONTH;
SELECT INTERVAL '-1-1' YEAR TO MONTH < INTERVAL '-13' MONTH;
SELECT INTERVAL '-1-1' YEAR TO MONTH <= INTERVAL '-12' MONTH;
SELECT INTERVAL '-1 00:00:00' DAY TO SECOND <= INTERVAL '-1 00:00' DAY TO MINUTE;
SELECT INTERVAL '-1 01:00:00' DAY TO SECOND <= INTERVAL '-1 02:00' DAY TO MINUTE;
SELECT INTERVAL '-1 00:00:00.999' DAY TO SECOND >= INTERVAL '-1 00:00:01' DAY TO SECOND;

SELECT INTERVAL '13' MONTH > INTERVAL '1' DAY;
SELECT INTERVAL '1-1' YEAR TO MONTH <= INTERVAL '1 01:01:01.111' DAY TO SECOND;
SELECT INTERVAL '1' MONTH = INTERVAL '01:01:01.111' HOUR TO SECOND;


SELECT array(INTERVAL '1-1' YEAR TO MONTH, INTERVAL '1' YEAR, INTERVAL '1' MONTH);
SELECT array(
  INTERVAL '1' DAY,
  INTERVAL '1 01' DAY TO HOUR,
  INTERVAL '1 01:01' DAY TO MINUTE,
  INTERVAL '1 01:01:01.111' DAY TO SECOND,
  INTERVAL '1' HOUR,
  INTERVAL '01:01' HOUR TO MINUTE,
  INTERVAL '01:01:01.111' HOUR TO SECOND,
  INTERVAL '1' MINUTE,
  INTERVAL '01:01.111' MINUTE TO SECOND,
  INTERVAL '01.111' SECOND
  );

SELECT coalesce(INTERVAL '1-1' YEAR TO MONTH, INTERVAL '1' YEAR, INTERVAL '1' MONTH);
SELECT coalesce(
  INTERVAL '1' DAY,
  INTERVAL '1 01' DAY TO HOUR,
  INTERVAL '1 01:01' DAY TO MINUTE,

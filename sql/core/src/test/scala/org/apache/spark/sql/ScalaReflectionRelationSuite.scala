...
class ScalaReflectionRelationSuite extends FunSuite {
  ...
  test("query case class RDD") {
    ...
    rdd.toDataFrame.registerTempTable("reflectData")
  ...
  test("query case class RDD with nulls") {
    ...
    val rdd = sparkContext.parallelize(data :: Nil)
    rdd.toDataFrame.registerTempTable("reflectNullData")
  ...
  test("query case class RDD with Nones") {
    ...
    val rdd = sparkContext.parallelize(data :: Nil)
    rdd.toDataFrame.registerTempTable("reflectOptionalData")
  ...
  test("query binary data") {
    ...
    rdd.toDataFrame.registerTempTable("reflectBinary")
  ...
  test("query complex data") {
    val data = ComplexReflectData(
      ...
      Data(
        ...
        Nested(None, "abc")))
    val rdd = sparkContext.parallelize(data :: Nil)
    rdd.toDataFrame.registerTempTable("reflectComplexData")

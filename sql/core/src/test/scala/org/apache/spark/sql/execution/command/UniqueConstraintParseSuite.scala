    ...
    Seq(
      ...
      plan match {
        case c: CreateTable =>
          ...
          assert(tableSpec.constraints.head.name.matches("t_uniq_[0-9a-zA-Z]{6}"))
    ...
    Seq(
      ...
      plan match {
        case c: CreateTable =>
          ...
          assert(tableSpec.constraints.last.name.matches("t_uniq_[0-9a-zA-Z]{6}"))
  ...
  test("Add unnamed unique constraint") {
    ...
    plan match {
      case a: AddConstraint =>
        ...
        assert(a.tableConstraint.name.matches("c_uniq_[0-9a-zA-Z]{6}"))

 ...
 *     `org.apache.spark.sql.execution.command.v2.AlterTableDropColumnSuite`
 *   - V1 table catalog tests:
 *     `org.apache.spark.sql.execution.command.v1.AlterTableDropColumnSuiteBase`
 ...
 */
trait AlterTableDropColumnSuiteBase extends QueryTest with DDLCommandTestUtils {
  override val command = "ALTER TABLE .. DROP COLUMN"
}

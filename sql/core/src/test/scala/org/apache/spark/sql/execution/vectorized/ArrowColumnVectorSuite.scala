...
class ArrowColumnVectorSuite extends SparkFunSuite {
  ...
  test("boolean") {
    ...
    val vector = ArrowUtils.toArrowField("boolean", BooleanType, nullable = true, None)
  ...
  test("byte") {
    ...
    val vector = ArrowUtils.toArrowField("byte", ByteType, nullable = true, None)
  ...
  test("short") {
    ...
    val vector = ArrowUtils.toArrowField("short", ShortType, nullable = true, None)
  ...
  test("int") {
    ...
    val vector = ArrowUtils.toArrowField("int", IntegerType, nullable = true, None)
  ...
  test("long") {
    ...
    val vector = ArrowUtils.toArrowField("long", LongType, nullable = true, None)
  ...
  test("float") {
    ...
    val vector = ArrowUtils.toArrowField("float", FloatType, nullable = true, None)
  ...
  test("double") {
    ...
    val vector = ArrowUtils.toArrowField("double", DoubleType, nullable = true, None)
  ...
  test("string") {
    ...
    val vector = ArrowUtils.toArrowField("string", StringType, nullable = true, None)
  ...
  test("binary") {
    ...
    val vector = ArrowUtils.toArrowField("binary", BinaryType, nullable = true, None)
  ...
  test("array") {
    ...
    val vector = ArrowUtils.toArrowField("array", ArrayType(IntegerType), nullable = true, None)
  ...
  test("struct") {
    ...
    val vector = ArrowUtils.toArrowField("struct", schema, nullable = true, None)

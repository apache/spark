...
class ValidateRequirementsSuite extends PlanTest with SharedSparkSession {
  ...
  private def testValidate(
    ...
    val table1 =
      spark.range(10).select(Symbol("id") + 1 as Symbol("a1"), Symbol("id") + 2 as Symbol("b1"), Symbol("id") + 3 as Symbol("c1"))
        .queryExecution.executedPlan
    val table2 =
      spark.range(10).select(Symbol("id") + 1 as Symbol("a2"), Symbol("id") + 2 as Symbol("b2"), Symbol("id") + 3 as Symbol("c2"))
        .queryExecution.executedPlan
  ...
  private def testNestedJoin(
    ...
    val table2 =
      spark.range(10).select(Symbol("id") + 1 as Symbol("a2"), Symbol("id") + 2 as Symbol("b2"), Symbol("id") + 3 as Symbol("c2"))
        .queryExecution.executedPlan
    val table3 =
      spark.range(10).select(Symbol("id") + 1 as Symbol("a3"), Symbol("id") + 2 as Symbol("b3"), Symbol("id") + 3 as Symbol("c3"))
        .queryExecution.executedPlan

...
object ColumnarTestUtils {
  ...
  def makeRandomValues(head: ColumnType[_], tail: ColumnType[_]*): Seq[Any] = makeRandomValues(
    Seq(head) ++ tail)
  ...
  def makeRandomRow(head: ColumnType[_], tail: ColumnType[_]*): InternalRow = makeRandomRow(
    Seq(head) ++ tail)

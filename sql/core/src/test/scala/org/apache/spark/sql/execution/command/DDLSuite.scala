...
abstract class DDLSuite extends QueryTest with SQLTestUtils {
  ...
  test("create table - column repeated in partition columns") {
    ...
    assert(e.message == "Found duplicate column(s) in the partition columns of `tbl`: `a`")
  }
  ...
  test("create table - column repeated in bucket columns") {
    ...
    assert(e.message == "Found duplicate column(s) in the bucket column names of `tbl`: `a`")
  }

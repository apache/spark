...
//    checkScan(query,
//      "struct<id:int,name:struct<first:string,middle:string,l
  //      ast:string>,address:string,pets:int," +
...
//    checkAnswer(query.orderBy("id"),
//      Row(2, "Jones", null, "Janet", null, null, null,
  //      null, null, null, null, "567 Maple Drive") ::

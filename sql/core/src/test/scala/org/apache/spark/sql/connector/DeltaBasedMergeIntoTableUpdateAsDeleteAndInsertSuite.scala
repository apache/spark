  ...
  test("merge handles metadata columns correctly") {
    withTempView("source") {
      ...
      checkLastWriteLog(
        ...
        insertWriteLogEntry(metadata = Row("hr", null), data = Row(3, 301, "hr")),
        deleteWriteLogEntry(id = 4, metadata = Row("hr", null)),
        insertWriteLogEntry(metadata = Row("hr", null), data = Row(4, 401, "hr")),
        deleteWriteLogEntry(id = 5, metadata = Row("hr", null)),
        insertWriteLogEntry(metadata = Row("hr", null), data = Row(5, 501, "hr")),

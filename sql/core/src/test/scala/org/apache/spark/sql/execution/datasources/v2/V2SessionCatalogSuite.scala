...
import org.apache.spark.sql.connector.catalog.{CatalogManager, CatalogV2Util, Column, Identifier, NamespaceChange, SupportsNamespaces, TableCatalog, TableChange, V1Table}
...
abstract class V2SessionCatalogBaseSuite extends SharedSparkSession with BeforeAndAfter {
  ...
  val testIdentQuoted: String =
    (CatalogManager.SESSION_CATALOG_NAME +: testIdent.namespace :+ testIdent.name)

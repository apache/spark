...
class CollationStringExpressionsSuite
  ...
  test("Support StringTranslate string expression with collation") {
    ...
    val testCases = Seq(
      ...
      TranslateTestCase("Translate", "Rn", "1234", "UTF8_BINARY", "Tra2slate"),
      TranslateTestCase("Translate", "Rnlt", "1234", "UTF8_BINARY", "Tra2s3a4e"),
      TranslateTestCase("TRanslate", "rnlt", "XxXx", "UTF8_BINARY", "TRaxsXaxe"),
      TranslateTestCase("TRanslater", "Rrnlt", "xXxXx", "UTF8_BINARY", "TxaxsXaxeX"),
      TranslateTestCase("TRanslater", "Rrnlt", "XxxXx", "UTF8_BINARY", "TXaxsXaxex"),
      TranslateTestCase("test大千世界X大千世界", "界x", "AB", "UTF8_BINARY", "test大千世AX大千世A"),
      TranslateTestCase("大千世界test大千世界", "TEST", "abcd", "UTF8_BINARY", "大千世界test大千世界"),
      TranslateTestCase("Test大千世界大千世界", "tT", "oO", "UTF8_BINARY", "Oeso大千世界大千世界"),
      TranslateTestCase("大千世界大千世界tesT", "Tt", "Oo", "UTF8_BINARY", "大千世界大千世界oesO"),
      TranslateTestCase("大千世界大千世界tesT", "大千", "世世", "UTF8_BINARY", "世世世界世世世界tesT"),
      ...
      TranslateTestCase("i\u0307", "İ", "xy", "UTF8_BINARY", "i\u0307"),
      TranslateTestCase("i\u030A", "İ", "x", "UTF8_BINARY", "i\u030A"),
      TranslateTestCase("i\u030A", "İi", "xy", "UTF8_BINARY", "y\u030A"),
      ...
      TranslateTestCase("i\u0307", "İ", "xy", "UTF8_LCASE", "x"),
      TranslateTestCase("i\u030A", "İ", "x", "UTF8_LCASE", "i\u030A"),
      ...
      TranslateTestCase("İ", "i\u0307", "xy", "UNICODE", "İ"),
      TranslateTestCase("i\u0307", "İ", "xy", "UNICODE", "i\u0307"),
      TranslateTestCase("i\u030A", "İ", "x", "UNICODE", "i\u030A"),
      TranslateTestCase("i\u030A", "İi", "xy", "UNICODE", "i\u030A"),
      ...
      TranslateTestCase("İ", "i\u0307", "xy", "UNICODE_CI", "İ"),
      TranslateTestCase("i\u0307", "İ", "xy", "UNICODE_CI", "x"),
      TranslateTestCase("i\u030A", "İ", "x", "UNICODE_CI", "i\u030A"),
      TranslateTestCase("i\u030A", "İi", "xy", "UNICODE_CI", "i\u030A"),

  ...
  test("join operator selection") {
    ...
    withSQLConf(SQLConf.AUTO_BROADCASTJOIN_THRESHOLD.key -> "0",
      ...
      Seq(
        ...
        ("SELECT * FROM testData LEFT JOIN testData2", classOf[CartesianProductExec]),
        ("SELECT * FROM testData RIGHT JOIN testData2", classOf[CartesianProductExec]),
        ("SELECT * FROM testData FULL OUTER JOIN testData2", classOf[CartesianProductExec]),

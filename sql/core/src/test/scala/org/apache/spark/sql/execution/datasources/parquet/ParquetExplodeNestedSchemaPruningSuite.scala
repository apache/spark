...
import org.apache.spark.sql.execution.datasources.ExplodeNestedSchemaPruningSuite
import org.apache.spark.sql.execution.datasources.v2.BatchScanExec
import org.apache.spark.sql.execution.datasources.v2.parquet.ParquetScan
import org.apache.spark.sql.internal.SQLConf
import org.apache.spark.tags.ExtendedSQLTest

abstract class ParquetExplodeNestedSchemaPruningSuite
  extends ExplodeNestedSchemaPruningSuite with AdaptiveSparkPlanHelper {
...
@ExtendedSQLTest
class ParquetV1ExplodeNestedSchemaPruningSuite
...
@ExtendedSQLTest
class ParquetV2ExplodeNestedSchemaPruningSuite
  extends ParquetExplodeNestedSchemaPruningSuite {
  override protected def sparkConf: SparkConf =
    super
      .sparkConf

...
trait MergeIntoSchemaEvolutionBasicTests extends MergeIntoSchemaEvolutionSuiteBase {
  ...
  testEvolution("source with extra column with conditions on update and insert")(
    ...
    clauses = Seq(
      ...
      insert(
        values = "(pk, salary, dep, active) VALUES (s.pk, s.salary, s.dep, s.active)",
          ...
          StructType(Seq(
            ...
            StructField(
              ...
              StructType(Seq(
                ...
                StructField("c3", BooleanType))))))),
        StructField("dep", StringType))),
    expectErrorWithoutEvolutionContains = "Cannot write extra fields `c3` to the struct `s`.`c2`")

  testEvolution(
    "source has missing column with default value and extra column" +
      " and set all columns")(
    targetData = {
          ...
          StructType(
            Seq(
              ...
              StructField(
                "details",
                StructType(
                  Seq(StructField("bonus", IntegerType), StructField("years", IntegerType))))))),
        StructField("dep", StringType))),
    sourceSchema = StructType(
      Seq(
        StructField("pk", IntegerType, nullable = false),
          ...
          StructType(
            Seq(
              ...
              StructField(
                "details",
                StructType(
                  Seq(StructField("bonus", LongType), StructField("years", IntegerType))))))),
        StructField("dep", StringType))),
    expectErrorWithoutEvolutionContains =
  ...
  testEvolution("type widening two types and adding two columns")(
    targetData = {
      ...
      spark.createDataFrame(
        spark.sparkContext.parallelize(
          Seq(Row(1, 100, 45.toShort, "premium"), Row(2, 85, 38.toShort, "standard"))),
        schema)
    },
    sourceData = {
  ...
  testNestedStructsEvolution("type promotion from int to struct not allowed")(
    ...
    sourceSchema = StructType(
      Seq(
        ...
        StructField(
          "data",
          StructType(Seq(StructField("value", IntegerType), StructField("timestamp", LongType)))),
        StructField("dep", StringType))),
    clauses = Seq(updateAll(), insertAll()),
  ...
  testNestedStructsEvolution(
    "source has missing and extra nested struct field" +
  ...
  testNestedStructsEvolution(
    "source has missing and extra nested struct field with " +
      "set all columns")(
    target = Seq(
      """{ "pk": 1, "s": { "c1": 2, "c2": { "a": [1,2], "m": { "a": "b" } } }, "dep": "hr" }"""),
    source = Seq(
          ...
          StructType(Seq(
            ...
            StructField(
              ...
              StructType(Seq(
                ...
                StructField("c3", BooleanType))))))),
        StructField("dep", StringType))),
    expectErrorWithoutEvolutionContains = "Cannot find data for the output column `s`.`c2`.`a`",
  ...
  testEvolution("source has missing and extra field for struct in map and set all columns")(
    ...
    expected = Seq(
      (
        0,
        Map(
          (10, 10: java.lang.Integer, null: java.lang.Boolean) ->
            ("c", "c", null: java.lang.Boolean)),
        "hr"),
      (
        1,
        Map(
          (10, null: java.lang.Integer, true: java.lang.Boolean) ->
            ("y", null: String, false: java.lang.Boolean)),
        "sales"),
      (
        2,
        Map(
          (20, null: java.lang.Integer, false: java.lang.Boolean) ->
            ("z", null: String, true: java.lang.Boolean)),
        "engineering")).toDF("pk", "m", "dep"),
    ...
    expected = Seq(
      ...
      (
        ...
        Map(
          (20, null: java.lang.Integer, false: java.lang.Boolean) ->
            ("z", null: String, true: java.lang.Boolean)),
        "my_new_dep")).toDF("pk", "m", "dep"),
    expectErrorWithoutEvolutionContains = "Cannot find data for the output column",
    requiresNestedTypeCoercion = true)

  testNestedStructsEvolution(
    "source has missing and extra field for struct in array" +
      " and set all columns")(
    target = Seq(
  ...
  testNestedStructsEvolution(
    "source has missing and extra column for struct in array" +
      "and set explicit columns")(
    target = Seq(
      """{ "pk": 0, "a": [{ "c1": 10, "c2": 10 }], "dep": "hr" }""",
      """{ "pk": 1, "a": [{ "c1": 20, "c2": 20 }], "dep": "sales" }"""),
  ...
  testEvolution("source has extra column - empty table and insert")(
    ...
    sourceData = Seq((1, 100, "hr", true), (2, 200, "finance", false), (3, 300, "hr", true))
      .toDF("pk", "salary", "dep", "active"),
    clauses = Seq(insertAll()),
    expected = Seq((1, 100, "hr", true), (2, 200, "finance", false), (3, 300, "hr", true))
      .toDF("pk", "salary", "dep", "active"),
    expectedWithoutEvolution =
      Seq((1, 100, "hr"), (2, 200, "finance"), (3, 300, "hr")).toDF("pk", "salary", "dep"))
  ...
  testEvolution(
    ...
    clauses = Seq(update(set = "extra=substring(s.extra, 1, 2)")),
  ...
  testEvolution(
    ...
    sourceData = Seq((2, 150, "dummy", "blah"), (3, 250, "dummy", "blah"))
      .toDF("pk", "salary", "dep", "extra"),
    clauses = Seq(update(set = "dep='software'")),
  ...
  testEvolution(
    ...
    sourceData = Seq((2, 150, "dummy", "blah"), (3, 250, "dummy", "blah"))
      .toDF("pk", "salary", "dep", "extra"),
    clauses = Seq(insert(values = "(pk, salary, dep) VALUES (s.pk, s.salary, 'newdep')")),
    expected =
      Seq((1, 100, "hr"), (2, 200, "software"), (3, 250, "newdep")).toDF("pk", "salary", "dep"),
    expectedWithoutEvolution =
      Seq((1, 100, "hr"), (2, 200, "software"), (3, 250, "newdep")).toDF("pk", "salary", "dep"))
  ...
  testEvolution(
    ...
    sourceData = Seq((2, 150, "dummy", "blah"), (3, 250, "dummy", "blah"))
      .toDF("pk", "salary", "dep", "extra"),
    clauses = Seq(update(set = "t.extra = s.extra")),
    expectErrorContains = "A column, variable, or function parameter with name " +
  ...
  testEvolution(
    "source has multiple extra columns -" +
      "only evolve referenced column")(
    targetData = Seq((1, 100, "hr"), (2, 200, "software")).toDF("pk", "salary", "dep"),
    sourceData = Seq((2, 150, "dummy", 50, "blah"), (3, 250, "dummy", 75, "blah"))

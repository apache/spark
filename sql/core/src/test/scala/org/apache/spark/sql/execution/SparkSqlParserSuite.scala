 ...
 *
 * See [[org.apache.spark.sql.catalyst.parser.PlanParserSuite]] for rules defined in the Catalyst
 * module.
 */
class SparkSqlParserSuite extends AnalysisTest with SharedSparkSession {
  ...
  test("Checks if SET/RESET can parse all the configurations") {
    ...
    ConfigEntry.knownConfigs.values.asScala.foreach { config =>
      ...
      if (config.defaultValue.isDefined && defaultValueStr != null) {
        assertEqual(
          s"SET ${config.key}=`$defaultValueStr`",
  ...
  test("Report Error for invalid usage of SET command") {
    ...
    checkError(
      ...
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql1, start = 0, stop = 22))
    ...
    checkError(
      ...
      condition = "INVALID_SET_SYNTAX",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql2, start = 0, stop = 26))
    ...
    checkError(
      ...
      parameters = Map.empty,
      context =
        ExpectedContext(fragment = "SET    spark.sql.key \"value\"", start = 0, stop = 27))
    ...
    checkError(
      ...
      condition = "INVALID_SET_SYNTAX",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql5, start = 0, stop = 25))
    ...
    checkError(
      ...
      condition = "INVALID_SET_SYNTAX",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql6, start = 0, stop = 25))
    ...
    checkError(
      ...
      condition = "INVALID_SET_SYNTAX",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql7, start = 0, stop = 25))
    ...
    checkError(
      ...
      condition = "INVALID_SET_SYNTAX",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql8, start = 0, stop = 25))
    ...
    checkError(
      ...
      condition = "INVALID_SET_SYNTAX",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql9, start = 0, stop = 25))
    ...
    checkError(
      ...
      condition = "INVALID_SET_SYNTAX",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql10, start = 0, stop = 25))
    ...
    checkError(
      ...
      condition = "INVALID_SET_SYNTAX",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql11, start = 0, stop = 4))
    ...
    checkError(
      ...
      condition = "INVALID_SET_SYNTAX",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql12, start = 0, stop = 9))
  }
  ...
  test("Report Error for invalid usage of RESET command") {
    ...
    checkError(
      ...
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql1, start = 0, stop = 24))
    ...
    checkError(
      ...
      condition = "INVALID_RESET_COMMAND_FORMAT",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql3, start = 0, stop = 29))
    ...
    checkError(
      ...
      condition = "INVALID_RESET_COMMAND_FORMAT",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql4, start = 0, stop = 21))
    ...
    checkError(
      ...
      condition = "INVALID_RESET_COMMAND_FORMAT",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql5, start = 0, stop = 21))
    ...
    checkError(
      ...
      condition = "INVALID_RESET_COMMAND_FORMAT",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql6, start = 0, stop = 21))
    ...
    checkError(
      ...
      condition = "INVALID_RESET_COMMAND_FORMAT",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql7, start = 0, stop = 21))
    ...
    checkError(
      ...
      condition = "INVALID_RESET_COMMAND_FORMAT",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql8, start = 0, stop = 21))
    ...
    checkError(
      ...
      condition = "INVALID_RESET_COMMAND_FORMAT",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql9, start = 0, stop = 21))
  }
  ...
  test("SPARK-33419: Semicolon handling in SET command") {
    ...
    checkError(
      ...
      condition = "INVALID_SET_SYNTAX",
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql1, start = 0, stop = 16))
    ...
    checkError(
      ...
      condition = "INVALID_SET_SYNTAX",
      parameters = Map.empty,
      context = ExpectedContext(fragment = "SET a=1;2", start = 0, stop = 8))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql3, start = 0, stop = 12))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = "SET `a`=1;2", start = 0, stop = 10))
  }
  ...
  test("refresh resource") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql1, start = 0, stop = 10))
    ...
    checkError(
      ...
      condition = "_LEGACY_ERROR_TEMP_0064",
      parameters = Map("msg" -> errMsg1),
      context = ExpectedContext(fragment = sql2, start = 0, stop = 10))
    ...
    checkError(
      ...
      condition = "_LEGACY_ERROR_TEMP_0064",
      parameters = Map("msg" -> errMsg1),
      context = ExpectedContext(fragment = sql3, start = 0, stop = 10))
    ...
    checkError(
      ...
      condition = "_LEGACY_ERROR_TEMP_0064",
      parameters = Map("msg" -> errMsg1),
      context = ExpectedContext(fragment = sql4, start = 0, stop = 10))
    ...
    checkError(
      ...
      condition = "_LEGACY_ERROR_TEMP_0064",
      parameters = Map("msg" -> errMsg1),
      context = ExpectedContext(fragment = sql5, start = 0, stop = 11))
    ...
    checkError(
      ...
      condition = "_LEGACY_ERROR_TEMP_0064",
      parameters = Map("msg" -> errMsg1),
      context = ExpectedContext(fragment = sql6, start = 0, stop = 12))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = "REFRESH", start = 0, stop = 6))
    ...
    checkError(
      ...
      condition = "_LEGACY_ERROR_TEMP_0064",
      parameters = Map("msg" -> errMsg2),
      context = ExpectedContext(fragment = sql8, start = 0, stop = 6))
  }

  test("SPARK-33118 CREATE TEMPORARY TABLE with LOCATION") {
    assertEqual(
      "CREATE TEMPORARY TABLE t USING parquet OPTIONS (path '/data/tmp/testspark1')",
      CreateTempViewUsing(
    ...
    assertEqual(
      "CREATE TEMPORARY TABLE t USING parquet LOCATION '/data/tmp/testspark1'",
      CreateTempViewUsing(
        TableIdentifier("t", None),
        None,
        false,
  ...
  test("query organization") {
    ...
    assertEqual(
      s"$baseSql distribute by a, b",
      RepartitionByExpression(
        UnresolvedAttribute("a") :: UnresolvedAttribute("b") :: Nil,
        basePlan,
        None))
    assertEqual(
      s"$baseSql distribute by a sort by b",
      Sort(
        SortOrder(UnresolvedAttribute("b"), Ascending) :: Nil,
        global = false,
        RepartitionByExpression(UnresolvedAttribute("a") :: Nil, basePlan, None)))
    assertEqual(
      s"$baseSql cluster by a, b",
      Sort(
  ...
  test("database and schema tokens are interchangeable") {
    ...
    assertEqual(
      "ALTER DATABASE foo SET DBPROPERTIES ('x' = 'y')",
  ...
  test(
    "SPARK-32607: Script Transformation ROW FORMAT DELIMITED" +
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql1, start = 0, stop = 264))
    ...
    checkError(
      ...
      condition = "_LEGACY_ERROR_TEMP_0064",
      parameters = Map("msg" -> errMsg),
      context = ExpectedContext(fragment = sql2, start = 0, stop = 264))
  }
  ...
  test("CREATE TABLE LIKE COMMAND should reject reserved properties") {
    ...
    checkError(
      ...
      parameters =
        Map("property" -> TableCatalog.PROP_OWNER, "msg" -> "it will be set to the current user"),
    ...
    checkError(
      ...
      condition = "UNSUPPORTED_FEATURE.SET_TABLE_PROPERTY",
      parameters = Map(
        "property" -> TableCatalog.PROP_PROVIDER,
        "msg" -> "please use the USING clause to specify it"),
      context = ExpectedContext(fragment = sql2, start = 0, stop = 63))
  }
  ...
  test("CREATE TEMPORARY TABLE ... USING provider should be blocked under the flag") {
    withSQLConf((SQLConf.BLOCK_CREATE_TEMP_TABLE_USING_PROVIDER.key, "true")) {
      checkError(
        exception =
          intercept[ParseException](sql("CREATE TEMPORARY TABLE t (i int) USING parquet")),
  ...
  test("Operator pipe SQL syntax") {
    ...
    withSQLConf(SQLConf.OPERATOR_PIPE_SYNTAX_ENABLED.key -> "false") {
      ...
      checkError(
        ...
        context = ExpectedContext(fragment = sql, start = 0, stop = sql.length - 1))
    }
  }
  ...
  test("SPARK-47404: Managed parsers killswitch works") {
    ...
    withSQLConf(
      SQLConf.PARSER_DFA_CACHE_FLUSH_THRESHOLD.key -> (10000).toString,
  ...
  Seq((-1, -1, false), (10000, -1, true), (-1, 1, true), (10000, 1, true)).foreach {
    case (threshold, ratio, shouldFlush) =>

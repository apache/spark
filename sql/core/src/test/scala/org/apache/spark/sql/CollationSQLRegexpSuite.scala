...
class CollationSQLRegexpSuite
  ...
  test("Support Like string expression with collation") {
    ...
    val failCases = Seq(
      LikeTestFail("ABC", "%b%", "UNICODE_CI_AS")
    )
    failCases.foreach(t => {
      val query = s"SELECT like(collate('${t.l}', '${t.c}'), '${t.r}')"
      checkError(
        ...
        parameters = Map(
          "sqlExpr" -> "\"collate(ABC, UNICODE_CI_AS) LIKE %b%\"",
          "paramIndex" -> "first",
          "inputSql" -> "\"collate(ABC, UNICODE_CI_AS)\"",
          "inputType" -> "\"STRING COLLATE UNICODE_CI_AS\"",
          "requiredType" -> "\"STRING\""),
  ...
  test("Support ILike string expression with collation") {
    ...
    val failCases = Seq(
      ILikeTestFail("ABC", "%b%", "UNICODE_CI_AS")
    )
    failCases.foreach(t => {
      val query = s"SELECT ilike(collate('${t.l}', '${t.c}'), '${t.r}')"
      checkError(
        ...
        errorClass = "DATATYPE_MISMATCH.UNEXPECTED_INPUT_TYPE",
        parameters = Map(
          "sqlExpr" -> "\"ilike(collate(ABC, UNICODE_CI_AS), %b%)\"",
          "paramIndex" -> "first",
          "inputSql" -> "\"collate(ABC, UNICODE_CI_AS)\"",
          "inputType" -> "\"STRING COLLATE UNICODE_CI_AS\"",
          "requiredType" -> "\"STRING\""),
  ...
  test("Support LikeAll string expression with collation") {
    ...
    val failCases = Seq(
      LikeAllTestFail("Foo", Seq("%foo%", "%oo"), "UNICODE_CI_AS")
    )
    failCases.foreach(t => {
      val query = s"SELECT collate('${t.s}', '${t.c}') LIKE ALL ('${t.p.mkString("','")}')"
      checkError(
        ...
        errorClass = "DATATYPE_MISMATCH.UNEXPECTED_INPUT_TYPE",
        parameters = Map(
          "sqlExpr" -> "\"likeall(collate(Foo, UNICODE_CI_AS))\"",
          "paramIndex" -> "first",
          "inputSql" -> "\"collate(Foo, UNICODE_CI_AS)\"",
          "inputType" -> "\"STRING COLLATE UNICODE_CI_AS\"",
          "requiredType" -> "\"STRING\""),
        context = ExpectedContext(
  ...
  test("Support NotLikeAll string expression with collation") {
    ...
    val failCases = Seq(
      NotLikeAllTestFail("Foo", Seq("%foo%", "%oo"), "UNICODE_CI_AS")
    )
    failCases.foreach(t => {
      val query = s"SELECT collate('${t.s}', '${t.c}') NOT LIKE ALL ('${t.p.mkString("','")}')"
      checkError(
        ...
        errorClass = "DATATYPE_MISMATCH.UNEXPECTED_INPUT_TYPE",
        parameters = Map(
          "sqlExpr" -> "\"notlikeall(collate(Foo, UNICODE_CI_AS))\"",
          "paramIndex" -> "first",
          "inputSql" -> "\"collate(Foo, UNICODE_CI_AS)\"",
          "inputType" -> "\"STRING COLLATE UNICODE_CI_AS\"",
          "requiredType" -> "\"STRING\""),
  ...
  test("Support LikeAny string expression with collation") {
    ...
    val failCases = Seq(
      LikeAnyTestFail("Foo", Seq("%foo%", "%oo"), "UNICODE_CI_AS")
    )
    failCases.foreach(t => {
      val query = s"SELECT collate('${t.s}', '${t.c}') LIKE ANY ('${t.p.mkString("','")}')"
      checkError(
        ...
        errorClass = "DATATYPE_MISMATCH.UNEXPECTED_INPUT_TYPE",
        parameters = Map(
          "sqlExpr" -> "\"likeany(collate(Foo, UNICODE_CI_AS))\"",
          "paramIndex" -> "first",
          "inputSql" -> "\"collate(Foo, UNICODE_CI_AS)\"",
          "inputType" -> "\"STRING COLLATE UNICODE_CI_AS\"",
          "requiredType" -> "\"STRING\""),
  ...
  test("Support NotLikeAny string expression with collation") {
    ...
    val failCases = Seq(
      NotLikeAnyTestFail("Foo", Seq("%foo%", "%oo"), "UNICODE_CI_AS")
    )
    failCases.foreach(t => {
      val query = s"SELECT collate('${t.s}', '${t.c}') NOT LIKE ANY ('${t.p.mkString("','")}')"
      checkError(
        ...
        errorClass = "DATATYPE_MISMATCH.UNEXPECTED_INPUT_TYPE",
        parameters = Map(
          "sqlExpr" -> "\"notlikeany(collate(Foo, UNICODE_CI_AS))\"",
          "paramIndex" -> "first",
          "inputSql" -> "\"collate(Foo, UNICODE_CI_AS)\"",
          "inputType" -> "\"STRING COLLATE UNICODE_CI_AS\"",
          "requiredType" -> "\"STRING\""),
  ...
  test("Support RLike string expression with collation") {
    ...
    val failCases = Seq(
      RLikeTestFail("ABC", ".b.", "UNICODE_CI_AS")
    )
    failCases.foreach(t => {
      val query = s"SELECT rlike(collate('${t.l}', '${t.c}'), '${t.r}')"
      checkError(
        ...
        errorClass = "DATATYPE_MISMATCH.UNEXPECTED_INPUT_TYPE",
        parameters = Map(
          "sqlExpr" -> "\"RLIKE(collate(ABC, UNICODE_CI_AS), .b.)\"",
          "paramIndex" -> "first",
          "inputSql" -> "\"collate(ABC, UNICODE_CI_AS)\"",
          "inputType" -> "\"STRING COLLATE UNICODE_CI_AS\"",
          "requiredType" -> "\"STRING\""),
  ...
  test("Support StringSplit string expression with collation") {
    ...
    val failCases = Seq(
      StringSplitTestFail("ABC", "[b]", "UNICODE_CI_AS")
    )
    failCases.foreach(t => {
      val query = s"SELECT split(collate('${t.l}', '${t.c}'), '${t.r}')"
      checkError(
        ...
        errorClass = "DATATYPE_MISMATCH.UNEXPECTED_INPUT_TYPE",
        parameters = Map(
          "sqlExpr" -> "\"split(collate(ABC, UNICODE_CI_AS), [b], -1)\"",
          "paramIndex" -> "first",
          "inputSql" -> "\"collate(ABC, UNICODE_CI_AS)\"",
          "inputType" -> "\"STRING COLLATE UNICODE_CI_AS\"",
          "requiredType" -> "\"STRING\""),
  ...
  test("Support RegExpReplace string expression with collation") {
    ...
    val failCases = Seq(
      RegExpReplaceTestFail("ABCDE", ".c.", "UNICODE_CI_AS")
    )
    failCases.foreach(t => {
      val query =
      ...
      checkError(
        ...
        errorClass = "DATATYPE_MISMATCH.UNEXPECTED_INPUT_TYPE",
        parameters = Map(
          "sqlExpr" -> "\"regexp_replace(collate(ABCDE, UNICODE_CI_AS), .c., FFF, 1)\"",
          "paramIndex" -> "first",
          "inputSql" -> "\"collate(ABCDE, UNICODE_CI_AS)\"",
          "inputType" -> "\"STRING COLLATE UNICODE_CI_AS\"",
          "requiredType" -> "\"STRING\""),
        context = ExpectedContext(
  ...
  test("Support RegExpExtract string expression with collation") {
    ...
    val failCases = Seq(
      RegExpExtractTestFail("ABCDE", ".c.", "UNICODE_CI_AS")
    )
    failCases.foreach(t => {
      val query =
        s"SELECT regexp_extract(collate('${t.l}', '${t.c}'), '${t.r}', 0)"
      checkError(
        ...
        errorClass = "DATATYPE_MISMATCH.UNEXPECTED_INPUT_TYPE",
        parameters = Map(
          "sqlExpr" -> "\"regexp_extract(collate(ABCDE, UNICODE_CI_AS), .c., 0)\"",
          "paramIndex" -> "first",
          "inputSql" -> "\"collate(ABCDE, UNICODE_CI_AS)\"",
          "inputType" -> "\"STRING COLLATE UNICODE_CI_AS\"",
          "requiredType" -> "\"STRING\""),
  ...
  test("Support RegExpExtractAll string expression with collation") {
    ...
    val failCases = Seq(
      RegExpExtractAllTestFail("ABCDE", ".c.", "UNICODE_CI_AS")
    )
    failCases.foreach(t => {
      val query =
        s"SELECT regexp_extract_all(collate('${t.l}', '${t.c}'), '${t.r}', 0)"
      checkError(
        ...
        errorClass = "DATATYPE_MISMATCH.UNEXPECTED_INPUT_TYPE",
        parameters = Map(
          "sqlExpr" -> "\"regexp_extract_all(collate(ABCDE, UNICODE_CI_AS), .c., 0)\"",
          "paramIndex" -> "first",
          "inputSql" -> "\"collate(ABCDE, UNICODE_CI_AS)\"",
          "inputType" -> "\"STRING COLLATE UNICODE_CI_AS\"",
          "requiredType" -> "\"STRING\""),
  ...
  test("Support RegExpCount string expression with collation") {
    ...
    val failCases = Seq(
      RegExpCountTestFail("ABCDE", ".c.", "UNICODE_CI_AS")
    )
    failCases.foreach(t => {
      val query = s"SELECT regexp_count(collate('${t.l}', '${t.c}'), '${t.r}')"
      checkError(
        ...
        errorClass = "DATATYPE_MISMATCH.UNEXPECTED_INPUT_TYPE",
        parameters = Map(
          "sqlExpr" -> "\"regexp_count(collate(ABCDE, UNICODE_CI_AS), .c.)\"",
          "paramIndex" -> "first",
          "inputSql" -> "\"collate(ABCDE, UNICODE_CI_AS)\"",
          "inputType" -> "\"STRING COLLATE UNICODE_CI_AS\"",
          "requiredType" -> "\"STRING\""),
  ...
  test("Support RegExpSubStr string expression with collation") {
    ...
    val failCases = Seq(
      RegExpSubStrTestFail("ABCDE", ".c.", "UNICODE_CI_AS")
    )
    failCases.foreach(t => {
      val query = s"SELECT regexp_substr(collate('${t.l}', '${t.c}'), '${t.r}')"
      checkError(
        ...
        errorClass = "DATATYPE_MISMATCH.UNEXPECTED_INPUT_TYPE",
        parameters = Map(
          "sqlExpr" -> "\"regexp_substr(collate(ABCDE, UNICODE_CI_AS), .c.)\"",
          "paramIndex" -> "first",
          "inputSql" -> "\"collate(ABCDE, UNICODE_CI_AS)\"",
          "inputType" -> "\"STRING COLLATE UNICODE_CI_AS\"",
          "requiredType" -> "\"STRING\""),
  ...
  test("Support RegExpInStr string expression with collation") {
    ...
    val failCases = Seq(
      RegExpInStrTestFail("ABCDE", ".c.", "UNICODE_CI_AS")
    )
    failCases.foreach(t => {
      val query = s"SELECT regexp_instr(collate('${t.l}', '${t.c}'), '${t.r}')"
      checkError(
        ...
        errorClass = "DATATYPE_MISMATCH.UNEXPECTED_INPUT_TYPE",
        parameters = Map(
          "sqlExpr" -> "\"regexp_instr(collate(ABCDE, UNICODE_CI_AS), .c., 0)\"",
          "paramIndex" -> "first",
          "inputSql" -> "\"collate(ABCDE, UNICODE_CI_AS)\"",
          "inputType" -> "\"STRING COLLATE UNICODE_CI_AS\"",
          "requiredType" -> "\"STRING\""),

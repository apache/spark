...
abstract class StatisticsCollectionTestBase extends QueryTest with SQLTestUtils {
  ...
  val expectedSerializedColStats = Map(
    ...
    "spark.sql.statistics.colStats.cbinary.version" -> version,
    ...
    "spark.sql.statistics.colStats.cbool.version" -> version,
    ...
    "spark.sql.statistics.colStats.cbyte.version" -> version,
    "spark.sql.statistics.colStats.cdate.avgLen" -> "4",
    "spark.sql.statistics.colStats.cdate.distinctCount" -> "2",
    "spark.sql.statistics.colStats.cdate.max" -> "16930",
    "spark.sql.statistics.colStats.cdate.maxLen" -> "4",
    "spark.sql.statistics.colStats.cdate.min" -> "16929",
    "spark.sql.statistics.colStats.cdate.nullCount" -> "1",
    "spark.sql.statistics.colStats.cdate.version" -> version,
    ...
    "spark.sql.statistics.colStats.cdecimal.version" -> version,
    ...
    "spark.sql.statistics.colStats.cdouble.version" -> version,
    ...
    "spark.sql.statistics.colStats.cfloat.version" -> version,
    ...
    "spark.sql.statistics.colStats.cint.version" -> version,
    ...
    "spark.sql.statistics.colStats.clong.version" -> version,
    ...
    "spark.sql.statistics.colStats.cshort.version" -> version,
    ...
    "spark.sql.statistics.colStats.cstring.version" -> version,
    "spark.sql.statistics.colStats.ctimestamp.avgLen" -> "8",
    "spark.sql.statistics.colStats.ctimestamp.distinctCount" -> "2",
    "spark.sql.statistics.colStats.ctimestamp.max" -> "1462777202000000",
    "spark.sql.statistics.colStats.ctimestamp.maxLen" -> "8",
    "spark.sql.statistics.colStats.ctimestamp.min" -> "1462690801000000",
    "spark.sql.statistics.colStats.ctimestamp.nullCount" -> "1",
    "spark.sql.statistics.colStats.ctimestamp.version" -> version
  )

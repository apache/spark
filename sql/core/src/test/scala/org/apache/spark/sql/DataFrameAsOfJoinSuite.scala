...
class DataFrameAsOfJoinSuite
  ...
  def prepareForAsOfJoin(): (classic.DataFrame, classic.DataFrame) = {
    ...
    val rowSeq2: List[Row] =
      List(Row(1, "v", 1), Row(2, "w", 2), Row(3, "x", 3), Row(6, "y", 6), Row(7, "z", 7))
  ...
  test("as-of join - simple") {
    ...
    checkAnswer(
      df1.joinAsOf(
        ...
        df1.col("a"),
        df2.col("a"),
        usingColumns = Seq.empty,
        joinType = "inner",
        tolerance = null,
        allowExactMatches = true,
        direction = "backward"),
      Seq(Row(1, "x", "a", 1, "v", 1), Row(5, "y", "b", 3, "x", 3), Row(10, "z", "c", 7, "z", 7)))
  }
  ...
  test("as-of join - allowExactMatches = false") {
    ...
    checkAnswer(
      df1.joinAsOf(
        ...
        direction = "backward"),
      Seq(Row(5, "y", "b", 3, "x", 3), Row(10, "z", "c", 7, "z", 7)))
  }
  ...
  test("as-of join - direction = \"forward\"") {
    ...
    checkAnswer(
      df1.joinAsOf(
        ...
        allowExactMatches = true,
        direction = "forward"),
      Seq(Row(1, "x", "a", 1, "v", 1), Row(5, "y", "b", 6, "y", 6)))
  }
  ...
  test("as-of join - direction = \"nearest\"") {
    ...
    checkAnswer(
      df1.joinAsOf(
        ...
        allowExactMatches = true,
        direction = "nearest"),
      Seq(Row(1, "x", "a", 1, "v", 1), Row(5, "y", "b", 6, "y", 6), Row(10, "z", "c", 7, "z", 7)))
  }

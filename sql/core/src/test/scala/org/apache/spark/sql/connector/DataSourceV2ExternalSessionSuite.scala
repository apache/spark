...
import org.apache.spark.sql.connector.catalog.{InMemoryTableCatalog, SharedInMemoryTableCatalog}
import org.apache.spark.sql.internal.SQLConf
import org.apache.spark.sql.test.SharedSparkSession

/**
 * Tests for cross-session scenarios where an external [[SparkSession]]
 * modifies a DSv2 table while another session holds a stale [[DataFrame]].
 *

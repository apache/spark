...
abstract class BaseScriptTransformationSuite extends SparkPlanTest with SQLTestUtils
    ...
    test(s"SPARK-32400: TRANSFORM should support basic data types as input ($testName)") {
      ...
      withTempView("v") {
        ...
        checkAnswer(
          ...
          df.select(Symbol("a"), Symbol("b"), Symbol("c"), Symbol("d"), Symbol("e"), Symbol("f"),
            Symbol("g"), Symbol("h"), Symbol("i"), Symbol("j")).collect())
      }
    }
  }
  ...
  test("SPARK-32400: TRANSFORM should support more data types (interval, array, map, struct " +
    ...
    withTempView("v") {
      ...
      checkAnswer(
        ...
        df.select(Symbol("a"), Symbol("b").cast("string"), Symbol("c").cast("string"),
          Symbol("d").cast("string"), Symbol("e")).collect())
    }
  }
  ...
  test("SPARK-32667: SCRIPT TRANSFORM pad null value to fill column" +
    ...
    checkAnswer(
      ...
      df.select(
        Symbol("a").cast("string").as("a"),
        Symbol("b").cast("string").as("b"),

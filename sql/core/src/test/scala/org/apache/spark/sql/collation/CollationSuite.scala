...
class CollationSuite extends DatasourceV2SQLBase with AdaptiveSparkPlanHelper {
  ...
  test("ConstantPropagation: replaces binary-stable attributes with contradicting predicates") {
    withTable("t1") {
      ...
      checkAnswer(sql("SELECT * FROM t1 WHERE c = 'hello' AND c = 'world'"), Seq.empty)
    }
  }
  ...
  test(
    "ConstantPropagation: does not replace non-binary-stable " +
  ...
  test(
    "ConstantPropagation: replaces non-binary-stable attributes in same-collation comparison") {
    withTable("t1") {
  ...
  test(
    "ConstantPropagation: does not replace non-binary-stable attribute " +
  ...
  test(
    "ConstantPropagation: binary-stable join replaces attributes " +
  ...
  test(
    "ConstantPropagation: non-binary-stable null-safe join condition " +

...
insertInto
    ...
    | INSERT (WITH SCHEMA EVOLUTION)? INTO TABLE? identifierReference tableAlias optionsClause? (BY NAME)? REPLACE (WHERE | ON) replaceCondition=booleanExpression   #insertIntoReplaceBooleanCond

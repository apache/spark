...
import org.apache.spark.sql.internal.{InvokeInlineUserDefinedFunction, UnresolvedStar, UserDefinedFunctionLike}
...
abstract class Aggregator[-IN, BUF, OUT] extends Serializable with UserDefinedFunctionLike {
  ...
  def toColumn: TypedColumn[IN, OUT] = {
    new TypedColumn[IN, OUT](
      InvokeInlineUserDefinedFunction(this, UnresolvedStar(None) :: Nil),
      outputEncoder)
  }
}

...
private[sql] object SqlApiConf {
  ...
  val DEFAULT_COLLATION_KEY: String = SqlApiConfHelper.DEFAULT_COLLATION_KEY
  val USE_V1_SOURCE_LIST_KEY: String = SqlApiConfHelper.USE_V1_SOURCE_LIST_KEY
  val BINARY_OUTPUT_STYLE_KEY: String = SqlApiConfHelper.BINARY_OUTPUT_STYLE_KEY
  val SUPPORT_QUOTED_REGEX_COLUMN_NAME_KEY: String =
    SqlApiConfHelper.SUPPORT_QUOTED_REGEX_COLUMN_NAME_KEY
  val CODEGEN_FALLBACK_KEY: String = SqlApiConfHelper.CODEGEN_FALLBACK_KEY
  val DATAFRAME_RETAIN_GROUP_COLUMNS_KEY: String =
    SqlApiConfHelper.DATAFRAME_RETAIN_GROUP_COLUMNS_KEY
  val ENFORCE_RESERVED_KEYWORDS_KEY: String = SqlApiConfHelper.ENFORCE_RESERVED_KEYWORDS_KEY
  val WHOLESTAGE_CODEGEN_ENABLED_KEY: String = SqlApiConfHelper.WHOLESTAGE_CODEGEN_ENABLED_KEY

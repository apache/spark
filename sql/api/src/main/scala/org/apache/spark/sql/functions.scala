...
// scalastyle:on
   ...
   * ThetaSketch, generated by intersecting previously created Datasketches ThetaSketch instances
   * via a Datasketches Intersection instance Allows setting of log nominal entries for the
   * intersection buffer.
   *
   * @group agg_funcs
   * @since 4.0.0
   ...
   * configured with lgNomEntries arg.
   *
   * @group agg_funcs
   * @since 4.0.0
   */
  ...
  /**
   * Aggregate function: returns the compact binary representation of the Datasketches ThetaSketch
   * configured with default lgNomEntries value.
   *
   * @group agg_funcs
   * @since 4.0.0
   */
  ...
  /**
   * Aggregate function: returns the compact binary representation of the Datasketches
   * ThetaSketch, generated by merging previously created Datasketches ThetaSketch instances via a
  ...
  /**
   * Aggregate function: returns the compact binary representation of the Datasketches
   * ThetaSketch, generated by merging previously created Datasketches HllSketch instances via a
  ...
  /**
   * Subtracts two binary representations of Datasketches ThetaSketch objects, using a
  ...
  /**
   * Intersects two binary representations of Datasketches ThetaSketch objects, using a
  ...
  /**
   * Intersects two binary representations of Datasketches ThetaSketch objects, using a
   * Datasketches Intersection object. Allows setting of log nominal entries for the intersection
   * buffer.
   *
   * @group misc_funcs
   * @since 4.0.0
  ...
  /**
   * Merges two binary representations of Datasketches ThetaSketch objects, using a Datasketches

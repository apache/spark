 ...
 *
 * PURPOSE: TypeApiOps handles operations that require spark-api internals (e.g., AgnosticEncoder)
 * that are not available in the catalyst package. This separation prevents circular dependencies

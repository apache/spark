...
import org.apache.spark.sql.types.{ArrayType, BinaryType, BooleanType, ByteType, CalendarIntervalType, CharType, DataType, DateType, DayTimeIntervalType, DecimalType, DoubleType, FloatType, IntegerType, LongType, MapType, MetadataBuilder, NullType, ShortType, StronglyTypedStringType, StructField, StructType, TimestampNTZType, TimestampType, VarcharType, VariantType, YearMonthIntervalType}
      ...
      case (STRING, Nil) =>
        typeCtx.children.asScala.toSeq match {
          ...
          case Seq(_, ctx: CollateClauseContext) =>
            ...
            StronglyTypedStringType(collationId)
        }

...
object AuthenticationProviderFactory {
  ...
  def getAuthenticationProvider(authMethod: AuthMethods): PasswdAuthenticationProvider = {
    if (authMethod eq AuthMethods.LDAP) {
      new LdapAuthenticationProviderImpl
    } else if (authMethod eq AuthMethods.PAM) {
      new PamAuthenticationProviderImpl
    } else if (authMethod eq AuthMethods.CUSTOM) {
      new CustomAuthenticationProviderImpl
    } else if (authMethod eq AuthMethods.NONE) {

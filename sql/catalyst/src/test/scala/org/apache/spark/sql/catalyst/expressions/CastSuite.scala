...
class CastSuite extends SparkFunSuite with ExpressionEvalHelper {
  ...
  test("cast from int") {
    ...
    checkEvaluation(cast(123, DecimalType.Default), Decimal(123))
  ...
  test("cast from long") {
    ...
    checkEvaluation(cast(123L, DecimalType.Default), Decimal(123))
  ...
  test("cast from string") {
    ...
    assert(cast("abcdef", DecimalType.Default).nullable === true)
  ...
  test("data type casting") {
    ...
    checkEvaluation(cast("abdef", DecimalType.Default), null)
    checkEvaluation(cast("abdef", TimestampType), null)
    checkEvaluation(cast("12.65", DecimalType.Maximum), Decimal(12.65))
    ...
    checkEvaluation(
      cast(cast(cast(cast(cast(cast("5", ByteType), TimestampType),
        DecimalType.Maximum), LongType), StringType), ShortType),
      0.toShort)
    checkEvaluation(
      cast(cast(cast(cast(cast(cast("5", TimestampType), ByteType),
        DecimalType.Maximum), LongType), StringType), ShortType),
      null)
    checkEvaluation(cast(cast(cast(cast(cast(cast("5", DecimalType.Maximum),
    ...
    checkEvaluation(cast("23", DecimalType.Default), Decimal(23))
  ...
  test("cast and add") {
    ...
    checkEvaluation(Add(Literal(Decimal(23)), cast(true, DecimalType.Default)), Decimal(24))
  ...
  test("casting to fixed-precision decimals") {
    ...
    assert(cast(123, DecimalType.Default).nullable === true)
    assert(cast(10.03f, DecimalType.Maximum).nullable === true)
    assert(cast(10.03, DecimalType.Maximum).nullable === true)
    assert(cast(Decimal(10.03), DecimalType.Maximum).nullable === true)
    ...
    checkEvaluation(cast(10.03, DecimalType.Maximum), Decimal(10.03))
    ...
    checkEvaluation(cast(10.05, DecimalType.Maximum), Decimal(10.05))
    ...
    checkEvaluation(cast(Double.NaN, DecimalType.Maximum), null)
    checkEvaluation(cast(1.0 / 0.0, DecimalType.Maximum), null)
    checkEvaluation(cast(Float.NaN, DecimalType.Maximum), null)
    checkEvaluation(cast(1.0f / 0.0f, DecimalType.Maximum), null)
  ...
  test("cast from date") {
    ...
    checkEvaluation(cast(d, DecimalType.Maximum), null)
  ...
  test("cast from timestamp") {
    ...
    checkEvaluation(
      cast(cast(Decimal(1), TimestampType), DecimalType.Maximum),
      Decimal(1))

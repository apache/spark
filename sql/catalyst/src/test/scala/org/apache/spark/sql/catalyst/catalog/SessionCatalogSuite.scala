 ...
 *
 * Note: many of the methods here are very similar to the ones in [[ExternalCatalogSuite]]. This
 * is because [[SessionCatalog]] and [[ExternalCatalog]] share many similar method signatures but
 * do not extend a common parent. This is largely by design but unfortunately leads to very
 * similar test code in two places.
 */
abstract class SessionCatalogSuite extends AnalysisTest with Eventually {
  ...
  test("create table with default columns") {
    def test: Unit = withBasicCatalog { catalog =>
      ...
      catalog.createTable(
        newTable("tbl3", Some("db1"), defaultColumns = true),
        ignoreIfExists = false)
      catalog.createTable(
        newTable("tbl3", Some("db2"), defaultColumns = true),
        ignoreIfExists = false)
      ...
      checkError(
        ...
        parameters =
          Map("statement" -> "CREATE TABLE", "colName" -> "`c`", "defaultValue" -> "_@#$%"))
      checkError(
        exception = intercept[AnalysisException] {
  ...
  test("drop table when database/table does not exist") {
    withBasicCatalog { catalog =>
      ...
      intercept[NoSuchTableException] {
        catalog.dropTable(
          TableIdentifier("unknown_table", Some("db2")),
          ignoreIfNotExists = false,
          purge = false)
      }
      catalog.dropTable(
  ...
  test("rename table") {
    withBasicCatalog { catalog =>
      ...
      intercept[TableAlreadyExistsException] {
        catalog.renameTable(TableIdentifier("tblone", Some("db2")), TableIdentifier("table_two"))
      }
    }
  }
  ...
  test("rename tables to an invalid name") {
    withBasicCatalog { catalog =>
      testInvalidName(name =>
        catalog.renameTable(TableIdentifier("tbl1", Some("db2")), TableIdentifier(name)))
    }
  }
  ...
  test("alter data schema add columns") {
    withBasicCatalog { sessionCatalog =>
      ...
      val expectedTableSchema = StructType(
        oldTab.dataSchema.fields ++
  ...
  test("alter schema add columns") {
    withBasicCatalog { sessionCatalog =>
      ...
      sessionCatalog.alterTableSchema(TableIdentifier("t1", Some("default")), newSchema)
  ...
  test("get table") {
    withBasicCatalog { catalog =>
      ...
      val withCatalog =
        raw.copy(identifier = raw.identifier.copy(catalog = Some(SESSION_CATALOG_NAME)))
  ...
  test("get tables by name") {
    withBasicCatalog { catalog =>
      ...
      assert(
        catalog.getTablesByName(
          Seq(
            TableIdentifier("tbl1", Some("db2")),
            TableIdentifier("tbl2", Some("db2")))) == tablesWithCatalog)
      // Get table without explicitly specifying database
      catalog.setCurrentDatabase("db2")
      assert(
        catalog.getTablesByName(
          Seq(TableIdentifier("tbl1"), TableIdentifier("tbl2"))) == tablesWithCatalog)
    }
  }
    ...
    withBasicCatalog { catalog =>
      ...
      assert(
        catalog.getTablesByName(
          Seq(
            TableIdentifier("tbl1", Some("db2")),
            TableIdentifier("tblnotexit", Some("db2")))) == tablesWithCatalog)
      // Get table without explicitly specifying database
      catalog.setCurrentDatabase("db2")
      assert(
        catalog.getTablesByName(
          Seq(TableIdentifier("tbl1"), TableIdentifier("tblnotexit"))) == tablesWithCatalog)
    }
  }
    ...
    withBasicCatalog { catalog =>
      ...
      assert(
        catalog.getTablesByName(
          Seq(
            TableIdentifier("tbl1", Some("db2")),
            TableIdentifier(name, Some("db2")))) == tablesWithCatalog)
      // Get table without explicitly specifying database
      catalog.setCurrentDatabase("db2")
      assert(
        catalog.getTablesByName(
          Seq(TableIdentifier("tbl1"), TableIdentifier(name))) == tablesWithCatalog)
    }
  }
  ...
  test("get tables by name when empty") {
    withBasicCatalog { catalog =>
      assert(
        catalog.getTablesByName(Seq.empty)
  ...
  test("get tables by name when tables belong to different databases") {
    withBasicCatalog { catalog =>
      intercept[AnalysisException](
        catalog.getTablesByName(
          Seq(TableIdentifier("tbl1", Some("db1")), TableIdentifier("tbl2", Some("db2")))))
      // Get table without explicitly specifying database
      catalog.setCurrentDatabase("db2")
      intercept[AnalysisException](
        catalog.getTablesByName(
          Seq(TableIdentifier("tbl1", Some("db1")), TableIdentifier("tbl2"))))
    }
  }
  ...
  test("lookup table relation") {
    withBasicCatalog { catalog =>
      ...
      assert(
        catalog
          .lookupRelation(TableIdentifier("tbl1", Some("db2")))
          .children
          .head
          .asInstanceOf[UnresolvedCatalogRelation]
          .tableMeta == metastoreTable1)
      ...
      assert(
        catalog
          .lookupRelation(TableIdentifier("tbl1"))
          .children
          .head
          .asInstanceOf[UnresolvedCatalogRelation]
          .tableMeta == metastoreTable1)
  ...
  test("look up view relation") {
    withBasicCatalog { catalog =>
      ...
      catalog.createTable(newView("db3", "view1", props), ignoreIfExists = false)
  ...
  test("getTempViewOrPermanentTableMetadata on temporary views") {
    withBasicCatalog { catalog =>
      ...
      assert(
        catalog
          .getTempViewOrPermanentTableMetadata(TableIdentifier("view1"))
          .identifier
          .table == "view1")
      assert(
        catalog
  ...
  test("list tables with pattern") {
    withBasicCatalog { catalog =>
      ...
      assert(
        catalog.listTables("db2", "tbl*").toSet ==
          Set(
            TableIdentifier("tbl1"),
            TableIdentifier("tbl4"),
            TableIdentifier("tbl1", Some("db2")),
  ...
  test("list tables with pattern and includeLocalTempViews") {
    withEmptyCatalog { catalog =>
      ...
      assert(
        catalog.listTables("mydb").toSet ==
          catalog.listTables("mydb", "*", false).toSet ++ catalog.listLocalTempViews("*"))
      assert(
        catalog.listTables("mydb", "*", true).toSet ==
          Set(
            TableIdentifier("tbl1", Some("mydb")),
            TableIdentifier("tbl2", Some("mydb")),
            TableIdentifier("temp_view1"),
            TableIdentifier("temp_view4")))
      assert(
        catalog.listTables("mydb", "*", false).toSet ==
          Set(TableIdentifier("tbl1", Some("mydb")), TableIdentifier("tbl2", Some("mydb"))))
      assert(
        catalog.listTables("mydb", "tbl*", true).toSet ==
          Set(TableIdentifier("tbl1", Some("mydb")), TableIdentifier("tbl2", Some("mydb"))))
      assert(
        catalog.listTables("mydb", "tbl*", false).toSet ==
          Set(TableIdentifier("tbl1", Some("mydb")), TableIdentifier("tbl2", Some("mydb"))))
      assert(
        catalog.listTables("mydb", "temp_view*", true).toSet ==
  ...
  test("list temporary view with pattern") {
    withBasicCatalog { catalog =>
      ...
      createTempView(catalog, "temp_view4", tempTable, overrideIfExists = false)
      assert(
        catalog.listLocalTempViews("*").toSet ==
          Set(TableIdentifier("temp_view1"), TableIdentifier("temp_view4")))
      assert(
        catalog.listLocalTempViews("temp_view*").toSet ==
          Set(TableIdentifier("temp_view1"), TableIdentifier("temp_view4")))
  ...
  test("list global temporary view and local temporary view with pattern") {
    withBasicCatalog { catalog =>
      ...
      assert(
        catalog.listTables(catalog.globalTempDatabase, "*").toSet ==
          Set(
            TableIdentifier("temp_view1"),
            TableIdentifier("temp_view4"),
      ...
      assert(
        catalog.listTables(catalog.globalTempDatabase, "*temp_view1").toSet ==
          Set(
            TableIdentifier("temp_view1"),
            TableIdentifier("global_temp_view1", Some(catalog.globalTempDatabase))))
      assert(
        catalog.listTables(catalog.globalTempDatabase, "global*").toSet ==
          Set(
            TableIdentifier("global_temp_view1", Some(catalog.globalTempDatabase)),
            TableIdentifier("global_temp_view2", Some(catalog.globalTempDatabase))))
    }
  ...
  test("basic create and list partitions") {
    withEmptyCatalog { catalog =>
      ...
      catalog.createPartitions(
        TableIdentifier("tbl", Some("mydb")),
        Seq(part1, part2),
        ignoreIfExists = false)
      assert(
        catalogPartitionsEqual(
          catalog.externalCatalog.listPartitions("mydb", "tbl"),
          part1,
          part2))
    ...
    withBasicCatalog { catalog =>
      ...
      checkError(
        exception = intercept[AnalysisException] {
          catalog.createPartitions(
            TableIdentifier("tbl2", Some("db2")),
            Seq(partWithUnknownColumns, part1),
            ignoreIfExists = true)
        },
        condition = "_LEGACY_ERROR_TEMP_1232",
        parameters = Map(
      ...
      checkError(
        exception = intercept[AnalysisException] {
          catalog.createPartitions(
            TableIdentifier("tbl2", Some("db2")),
            Seq(partWithEmptyValue, part1),
            ignoreIfExists = true)
        },
        condition = "_LEGACY_ERROR_TEMP_1076",
        parameters =
          Map("details" -> "The spec ([a=3, b=]) contains an empty partition column value"))
    }
  }
  ...
  test("drop partitions") {
    withBasicCatalog { catalog =>
      assert(
        catalogPartitionsEqual(
          catalog.externalCatalog.listPartitions("db2", "tbl2"),
          part1,
          part2))
      catalog.dropPartitions(
        ...
        purge = false,
        retainData = false)
      assert(catalogPartitionsEqual(catalog.externalCatalog.listPartitions("db2", "tbl2"), part2))
  ...
  test("get partition") {
    withBasicCatalog { catalog =>
      assert(
        catalog.getPartition(TableIdentifier("tbl2", Some("db2")), part1.spec).spec == part1.spec)
      assert(
        catalog.getPartition(TableIdentifier("tbl2", Some("db2")), part2.spec).spec == part2.spec)
  ...
  test("list partitions") {
    withBasicCatalog { catalog =>
      ...
      catalog.setCurrentDatabase("db2")
      assert(
        catalogPartitionsEqual(catalog.listPartitions(TableIdentifier("tbl2")), part1, part2))
    }
  }
  ...
  test("list partitions with partial partition spec") {
    withBasicCatalog { catalog =>
      assert(
        catalogPartitionsEqual(
          catalog.listPartitions(TableIdentifier("tbl2", Some("db2")), Some(Map("a" -> "1"))),
          part1))
    }
  }
  ...
  private def catalogPartitionsEqual(
    ...
    val actualPartsNormalize = actualParts
      .map(p =>
        p.copy(
          parameters = Map.empty,
          createTime = -1,
          lastAccessTime = -1,
          storage = p.storage.copy(properties = Map.empty, locationUri = None, serde = None)))
      .toSet

    val expectedPartsNormalize = expectedParts
      .map(p =>
        p.copy(
          parameters = Map.empty,
          createTime = -1,
  ...
  test("create function when database does not exist") {
    withBasicCatalog { catalog =>
      intercept[NoSuchNamespaceException] {
        catalog.createFunction(newFunc("func5", Some("does_not_exist")), ignoreIfExists = false)
      }
    }
  }
    ...
    withBasicCatalog { catalog =>
      ...
      val e = intercept[AnalysisException] {
        catalog.registerFunction(
          newFunc("temp1", None),
          overrideIfExists = false,
          functionBuilder = Some(tempFunc3))
      }
      checkError(
        e,
      ...
      catalog.registerFunction(
        ...
        functionBuilder = Some(tempFunc3))
      assert(
        catalog.lookupFunction(FunctionIdentifier("temp1"), arguments) === Literal(
          arguments.length))
      ...
      checkError(
        exception = intercept[AnalysisException] {
          catalog.registerFunction(
            CatalogFunction(
              FunctionIdentifier("temp2", None),
              "function_class_cannot_load",
        ...
        parameters =
          Map("className" -> "function_class_cannot_load", "functionName" -> "`temp2`"))
    }
  }
  ...
  test("drop function") {
    withBasicCatalog { catalog =>
      assert(catalog.externalCatalog.listFunctions("db2", "*").toSet == Set("func1"))
      catalog.dropFunction(FunctionIdentifier("func1", Some("db2")), ignoreIfNotExists = false)
    ...
    withBasicCatalog { catalog =>
      intercept[NoSuchNamespaceException] {
        catalog.dropFunction(
          FunctionIdentifier("something", Some("unknown_db")),
          ignoreIfNotExists = false)
      }
    ...
    withBasicCatalog { catalog =>
      ...
      assert(
        catalog.lookupFunction(
          ...
          Seq(Literal(1), Literal(2), Literal(3))) == Literal(1))
      catalog.dropTempFunction("func1", ignoreIfNotExists = false)
      intercept[NoSuchFunctionException] {
        catalog.lookupFunction(
          FunctionIdentifier("func1"),
  ...
  test("list functions") {
    withBasicCatalog { catalog =>
      ...
      catalog.registerFunction(
        ...
        functionBuilder = Some(tempFunc2))
      assert(
        catalog.listFunctions("db1", "*").map(_._1).toSet ==
          Set(FunctionIdentifier("func1"), FunctionIdentifier("yes_me")))
      assert(
        catalog.listFunctions("db2", "*").map(_._1).toSet ==
          Set(
            FunctionIdentifier("func1"),
      ...
      assert(
        catalog.listFunctions("db2", "func*").map(_._1).toSet ==
          Set(
            FunctionIdentifier("func1"),
            FunctionIdentifier("func1", Some("db2"), Some(SESSION_CATALOG_NAME)),
            FunctionIdentifier("func2", Some("db2"), Some(SESSION_CATALOG_NAME))))
  ...
  test("SPARK-38974: list functions in database") {
    withEmptyCatalog { catalog =>
      ...
      assert(
        catalog.listFunctions("default", "*").map(_._1).toSet ==
          Set(
            FunctionIdentifier("func1"),
  ...
  test("UnresolvedCatalogRelation requires database in identifier") {
    withEmptyCatalog { catalog =>
      ...
      val tableMetaWithoutDb = validTable.copy(identifier = TableIdentifier("test_table", None))
  ...
  test("SQLFunction requires either exprText or queryText") {
    ...
    val expectedMessage =
      "assertion failed: SQL function 'test_func' is missing function body. " +
  ...
  test("InMemoryCatalog.alterTable requires database in identifier") {
    ...
    val tableWithoutDb = validTable.copy(identifier = TableIdentifier("test_table", None))

...
class ExpressionParserSuite extends PlanTest {
  ...
  test("window function expressions") {
    ...
    assertEqual("foo(*) over (sort by null)", windowed(Seq.empty, Seq(Literal(null).asc)))

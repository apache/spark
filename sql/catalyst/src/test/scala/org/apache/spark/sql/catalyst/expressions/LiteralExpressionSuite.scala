...
import org.apache.spark.unsafe.types.{CalendarInterval, GeographyVal, GeometryVal, TimestampLTZNanos, TimestampNTZNanos, UTF8String}
...
class LiteralExpressionSuite extends SparkFunSuite with ExpressionEvalHelper {
  ...
  test("default") {
    ...
    checkEvaluation(
      Literal.default(TimestampNTZNanosType(9)), new TimestampNTZNanos(0L, 0.toShort))
    checkEvaluation(
      Literal.default(TimestampLTZNanosType(7)), new TimestampLTZNanos(0L, 0.toShort))

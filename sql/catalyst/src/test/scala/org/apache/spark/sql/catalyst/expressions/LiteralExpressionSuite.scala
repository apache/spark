...
class LiteralExpressionSuite extends SparkFunSuite with ExpressionEvalHelper {
  ...
  test("null") {
    ...
    checkEvaluation(Literal.create(null, DayTimeIntervalType.defaultConcreteType), null)
  ...
  test("default") {
    ...
    checkEvaluation(Literal.default(DayTimeIntervalType.defaultConcreteType), 0L)

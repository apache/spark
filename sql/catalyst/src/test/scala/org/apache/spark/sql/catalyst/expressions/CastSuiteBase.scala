...
abstract class CastSuiteBase extends SparkFunSuite with ExpressionEvalHelper {
  ...
  test("cast numeric to time") {
    ...
    // TINYINT
    checkEvaluation(cast(Literal.create(0.toByte, ByteType), TimeType()), sec_0)
    checkEvaluation(cast(Literal.create(1.toByte, ByteType), TimeType()), sec_1)
    checkEvaluation(cast(Literal.create(100.toByte, ByteType), TimeType()), sec_100)
    // SMALLINT
    checkEvaluation(cast(Literal.create(0.toShort, ShortType), TimeType()), sec_0)
    checkEvaluation(cast(Literal.create(1.toShort, ShortType), TimeType()), sec_1)
    checkEvaluation(cast(Literal.create(100.toShort, ShortType), TimeType()), sec_100)
    checkEvaluation(cast(Literal.create(999.toShort, ShortType), TimeType()), sec_999)
    checkEvaluation(cast(Literal.create(10999.toShort, ShortType), TimeType()), sec_10999)
    // INT
    ...
    checkEvaluation(cast(Literal.create(100, IntegerType), TimeType()), sec_100)
    checkEvaluation(cast(Literal.create(999, IntegerType), TimeType()), sec_999)
    checkEvaluation(cast(Literal.create(10999, IntegerType), TimeType()), sec_10999)
    checkEvaluation(cast(Literal.create(86399, IntegerType), TimeType()), sec_86399)
    checkEvaluation(cast(Literal.create(86400, IntegerType), TimeType()), sec_86400)
    checkEvaluation(cast(Literal.create(86401, IntegerType), TimeType()), sec_86401)
    checkEvaluation(cast(Literal.create(172799, IntegerType), TimeType()), sec_172799)
    checkEvaluation(cast(Literal.create(1000999, IntegerType), TimeType()), sec_1000999)
    checkEvaluation(cast(Literal.create(2000000999, IntegerType), TimeType()), sec_2000000999)
    // BIGINT
    ...
    checkEvaluation(cast(Literal.create(10999L, LongType), TimeType()), sec_10999)
    checkEvaluation(cast(Literal.create(86399L, LongType), TimeType()), sec_86399)
    checkEvaluation(cast(Literal.create(86400L, LongType), TimeType()), sec_86400)
    checkEvaluation(cast(Literal.create(86401L, LongType), TimeType()), sec_86401)
    checkEvaluation(cast(Literal.create(172799L, LongType), TimeType()), sec_172799)
    checkEvaluation(cast(Literal.create(1000999L, LongType), TimeType()), sec_1000999)
    checkEvaluation(cast(Literal.create(2000000999L, LongType), TimeType()), sec_2000000999)
    checkEvaluation(cast(Literal.create(86399999999999L, LongType), TimeType()), sec_86399999999999)
    // DECIMAL
    ...
    checkEvaluation(cast(Literal.create(Decimal(10999)), TimeType()), sec_10999)
    checkEvaluation(cast(Literal.create(Decimal(86399)), TimeType()), sec_86399)
    checkEvaluation(cast(Literal.create(Decimal(86400)), TimeType()), sec_86400)
    checkEvaluation(cast(Literal.create(Decimal(86401)), TimeType()), sec_86401)
    checkEvaluation(cast(Literal.create(Decimal(1000999)), TimeType()), sec_1000999)
    checkEvaluation(cast(Literal.create(Decimal(2000000999)), TimeType()), sec_2000000999)
    checkEvaluation(cast(Literal.create(Decimal(86399999999999L)), TimeType()), sec_86399999999999)
    // DOUBLE
    checkEvaluation(cast(Literal.create(0.0, DoubleType), TimeType()), sec_0)
    checkEvaluation(cast(Literal.create(1.0, DoubleType), TimeType()), sec_1)
    checkEvaluation(cast(Literal.create(100.0, DoubleType), TimeType()), sec_100)
    checkEvaluation(cast(Literal.create(999.0, DoubleType), TimeType()), sec_999)
    checkEvaluation(cast(Literal.create(10999.0, DoubleType), TimeType()), sec_10999)
    checkEvaluation(cast(Literal.create(86399.0, DoubleType), TimeType()), sec_86399)
    checkEvaluation(cast(Literal.create(86400.0, DoubleType), TimeType()), sec_86400)
    checkEvaluation(cast(Literal.create(86401.0, DoubleType), TimeType()), sec_86401)
    checkEvaluation(cast(Literal.create(1000999.0, DoubleType), TimeType()), sec_1000999)
    // FLOAT
    checkEvaluation(cast(Literal.create(0.0f, FloatType), TimeType()), sec_0)
    checkEvaluation(cast(Literal.create(1.0f, FloatType), TimeType()), sec_1)
    checkEvaluation(cast(Literal.create(100.0f, FloatType), TimeType()), sec_100)
    checkEvaluation(cast(Literal.create(999.0f, FloatType), TimeType()), sec_999)
    checkEvaluation(cast(Literal.create(10999.0f, FloatType), TimeType()), sec_10999)
    checkEvaluation(cast(Literal.create(86399.0f, FloatType), TimeType()), sec_86399)
    checkEvaluation(cast(Literal.create(86400.0f, FloatType), TimeType()), sec_86400)
    checkEvaluation(cast(Literal.create(86401.0f, FloatType), TimeType()), sec_86401)
    checkEvaluation(cast(Literal.create(1000999.0f, FloatType), TimeType()), sec_1000999)
  }

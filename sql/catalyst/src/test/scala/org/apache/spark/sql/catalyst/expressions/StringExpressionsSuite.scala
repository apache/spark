    ...
    Seq(
      ...
      ("454", "999@") ->
        DataTypeMismatch(
          ...
          messageParameters = Map(
            "token" -> "character '@''",
            "numberFormat" -> toSQLValue("999@", StringType))
        ),
      ("454", "999M") ->
        DataTypeMismatch(
          errorSubClass = "NUMBER_FORMAT_UNEXPECTED_TOKEN",
          messageParameters = Map(
            "token" -> "character 'M''",
            "numberFormat" -> toSQLValue("999M", StringType)
          )
        ),
      ("454", "999P") ->
        DataTypeMismatch(
          ...
          messageParameters = Map(
            "token" -> "character 'P''",
            "numberFormat" -> toSQLValue("999P", StringType))
        ),
      ...
      ("454", "99.99.99") ->
        DataTypeMismatch(
          ...
          messageParameters = Map(
            "token" -> ". or D",
            "numberFormat" -> toSQLValue("99.99.99", StringType))
        ),
      // Make sure the format string contains at most one dollar sign.
      ("454", "$$99") -> DataTypeMismatch(
        errorSubClass = "NUMBER_FORMAT_WRONG_NUM_TOKEN",
        messageParameters = Map("token" -> "$", "numberFormat" -> toSQLValue("$$99", StringType))),
      ...
      ("$4-4", "$9MI9") ->
        DataTypeMismatch(
          ...
          messageParameters = Map(
            ...
            "numberFormat" -> toSQLValue("$9MI9", StringType))
        ),
      ("--4", "SMI9") ->
        DataTypeMismatch(
          errorSubClass = "NUMBER_FORMAT_UNEXPECTED_TOKEN",
          messageParameters = Map(
            "token" -> "digit sequence",
            "numberFormat" -> toSQLValue("SMI9", StringType))
        ),
      ("--$54", "SS$99") ->
        DataTypeMismatch(
          errorSubClass = "NUMBER_FORMAT_WRONG_NUM_TOKEN",
          messageParameters = Map(
            "token" -> "S",
            "numberFormat" -> toSQLValue("SS$99", StringType))
        ),
      ("-$54", "MI$99MI") ->
        DataTypeMismatch(
          errorSubClass = "NUMBER_FORMAT_WRONG_NUM_TOKEN",
          messageParameters = Map(
            "token" -> "MI",
            "numberFormat" -> toSQLValue("MI$99MI", StringType))
        ),
      ("$4-4", "$9MI9MI") ->
        DataTypeMismatch(
          errorSubClass = "NUMBER_FORMAT_WRONG_NUM_TOKEN",
          messageParameters = Map("token" -> "MI",
            "numberFormat" -> toSQLValue("$9MI9MI", StringType))
        ),
      ...
      ("<$45>", "PR$99") ->
        DataTypeMismatch(
          ...
          messageParameters = Map(
            "token" -> "$",
            "numberFormat" -> toSQLValue("PR$99", StringType))
        ),
      ("$4<4>", "$9PR9") ->
        DataTypeMismatch(
          errorSubClass = "NUMBER_FORMAT_UNEXPECTED_TOKEN",
          messageParameters = Map(
            "token" -> "digit sequence",
            "numberFormat" -> toSQLValue("$9PR9", StringType))
        ),
      ("<<454>>", "999PRPR") ->
        DataTypeMismatch(
          errorSubClass = "NUMBER_FORMAT_WRONG_NUM_TOKEN",
          messageParameters = Map(
            "token" -> "PR",
            "numberFormat" -> toSQLValue("999PRPR", StringType))
        ),
      ...
      ("4$54", "9$99") -> DataTypeMismatch(
        ...
        messageParameters = Map("numberFormat" -> toSQLValue("9$99", StringType))),
      ...
      (".$99", ".$99") -> DataTypeMismatch(
        ...
        messageParameters = Map("numberFormat" -> toSQLValue(".$99", StringType))),
      ...
      (",123", ",099") -> DataTypeMismatch(
        ...
        messageParameters = Map("numberFormat" -> toSQLValue(",099", StringType))),
      (",123,456", ",999,099") -> DataTypeMismatch(
        errorSubClass = "NUMBER_FORMAT_THOUSANDS_SEPARATOR_MUST_HAVE_DIGIT_IN_BETWEEN",
        messageParameters = Map("numberFormat" -> toSQLValue(",999,099", StringType))),
      (",,345", "9,,09.99") -> DataTypeMismatch(
        errorSubClass = "NUMBER_FORMAT_THOUSANDS_SEPARATOR_MUST_HAVE_DIGIT_IN_BETWEEN",
        messageParameters = Map("numberFormat" -> toSQLValue("9,,09.99", StringType))),
      (",,345", "9,99,.99") -> DataTypeMismatch(
        errorSubClass = "NUMBER_FORMAT_THOUSANDS_SEPARATOR_MUST_HAVE_DIGIT_IN_BETWEEN",
        messageParameters = Map("numberFormat" -> toSQLValue("9,99,.99", StringType))),
      (",,345", "9,99,") -> DataTypeMismatch(
        errorSubClass = "NUMBER_FORMAT_THOUSANDS_SEPARATOR_MUST_HAVE_DIGIT_IN_BETWEEN",
        messageParameters = Map("numberFormat" -> toSQLValue("9,99,", StringType))),
      (",,345", ",,999,099.99") -> DataTypeMismatch(
        errorSubClass = "NUMBER_FORMAT_THOUSANDS_SEPARATOR_MUST_HAVE_DIGIT_IN_BETWEEN",
        messageParameters = Map("numberFormat" -> toSQLValue(",,999,099.99", StringType))),
      ...
      ("123.45,6", "099.99,9") -> DataTypeMismatch(
        ...
        messageParameters = Map("numberFormat" -> toSQLValue("099.99,9", StringType)))

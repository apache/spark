...
class StringExpressionsSuite extends SparkFunSuite with ExpressionEvalHelper {
  ...
  test("StringComparison") {
    ...
    val c1 = "a".attr.string.at(0)
    val c2 = "a".attr.string.at(1)
  ...
  test("Substring") {
    ...
    val s_notNull = "a".attr.string.notNull.at(0)

...
class CollapseRepartitionSuite extends PlanTest {
  ...
  test("distribute above repartition") {
    ...
    val optimized1 = Optimize.execute(query1.analyze)
    val optimized2 = Optimize.execute(query2.analyze)
    val correctAnswer = testRelation.distribute(Symbol("a"))(20).analyze
  ...
  test("repartition above distribute") {
    ...
    val query1 = testRelation
      .distribute(Symbol("a"))(10)
      .repartition(20)
    val query2 = testRelation
      .distribute(Symbol("a"))(30)
      .repartition(20)
  ...
  test("coalesce above distribute") {
    ...
    val optimized1 = Optimize.execute(query1.analyze)
    val correctAnswer1 = testRelation.distribute(Symbol("a"))(10).analyze
  ...
  test("collapse two adjacent distributes into one") {
    ...
    val query1 = testRelation
      .distribute(Symbol("b"))(10)
      .distribute(Symbol("a"))(20)
    val query2 = testRelation
      .distribute(Symbol("b"))(30)
      .distribute(Symbol("a"))(20)

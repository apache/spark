...
class DateExpressionsSuite extends SparkFunSuite with ExpressionEvalHelper {
  ...
  test("creating values of TimestampType via make_timestamp") {
    var makeTimestampExpr = MakeTimestamp(
      ...
      Literal(Decimal(BigDecimal(23.5), 20, 6)), Some(Literal(ZoneId.systemDefault().getId)))
    ...
    checkEvaluation(makeTimestampExpr.copy(sec = Literal.create(null, DecimalType(20, 6))), null)
    checkEvaluation(makeTimestampExpr.copy(sec = Literal(Decimal(BigDecimal(70.0), 20, 6))), null)

    makeTimestampExpr = MakeTimestamp(Literal(2019), Literal(6), Literal(30),
      Literal(23), Literal(59), Literal(Decimal(BigDecimal(60.0), 20, 6)))
    checkEvaluation(makeTimestampExpr, Timestamp.valueOf("2019-07-01 00:00:00"))
    checkEvaluation(makeTimestampExpr.copy(sec = Literal(Decimal(BigDecimal(60.5), 20, 6))), null)

    makeTimestampExpr = MakeTimestamp(Literal(2019), Literal(8), Literal(12),
      Literal(0), Literal(0), Literal(Decimal(BigDecimal(58.000001), 20, 6)))

...
class TableIdentifierParserSuite extends SparkFunSuite with SQLHelper {
  ...
  val allCandidateKeywords = Set("abs", "absolute", "acos", "action", "add", "after",
    ...
    "between", "bigint", "binary", "bit", "bit_length", "blob", "boolean", "both", "breadth",
    "bucket", "buckets", "by", "cache", "call", "called", "cardinality", "cascade", "cascaded",
    "case", "cast", "catalog", "ceil", "ceiling", "change", "char", "char_length", "character",
    "character_length", "check", "classifier", "clear", "clob", "close", "cluster", "clustered",
    "coalesce", "codegen", "collate", "collation", "collect", "collection", "column", "columns",
    "comment", "commit", "compact", "compactions", "compute", "concatenate", "condition", "connect",
    "connection", "constraint", "constraints", "constructor", "contains", "continue", "convert",
    ...
    "current_user", "cursor", "cycle", "data", "database", "databases", "date", "day",
    "dbproperties", "deallocate", "dec", "decfloat", "decimal", "declare", "default", "deferrable",
    "deferred", "define", "defined", "delete", "delimited", "dense_rank", "depth", "deref", "desc",
    "describe", "descriptor", "deterministic", "dfs", "diagnostics", "directories", "directory",
    "disconnect", "distinct", "distribute", "div", "do", "domain", "double", "drop", "dynamic",
    "each", "element", "else", "elseif", "empty", "end", "end_frame", "end_partition", "equals",
    "escape", "escaped", "every", "except", "exception", "exchange", "exec", "execute", "exists",
    "exit", "exp", "explain", "export", "extended", "external", "extract", "false", "fetch",
    "fields", "fileformat", "filter", "first", "first_value", "float", "following", "for",
    "foreign", "format", "formatted", "found", "frame_row", "free", "from", "full", "function",
    "functions", "fusion", "general", "get", "global", "go", "goto", "grant", "group", "grouping",
    "groups", "handler", "having", "hold", "hour", "identity", "if", "ignore", "immediate",
    "import", "in", "index", "indexes", "indicator", "initial", "initially", "inner", "inout",
    "inpath", "input", "inputformat", "insensitive", "insert", "int", "integer", "intersect",
    "intersection", "interval", "into", "is", "isolation", "items", "iterate", "join", "json_array",
    "json_arrayagg", "json_exists", "json_object", "json_objectagg", "json_query", "json_table",
    "json_table_primitive", "json_value", "key", "keys", "lag", "language", "large", "last",
    "last_value", "lateral", "lazy", "lead", "leading", "leave", "left", "level", "like",
    "like_regex", "limit", "lines", "list", "listagg", "ln", "load", "local", "localtime",
    "localtimestamp", "location", "locator", "lock", "locks", "log", "log10", "logical", "loop",
    "lower", "macro", "map", "match", "match_number", "match_recognize", "matches", "max", "member",
    "merge", "method", "min", "minute", "mod", "modifies", "module", "month", "msck", "multiset",
    ...
    "select", "sensitive", "separated", "serde", "serdeproperties", "session", "session_user",
    "set", "sets", "show", "signal", "similar", "sin", "sinh", "size", "skewed", "skip", "smallint",
    "some", "sort", "sorted", "space", "specific", "specifictype", "sql", "sqlcode", "sqlerror",
    ...
    "system_user", "table", "tables", "tablesample", "tan", "tanh", "tblproperties", "temporary",
    "terminated", "then", "time", "timestamp", "timezone_hour", "timezone_minute", "to", "touch",

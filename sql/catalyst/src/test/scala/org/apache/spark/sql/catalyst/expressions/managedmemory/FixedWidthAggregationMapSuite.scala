...
import org.apache.spark.managedmemory.memory.{ExecutorMemoryManager, MemoryAllocator, TaskMemoryManager}
import org.apache.spark.sql.catalyst.expressions._
import org.apache.spark.sql.types._

class FixedWidthAggregationMapSuite extends FunSuite with Matchers with BeforeAndAfterEach {

  import FixedWidthAggregationMap._
  ...
  test("empty map") {
    val map = new FixedWidthAggregationMap(

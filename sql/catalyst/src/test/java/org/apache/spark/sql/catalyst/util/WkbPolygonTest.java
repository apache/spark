...
public class WkbPolygonTest {
  ...
  public void testSimplePolygon() {
    ...
    Polygon polygon = new Polygon(Arrays.asList(ring), 0);
  ...
  public void testEmptyPolygon() {
    // POLYGON EMPTY
    Polygon polygon = new Polygon(Arrays.asList(), 0);
  ...
  public void testPolygonWithHole() {
    ...
    Polygon polygon = new Polygon(Arrays.asList(exteriorRing, interiorRing), 0);
  ...
  public void testPolygonRoundTrip() {
    ...
    Ring ring = new Ring(ringPoints);
    Polygon original = new Polygon(Arrays.asList(ring), 0);
  ...
  public void testTrianglePolygon() {
    ...
    Polygon triangle = new Polygon(Arrays.asList(ring), 0);
  ...
  public void testPolygonToString() {
    ...
    Polygon emptyPoly = new Polygon(Arrays.asList(), 0);

...
nonReserved
    ...
    | BOTH | BUCKET | BUCKETS | BY | CACHE | CASCADE | CASE | CAST | CHECK | COLLATE | CHANGE | CLEAR | CLUSTER | CLUSTERED | CODEGEN
    ...
    | PRIMARY | PRINCIPALS | PURGE | RANGE | RECORDREADER | RECORDWRITER | RECOVER | REDUCE | REFERENCES | REFRESH | RENAME | REPAIR
    ...
    | UNCACHE | UNLOCK | UNIQUE | UNSET | USE | USER | VALUES | VIEW | WHEN | WHERE | WINDOW | WITH
    ;

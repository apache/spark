...
nonReserved
    : SHOW | TABLES | COLUMNS | COLUMN | PARTITIONS | FUNCTIONS | DATABASE | DATABASES
    | ADD | ADMIN | ASC | BEFORE
    ...
    | CLUSTERSTATUS | CONTINUE | DAY | DATETIME | DEFERRED | DEPENDENCY | DESC | DIRECTORY
    | DISABLE | ELEM_TYPE | ENABLE | EXCLUSIVE | HOLD_DDLTIME | HOUR | IDXPROPERTIES | IGNORE
    | INPATH | JAR | KEY_TYPE | LIMIT | MAP_JOIN | MATERIALIZED | MINUS | MINUTE | MONTH
    | NOSCAN | NO_DROP | OFFLINE | OVERWRITE | OWNER | PLUS | PRETTY | PROTECTION | READONLY
    | REBUILD | RELOAD | RENAME | REPAIR | REWRITE | SECOND | SERVER | SETS | SHARED
    | SHOW_DATABASE | SSL | STREAMTABLE | UNDO | URI | UTC | VALUE_TYPE | WHILE | YEAR
    ;

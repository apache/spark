...
MICROSECONDS: 'MICROSECONDS' | 'US' | 'USEC' | 'USECS' | 'USECONDS';
MILLISECOND: 'MILLISECOND';
MILLISECONDS: 'MILLISECONDS' | 'MS' | 'MSEC' | 'MSECS' | 'MSECONDS';
MINUTE: 'MINUTE';
MINUTES: 'MINUTES' |  'M' | 'MIN' | 'MINS';
MONTH: 'MONTH';
MONTHS: 'MONTHS' | 'MON' | 'MONS';
MSCK: 'MSCK';
NAMESPACE: 'NAMESPACE';

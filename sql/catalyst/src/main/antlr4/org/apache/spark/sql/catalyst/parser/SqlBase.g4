...
ansiReserved
    ...
    | FETCH | FOR | FOREIGN | FROM | FULL | GRANT | GROUP | HAVING | IN | INNER | INTERSECT | INTO | IS | JOIN
...
nonReserved
    ...
    | UNBOUNDED | UNCACHE | UNIQUE | UNLOCK | UNSET | USE | USER | VALUES | VIEW | WHEN | WHERE | WINDOW | WITH
    ;

...
public interface MetadataColumn {
  ...
  /**
   * Indicates whether a row-level operation should preserve the value of the metadata column
   * for inserts generated by splitting updated rows into deletes and inserts. If true,
   * the metadata value will be retained and passed back to the writer. If false, the
  ...
  boolean PRESERVE_ON_INSERT_AS_UPDATE_DEFAULT = false;

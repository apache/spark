...
public interface SupportsDeleteV2 extends TruncatableTable {
   ...
   * individual records.
   *
   * @param predicates V2 filter expressions, used to select rows to delete when all expressions match
   ...
   *
   * @param predicates predicate expressions, used to select rows to delete when all expressions match

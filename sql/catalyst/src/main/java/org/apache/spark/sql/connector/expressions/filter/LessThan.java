 ...
 */
@Evolving
public final class LessThan extends FilterV2 {
  private final FieldReference column;
  private final Expression value;

  public LessThan(FieldReference column, Expression value) {
    this.column = column;
    this.value = value;
  }
  ...
  @Override
  public String toString() { return column.describe() + " LessThan: " + value.describe(); }

 ...
 */
@Evolving
public final class LessThanOrEqual extends FilterV2 {
  private final FieldReference column;
  private final Expression value;

  public LessThanOrEqual(FieldReference column, Expression value) {
    this.column = column;
    this.value = value;
  }
  ...
  @Override
  public String toString() { return column.describe() + " LessThanOrEqual: " + value.describe(); }

...
import org.apache.spark.sql.catalyst.catalog.{CatalogDatabase, CatalogRelation, InMemoryCatalog}
import org.apache.spark.sql.catalyst.catalog.{SessionCatalog, SimpleCatalogRelation}

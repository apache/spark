...
import org.apache.spark.sql.catalyst.trees.TreePattern.{EMPTY_LOCAL_RELATION, TRUE_OR_FALSE_LITERAL}
...
object PropagateEmptyRelation extends Rule[LogicalPlan] with PredicateHelper with CastSupport {
  ...
  def apply(plan: LogicalPlan): LogicalPlan = plan.transformUpWithPruning(
    _.containsAnyPattern(EMPTY_LOCAL_RELATION, TRUE_OR_FALSE_LITERAL), ruleId) {

...
abstract class StatisticalMoments(child: Expression) extends AlgebraicAggregate {
  ...
  override val updateExpressions = {
    ...
    lazy val updateM3: Expression = {
      currentM3 + deltaN * deltaN * delta * (updateM0 - Cast(Literal(1), resultType)) *
        (updateM0 - Cast(Literal(2), resultType)) - deltaN * currentM2 * Cast(Literal(3), resultType)
    }
    lazy val updateM4: Expression = {
  ...
  override val mergeExpressions = {
    ...
    lazy val M4 = currentM4.left + currentM4.right + deltaN * deltaN * deltaN * delta * currentM0.left *
...
abstract class StableMoments(child: Expression) extends AlgebraicAggregate {
  ...
  def kahan(s1: Expression, c1: Expression, s2: Expression, c2: Expression) = {
    ...
    val diff = (s - s1)
    val correction = correctedS2 - diff
    (s, correction)
  }

...
trait NamedExpression extends Expression {
  ...
  /** Returns true if the expression is a metadata column */
  def isMetadataColumn: java.lang.Boolean = false
 ...
 * @param isMetadataColumn A flag to indicate if this alias is a metadata column
 */
case class Alias(child: Expression, name: String)(
    ...
    override val isMetadataColumn: java.lang.Boolean = false)
  ...
  override def toAttribute: Attribute = {
    if (resolved) {
      AttributeReference(name, child.dataType, child.nullable, metadata)(
        exprId, qualifier, isGenerated, isMetadataColumn)
    } else {
  ...
  override protected final def otherCopyArgs: Seq[AnyRef] = {
    exprId :: qualifier :: explicitMetadata :: isGenerated :: isMetadataColumn :: Nil
  }
 ...
 * @param isMetadataColumn A flag to indicate if this reference is a metadata column
 */
case class AttributeReference(
  ...
  override def newInstance(): AttributeReference =
    AttributeReference(name, dataType, nullable, metadata)(
      qualifier = qualifier, isGenerated = isGenerated, isMetadataColumn = isMetadataColumn)
  ...
  override def withQualifier(newQualifier: Option[String]): AttributeReference = {
    if (newQualifier == qualifier) {
      ...
      AttributeReference(name, dataType, nullable, metadata)(
        exprId, newQualifier, isGenerated, isMetadataColumn)
    }
  }
  ...
  def withExprId(newExprId: ExprId): AttributeReference = {
    if (exprId == newExprId) {
      ...
      AttributeReference(name, dataType, nullable, metadata)(
        newExprId, qualifier, isGenerated, isMetadataColumn)
    }
  }
  ...
  override protected final def otherCopyArgs: Seq[AnyRef] = {
    exprId :: qualifier :: isGenerated :: isMetadataColumn :: Nil
  }

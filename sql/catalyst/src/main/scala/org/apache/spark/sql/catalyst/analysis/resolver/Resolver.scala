...
class Resolver(
    ...
    sharedRelationCache: SharedRelationCache = SharedRelationCache.empty,
...
object Resolver {
  ...
  def createRelationResolution(
      catalogManager: CatalogManager,
      relationCache: SharedRelationCache = SharedRelationCache.empty): RelationResolution = {
    new RelationResolution(catalogManager, relationCache)
  }
}

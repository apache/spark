...
import org.apache.spark.{Partition, SparkArithmeticException, SparkClassNotFoundException, SparkException, SparkFileAlreadyExistsException, SparkFileNotFoundException, SparkIOException, SparkNoSuchElementException, SparkRuntimeException, SparkUnsupportedOperationException, SparkUpgradeException}
...
object QueryExecutionErrors {
  ...
  def alterTableWithDropPartitionAndPurgeUnsupportedError(): Throwable = {
    new SparkUnsupportedOperationException(
      errorClass = "ALTER_TABLE_WITH_DROP_PARTITION_AND_PURGE_UNSUPPORTED_ERROR",
      messageParameters = Array.empty
    )
  }
  ...
  def renameSrcPathNotFoundError(srcPath: Path): Throwable = {
    new SparkFileNotFoundException(
      errorClass = "RENAME_SRC_PATH_NOT_FOUND_ERROR",
  ...
  def failedRenameTempFileError(srcPath: Path, dstPath: Path): Throwable = {
    new SparkIOException(
      errorClass = "FAILED_RENAME_TEMP_FILE_ERROR",
      messageParameters = Array(srcPath.toString, dstPath.toString)
    )
  }
  ...
  def legacyMetadataPathExistsError(metadataPath: Path, legacyMetadataPath: Path): Throwable = {
    new SparkException(
      errorClass = "LEGACY_METADATA_PATH_EXISTS_ERROR",
      messageParameters = Array(
  ...
  def partitionColumnNotFoundInSchemaError(col: String, schema: StructType): Throwable = {
    new SparkRuntimeException(
      errorClass = "PARTITION_COLUMN_NOT_FOUND_IN_SCHEMA_ERROR",
  ...
  def stateNotDefinedOrAlreadyRemovedError(): Throwable = {
    new SparkNoSuchElementException(
      errorClass = "STATE_NOT_DEFINED_OR_ALREADY_REMOVED_ERROR",
      messageParameters = Array.empty
    )
  }
  ...
  def cannotSetTimeoutDurationError(): Throwable = {
    new SparkUnsupportedOperationException(
      errorClass = "CANNOT_SET_TIMEOUT_DURATION_ERROR",
      messageParameters = Array.empty
    )
  }

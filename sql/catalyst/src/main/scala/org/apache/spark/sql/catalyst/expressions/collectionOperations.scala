...
case class ArrayInsert(srcArrayExpr: Expression, posExpr: Expression, itemExpr: Expression)
  ...
  override def dataType: DataType = third.nullable match {
    case true => first.dataType.asNullable
    case false => first.dataType
  }
...
case class ArrayAppend(left: Expression, right: Expression)
   ...
   */
  override def dataType: DataType = right.nullable match {
    case true => left.dataType.asNullable
    case false => left.dataType
  }

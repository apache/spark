...
object SortArray {
  private def lt(ordering: Ordering[Any]): Comparator[Any] = {
    (o1: Any, o2: Any) => {
      if (o1 == null && o2 == null) {
        0
      } else if (o1 == null) {
  ...
  private def gt(ordering: Ordering[Any]): Comparator[Any] = {
    (o1: Any, o2: Any) => {
      if (o1 == null && o2 == null) {
        0
      } else if (o1 == null) {
  ...
  def sortEval(
      ...
      ascending: Boolean = true): Any = {
    val data = array.asInstanceOf[ArrayData].toArray[AnyRef](elementType)
    if (elementType != NullType) {
      java.util.Arrays.sort(data, if (ascending) lt(ordering) else gt(ordering))
    }
  ...
  def sortCodegen(
      elementType: DataType,
      resultArrayElementNullable: Boolean,
      ctx: CodegenContext,
      ev: ExprCode,
      base: String,
    ...
    if (elementType == NullType) {
      ...
      s"""
         ...
         |  final int $sortOrder = $ascending ? 1 : -1;
...
case class SortArray(base: Expression, ascendingOrder: Expression)
  ...
  def arrayExpression: Expression = base
  ...
  @transient private lazy val ordering = PhysicalDataType.ordering(elementType)

  override def nullSafeEval(array: Any, ascending: Any): Any = {
    SortArray.sortEval(array, ordering, elementType, ascending.asInstanceOf[Boolean])
  }

  override def doGenCode(ctx: CodegenContext, ev: ExprCode): ExprCode = {
    nullSafeCodeGen(ctx, ev, (b, order) =>
      SortArray.sortCodegen(elementType, resultArrayElementNullable, ctx, ev, b, order))
  }

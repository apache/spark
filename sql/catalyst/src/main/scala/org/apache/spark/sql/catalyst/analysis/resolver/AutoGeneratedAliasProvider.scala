...
/**
 * [[AutoGeneratedAliasProvider]] is a tool to create auto-generated aliases in the plan. All the
 * auto-generated aliases have to be registered in [[ExpressionIdAssigner]].
 */
class AutoGeneratedAliasProvider(expressionIdAssigner: ExpressionIdAssigner) {

  /**
   * Create a new auto-generated [[Alias]]. If the `name` is not provided, [[toPrettySql]] is
   * going to be used to generate a proper alias name. We call
   * [[ExpressionIdAssigner.mapExpression]] to register this alias in the
  ...
  /**
   * Create a new auto-generated [[Alias]]. If the `name` is not provided, [[toPrettySql]] is
   * going to be used to generate a proper alias name. We don't call
  ...
  def newAliasImpl(
    ...
    val alias = Alias(child = child, name = name.getOrElse(toPrettySQL(child)))(explicitMetadata =
      explicitMetadata)

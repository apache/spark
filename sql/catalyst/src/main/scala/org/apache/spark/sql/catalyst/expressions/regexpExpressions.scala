...
import org.apache.spark.sql.internal.types.{StringTypeAnyCollation, StringTypeUTF8Lcase}
...
abstract class StringRegexExpression extends BinaryExpression
  ...
  override def inputTypes: Seq[AbstractDataType] =
    Seq(StringTypeUTF8Lcase, StringTypeAnyCollation)
...
sealed abstract class MultiLikeBase
  ...
  override def inputTypes: Seq[AbstractDataType] = StringTypeUTF8Lcase :: Nil
...
case class StringSplit(str: Expression, regex: Expression, limit: Expression)
  ...
  override def inputTypes: Seq[AbstractDataType] =
    Seq(StringTypeUTF8Lcase, StringTypeAnyCollation, IntegerType)
...
case class RegExpReplace(subject: Expression, regexp: Expression, rep: Expression, pos: Expression)
  ...
  override def inputTypes: Seq[AbstractDataType] =
    Seq(StringTypeUTF8Lcase, StringTypeAnyCollation, StringTypeUTF8Lcase, IntegerType)

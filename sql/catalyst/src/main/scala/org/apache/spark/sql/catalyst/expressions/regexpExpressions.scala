  ...
  arguments = """
    Arguments:
      ...
      * pattern - a string expression. The pattern is a string which is matched literally, with
          exception to the following special symbols:<br>
          _ matches any one character in the input (similar to . in posix regular expressions)\
          % matches zero or more characters in the input (similar to .* in posix regular
          expressions)<br>
          Since Spark 2.0, string literals are unescaped in our SQL parser. For example, in order
          to match "\abc", the pattern should be "\\abc".<br>
  ...
  arguments = """
    Arguments:
      ...
      * pattern - a string expression. The pattern is a string which is matched literally and
          case-insensitively, with exception to the following special symbols:<br>
          _ matches any one character in the input (similar to . in posix regular expressions)<br>
          % matches zero or more characters in the input (similar to .* in posix regular
          expressions)<br>
          Since Spark 2.0, string literals are unescaped in our SQL parser. For example, in order
          to match "\abc", the pattern should be "\\abc".<br>

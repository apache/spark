...
import org.apache.spark.sql.catalyst.trees.TreePattern.{DATASOURCEV2_RELATION, TreePattern}
...
case class DataSourceV2Relation(
  ...
  final override val nodePatterns: Seq[TreePattern] = Seq(DATASOURCEV2_RELATION)

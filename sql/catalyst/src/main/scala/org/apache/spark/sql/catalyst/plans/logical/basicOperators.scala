...
/**
 * GROUPING SETS is a quite useful analytics function.
 ...
 *
 * We will transform GROUPING SETS into logical plan Aggregate(xx, Expand) in Analyzer
 */
...
// Cube is a syntactic sugar for GROUPING SETS,
// and will be transformed to GroupingSets in Analyzer
case class Cube(
    groupByExprs: Seq[Expression],
    child: LogicalPlan,
    aggregations: Seq[NamedExpression],
...
// Rollup is a syntactic sugar for GROUPING SETS,
// and will be transformed to GroupingSets in Analyzer
case class Rollup(
    groupByExprs: Seq[Expression],
    child: LogicalPlan,

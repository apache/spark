...
object SQLConf {
  ...
  val FILE_SINK_FORMAT_CHECK_ENABLED =
    buildConf("spark.sql.streaming.fileSink.formatCheck.enabled")
      .internal()
      .doc("Whether to check a directory is generated by the file streaming sink. If this is " +
        "set to 'false', Spark will skip the check and assume it's not generated by the file " +
        "streaming sink.")
      .booleanConf
      .createWithDefault(true)

...
object SQLConf {
  ...
  val REPL_EAGER_EAVL_ENABLED = buildConf("spark.sql.repl.eagerEval.enabled")
    .doc("Enable eager evaluation or not. If true and the REPL you are using supports eager " +
      ...
      "user have defined. For plain Python REPL, the output will be shown like " +
      "<code>dataframe.show()</code>.")
    .booleanConf
    .createWithDefault(false)

  val REPL_EAGER_EAVL_MAX_NUM_ROWS = buildConf("spark.sql.repl.eagerEval.maxNumRows")
    .doc("Default number of rows in eager evaluation output HTML table generated by " +
      "<code>_repr_html_</code> or plain text, this only takes effect when " +
      "<code>spark.sql.repl.eagerEval.enabled</code> is set to true. The valid range of this " +
  ...
  val REPL_EAGER_EAVL_TRUNCATE = buildConf("spark.sql.repl.eagerEval.truncate")
    .doc("Default number of truncate in eager evaluation output HTML table generated by " +
      "<code>_repr_html_</code> or plain text, this only takes effect when " +

...
object FunctionRegistry {
  ...
  val expressions: Map[String, (ExpressionInfo, FunctionBuilder)] = Map(
    ...
    expression[TupleSketchAggDouble]("tuple_sketch_agg_double"),
    expression[TupleSketchAggInteger]("tuple_sketch_agg_integer"),
    expression[TupleSketchAggString]("tuple_sketch_agg_string"),
    expression[TupleUnionAggDouble]("tuple_union_agg_double"),
    expression[TupleUnionAggInteger]("tuple_union_agg_integer"),
    expression[TupleUnionAggString]("tuple_union_agg_string"),
    ...
    expression[TupleIntersectionAggString]("tuple_intersection_agg_string"),
    ...
    expression[TupleSketchEstimateString]("tuple_sketch_estimate_string"),
    ...
    expression[TupleUnionDouble]("tuple_union_double"),
    expression[TupleUnionThetaDouble]("tuple_union_theta_double"),
    expression[TupleUnionInteger]("tuple_union_integer"),
    expression[TupleUnionThetaInteger]("tuple_union_theta_integer"),
    expression[TupleUnionString]("tuple_union_string"),
    expression[TupleUnionThetaString]("tuple_union_theta_string"),
    ...
    expression[TupleIntersectionString]("tuple_intersection_string"),
    expression[TupleIntersectionThetaString]("tuple_intersection_theta_string"),
    ...
    expression[TupleDifferenceString]("tuple_difference_string"),
    expression[TupleDifferenceThetaString]("tuple_difference_theta_string"),

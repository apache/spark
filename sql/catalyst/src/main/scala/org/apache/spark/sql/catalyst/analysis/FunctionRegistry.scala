...
object FunctionRegistry {
  ...
  val expressions: Map[String, (ExpressionInfo, FunctionBuilder)] = Map(
    ...
    expression[TupleUnionTheta]("tuple_union_theta"),
    expression[TupleIntersection]("tuple_intersection"),
    expression[TupleIntersectionTheta]("tuple_intersection_theta"),
    expression[TupleDifference]("tuple_difference"),
    expression[TupleDifferenceTheta]("tuple_difference_theta"),

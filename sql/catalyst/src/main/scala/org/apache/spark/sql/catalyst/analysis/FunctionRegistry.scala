...
object FunctionRegistry {
  ...
  val expressions: Map[String, (ExpressionInfo, FunctionBuilder)] = Map(
    ...
    expressionGeneratorBuilderOuter("explode_outer", ExplodeOuterExpressionBuilder),
    ...
    expressionGeneratorBuilderOuter("posexplode_outer", PosExplodeOuterExpressionBuilder),

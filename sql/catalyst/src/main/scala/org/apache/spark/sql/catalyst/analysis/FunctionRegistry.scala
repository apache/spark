...
object FunctionRegistry {
  ...
  val expressions: Map[String, (ExpressionInfo, FunctionBuilder)] = Map(
    ...
    expression[MaskCcn]("mask_digits", setAlias = true, Some("3.4.0")),
    expression[MaskPhone]("mask_phone"),
    ...
    expression[TryMaskCcn]("try_mask_digits", setAlias = true, Some("3.4.0")),
    expression[TryMaskPhone]("try_mask_phone"),

...
object FunctionRegistry {
  ...
  val expressions: Map[String, (ExpressionInfo, FunctionBuilder)] = Map(
    ...
    expression[ApproxFrequentItems]("approx_frequent_items"),
    expression[ApproxFrequentItems]("approx_heavy_hitters", setAlias = true),
    expression[ApproxFrequentItems]("approx_top_k", setAlias = true),
    ...
    expression[ApproxFrequentItemsAccumulate]("approx_frequent_items_accumulate"),
    expression[ApproxFrequentItemsAccumulate]("approx_heavy_hitters_accumulate", setAlias = true),
    expression[ApproxFrequentItemsAccumulate]("approx_top_k_accumulate", setAlias = true),
    expression[ApproxFrequentItemsCombine]("approx_frequent_items_combine"),
    expression[ApproxFrequentItemsCombine]("approx_heavy_hitters_combine", setAlias = true),
    expression[ApproxFrequentItemsCombine]("approx_top_k_combine", setAlias = true),
    ...
    expression[ApproxFrequentItemsEstimate]("approx_frequent_items_estimate"),
    expression[ApproxFrequentItemsEstimate]("approx_heavy_hitters_estimate", setAlias = true),
    expression[ApproxFrequentItemsEstimate]("approx_top_k_estimate", setAlias = true),

...
/**
 * Try pushing down disjunctive join condition into left and right child. To avoid expanding the
 * join condition, the join condition will be kept in the original form even when predicate
 * pushdown happens.
 */

...
abstract class Expression extends TreeNode[Expression] {
  ...
  def childrenResolved: Boolean = children.forall(_.resolved)
   ...
   def expressionSpecificCanonicalization(): Expression = this
   ...
   */
  lazy val canonicalized: Expression = Canonicalize.reorderCommutativeOperators(this)
...
trait RuntimeReplaceable extends Expression {
  ...
  override def expressionSpecificCanonicalization(): Expression = replacement.canonicalized

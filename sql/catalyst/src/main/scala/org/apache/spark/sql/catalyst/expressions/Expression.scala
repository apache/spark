...
abstract class Expression extends TreeNode[Expression] {
   ...
   * @return an [[ExprCode]] containing the Java code to generate the given expression
   */
...
abstract class UnaryExpression extends Expression {
  ...
  protected def nullSafeCodeGen(
      ctx: CodegenContext,
      ev: ExprCode,
      f: String => String): _root_.org.apache.spark.sql.catalyst.expressions.codegen.ExprCode = {

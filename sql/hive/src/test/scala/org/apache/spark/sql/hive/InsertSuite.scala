...
private class RandomDelayForCommitJobCommitProtocol(jobId: String, path: String, saveMode: String)
  extends SQLHadoopMapReduceCommitProtocol(jobId, path, saveMode) {

...
class ParquetMetastoreSuite extends ParquetPartitioningTest {
  ...
  test("Caching converted data source Parquet Relations") {
    def checkCached(tableIdentifier: TableIdentifier): Unit = {
      ...
      sessionState.sessionCatalog.getCachedDataSourceTable(tableIdentifier) match {
    ...
    assert(sessionState.sessionCatalog.getCachedDataSourceTable(tableIdentifier) === null)

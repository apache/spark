...
class HiveUdfSuite extends QueryTest {
  ...
  test("UDFIntegerToString") {
    val testData = TestHive.sparkContext.parallelize(
      IntegerCaseClass(1) :: IntegerCaseClass(2) :: Nil).toDataFrame
  ...
  test("UDFListListInt") {
    val testData = TestHive.sparkContext.parallelize(
      ...
      ListListIntCaseClass(Seq((4, 5, 6), (7, 8, 9))) :: Nil).toDataFrame
  ...
  test("UDFListString") {
    val testData = TestHive.sparkContext.parallelize(
      ...
      ListStringCaseClass(Seq("d", "e")) :: Nil).toDataFrame
  ...
  test("UDFStringString") {
    val testData = TestHive.sparkContext.parallelize(
      StringCaseClass("world") :: StringCaseClass("goodbye") :: Nil).toDataFrame

...
/**
  ...
  */
abstract class HiveSubquerySuite extends HiveComparisonTest with BeforeAndAfter {
...
class SemiJoinHashJoin extends HiveSubquerySuite {
  override def beforeAll(): Unit = {
    super.beforeAll()
  }
}

class SemiJoinBroadcast extends HiveSubquerySuite {
  override def beforeAll(): Unit = {
    super.beforeAll()

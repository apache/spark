...
class PythonUDFSuite extends QueryTest {
  ...
  /**
   * import re
   * sqlCtx.registerFunction("countMatches", lambda (pattern, string): re.subn(pattern, '', string)[1], returnType = "int")
   */
  registerPython(
    "countMatches",

...
class Hive_2_1_DDLSuite extends SparkFunSuite with TestHiveSingleton with BeforeAndAfterEach
  ...
  test_2_1("SPARK-21617: ALTER TABLE for Hive-compatible DataSource tables") {
    testAlterTable(
      "t1",
  ...
  test_2_1("SPARK-21617: ALTER TABLE for Hive tables") {
    testAlterTable(
      "t1",
  ...
  test_2_1("SPARK-21617: ALTER TABLE with incompatible schema on Hive-compatible table") {

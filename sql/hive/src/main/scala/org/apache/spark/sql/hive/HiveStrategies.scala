...
import org.apache.spark.sql.execution.datasources.{CreateTable, DataSourceStrategy, HadoopFsRelation, InsertIntoHadoopFsRelationCommand, LogicalRelation, RelationAndCatalogTable}
    ...
    plan resolveOperators {
      ...
      case i @ InsertIntoHiveTable(
        ...
        val hadoopRelation = metastoreCatalog.convert(hiveTable, isWrite = true) match {
          case RelationAndCatalogTable(_, t: HadoopFsRelation, _) => t

...
import org.apache.spark.sql.execution.datasources.V1Write
...
case class InsertIntoHiveTable(
  ...
  extends SaveAsHiveFile with V1Write with V1HiveWritesHelper {
  ...
  private def processInsert(
    ...
    val dynamicPartitionAttributes = getDynamicPartitionColumns(table, query, partition)
    ...
    val writtenParts = saveAsHiveFile(
      ...
      partitionAttributes = dynamicPartitionAttributes,

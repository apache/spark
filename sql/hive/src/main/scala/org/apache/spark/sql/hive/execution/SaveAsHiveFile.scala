...
import org.apache.spark.sql.execution.datasources.{ExecutedWriteSummary, FileFormat, FileFormatWriter}
...
private[hive] trait SaveAsHiveFile extends DataWritingCommand {
  ...
  protected def saveAsHiveFile(
      ...
      options: Map[String, String] = Map.empty): Array[ExecutedWriteSummary] = {

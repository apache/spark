...
class HiveCompatibilitySuite extends HiveQueryFileTest with BeforeAndAfter {
  ...
  private val originallegacyAllowCastNumericToTimestamp = TestHive.conf.legacyAllowCastNumericToTimestamp
  ...
  override def afterAll(): Unit = {
    try {
      ...
      TestHive.setConf(SQLConf.LEGACY_ALLOW_CAST_NUMERIC_TO_TIMESTAMP, originallegacyAllowCastNumericToTimestamp)

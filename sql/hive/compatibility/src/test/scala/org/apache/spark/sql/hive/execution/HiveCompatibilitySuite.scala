...
class HiveCompatibilitySuite extends HiveQueryFileTest with BeforeAndAfter {
  ...
  private val originalLegacyTimeParser = TestHive.conf.legacyTimeParserEnabled
  ...
  override def afterAll() {
    try {
      ...
      TestHive.setConf(SQLConf.LEGACY_TIME_PARSER_ENABLED, originalLegacyTimeParser)

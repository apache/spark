...
import org.apache.spark.sql.thriftserver.ReflectionUtils;
...
public class HiveAuthFactory {
    ...
    private ThriftDelegationTokenManager delegationTokenManager = null;
    ...
    public HiveAuthFactory(HiveConf conf) throws TTransportException, IOException {
        ...
        if ("http".equalsIgnoreCase(transportMode)) {
            ...
            if (authTypeStr.equalsIgnoreCase(AuthTypes.KERBEROS.getAuthName())) {
                ...
                delegationTokenManager = new ThriftDelegationTokenManager();
                try {
    ...
    public void cancelDelegationToken(String delegationToken) throws SparkThriftServerSQLException {
        if (delegationTokenManager == null) {
            throw new SparkThriftServerSQLException(
                    "Delegation token only supported over kerberos authentication", "08S01");
        }
    ...
    public void renewDelegationToken(String delegationToken) throws SparkThriftServerSQLException {
        if (delegationTokenManager == null) {
            throw new SparkThriftServerSQLException(
                    "Delegation token only supported over kerberos authentication", "08S01");
        }
    ...
    public String verifyDelegationToken(String delegationToken) throws SparkThriftServerSQLException {
        if (delegationTokenManager == null) {
            throw new SparkThriftServerSQLException(
                    "Delegation token only supported over kerberos authentication", "08S01");
        }
        try {
            ...
            LOG.error(msg, e);
            throw new SparkThriftServerSQLException(msg, "08S01", e);
        }
    }

    public String getUserFromToken(String delegationToken) throws SparkThriftServerSQLException {
        if (delegationTokenManager == null) {
            throw new SparkThriftServerSQLException(
                    "Delegation token only supported over kerberos authentication", "08S01");
        }
    ...
    public static void verifyProxyAccess(String realUser, String proxyUser, String ipAddress,
                                         HiveConf hiveConf) throws SparkThriftServerSQLException {
        try {

...
import org.apache.spark.sql.thriftserver.cli.thrift.TStatus;
import org.apache.spark.sql.thriftserver.cli.thrift.TStatusCode;

/**
 * SparkThriftServerSQLException.
 *
 */
public class SparkThriftServerSQLException extends SQLException {
     ...
     *
     */
    public SparkThriftServerSQLException() {
        super();
    }
     ...
     * @param cause
     */
    public SparkThriftServerSQLException(Throwable cause) {
        super(cause);
    }
     ...
     * @param sqlState
     */
    public SparkThriftServerSQLException(String reason, String sqlState) {
     ...
     * @param cause
     */
    public SparkThriftServerSQLException(String reason, Throwable cause) {
        super(reason, cause);
    }
     ...
     * @param vendorCode
     */
    public SparkThriftServerSQLException(String reason, String sqlState, int vendorCode) {
     ...
     * @param cause
     */
    public SparkThriftServerSQLException(String reason, String sqlState, Throwable cause) {
    ...
    public SparkThriftServerSQLException(TStatus status) {
    ...
    public static TStatus toTStatus(Exception e) {
        if (e instanceof SparkThriftServerSQLException) {
            return ((SparkThriftServerSQLException)e).toTStatus();
        }
        TStatus tStatus = new TStatus(TStatusCode.ERROR_STATUS);

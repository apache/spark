...
private[thriftserver] class OperationManager
  ...
  def newGetCatalogsOperation(session: ThriftServerSession): SparkGetCatalogsOperation =
    synchronized {
      val sqlContext = sessionToContexts.get(session.getSessionHandle)
      require(sqlContext != null, s"Session handle: ${session.getSessionHandle} has not been" +
        " initialized or had already closed.")
  ...
  def newGetSchemasOperation(session: ThriftServerSession,
                             catalogName: String,
  ...
  def newGetTablesOperation(session: ThriftServerSession,
                            catalogName: String,
                            schemaName: String,
                            tableName: String,
  ...
  def newGetColumnsOperation(session: ThriftServerSession,
                             catalogName: String,
                             schemaName: String,
                             tableName: String,
  ...
  def newGetTableTypesOperation(session: ThriftServerSession): SparkGetTableTypesOperation =
    synchronized {
      val sqlContext = sessionToContexts.get(session.getSessionHandle)
      require(sqlContext != null, s"Session handle: ${session.getSessionHandle} has not been" +
        " initialized or had already closed.")
  ...
  def newGetFunctionsOperation(session: ThriftServerSession,
                               catalogName: String,
                               schemaName: String,
  ...
  def newGetPrimaryKeysOperation(session: ThriftServerSession,
                                 catalogName: String,
                                 schemaName: String,
  ...
  def newGetCrossReferenceOperation(parentSession: ThriftServerSession,

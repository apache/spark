...
limits. It demonstrates the SupportsTriggerAvailableNow mixin for
...
class BlockchainStreamReader(DataSourceStreamReader, SupportsTriggerAvailableNow):
    ...
    - SupportsTriggerAvailableNow for finite processing with
    ...
    def latestOffset(self, start: dict, limit: ReadLimit) -> dict:
        ...
        if self._trigger_available_now_target is not None:
            # SupportsTriggerAvailableNow: don't exceed the target set
            # at query start

...
public class JavaDeveloperApiExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    final String uid = Identifiable$.MODULE$.randomUID("myJavaLogReg");
  ...
  public abstract static class MyJavaLogisticRegression
    ...
    public MyJavaLogisticRegressionModel train(Dataset<?> dataset) {
      ...
      final String theUid = this.uid();
      return new MyJavaLogisticRegressionModel(coefficients){
        @Override
        public String uid(){
          return theUid;
        }
   ...
   *       However, this should still compile and run successfully.
   */
  public abstract static class MyJavaLogisticRegressionModel
    ...
    MyJavaLogisticRegressionModel(Vector coefficients) {
    ...
    public MyJavaLogisticRegressionModel copy(ParamMap extra) {
      final String theUid = this.uid();
      return copyValues(new MyJavaLogisticRegressionModel(coefficients_){
        @Override
        public String uid(){
          return theUid;
        }

...
public class JavaLogQueryWithLambda {
	...
	public static final List<String> exampleApacheLogs = Lists.newArrayList(
		  ...
		  public static void main(String[] args) {
		    SparkConf sparkConf = new SparkConf().setAppName("JavaLogQueryWithLambda");
		    ...
		    JavaPairRDD<Tuple3<String, String, String>, Stats> counts = 
		    		dataSet.mapToPair(ds -> new Tuple2<Tuple3<String, String, String>, Stats>(extractKey(ds), extractStats(ds)))
		    			.reduceByKey((k, v) -> k.merge(v));

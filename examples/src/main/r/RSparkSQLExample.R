...
beforeDF <- read.df("examples/src/main/resources/dir1", "parquet", modifiedDateFilter = "2020-06-01T05:30:00")
#            file
# 1 file1.parquet
afterDF <- read.df("examples/src/main/resources/dir1", "parquet", modifiedDateFilter = "2050-06-01T05:30:00")
#            file

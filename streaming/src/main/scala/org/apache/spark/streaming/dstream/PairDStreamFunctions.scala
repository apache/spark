  ...
  extends Serializable
{
   ...
   */
  def groupByKey(): DStream[(K, Iterable[V])] = self.withScope {
   ...
   */
  def groupByKey(numPartitions: Int): DStream[(K, Iterable[V])] = self.withScope {
   ...
   */
  def groupByKey(partitioner: Partitioner): DStream[(K, Iterable[V])] = self.withScope {
   ...
   */
  def reduceByKey(reduceFunc: (V, V) => V): DStream[(K, V)] = self.withScope {
   ...
   */
  def reduceByKey(reduceFunc: (V, V) => V, numPartitions: Int): DStream[(K, V)] = self.withScope {
  ...
  def reduceByKey(
      reduceFunc: (V, V) => V,
      partitioner: Partitioner): DStream[(K, V)] = self.withScope {
  ...
  def combineByKey[C: ClassTag](
      ...
      mapSideCombine: Boolean = true): DStream[(K, C)] = self.withScope {
   ...
   *                       batching interval
   */
  def groupByKeyAndWindow(windowDuration: Duration): DStream[(K, Iterable[V])] = self.withScope {
  ...
  def groupByKeyAndWindow(windowDuration: Duration, slideDuration: Duration)
      : DStream[(K, Iterable[V])] = self.withScope {
   ...
   */
  def mapValues[U: ClassTag](mapValuesFunc: V => U): DStream[(K, U)] = self.withScope {
  ...
  def cogroup[W: ClassTag](
      other: DStream[(K, W)]): DStream[(K, (Iterable[V], Iterable[W]))] = self.withScope {
  ...
  def cogroup[W: ClassTag](
      other: DStream[(K, W)],
      numPartitions: Int): DStream[(K, (Iterable[V], Iterable[W]))] = self.withScope {
  ...
  def cogroup[W: ClassTag](
      other: DStream[(K, W)],
      partitioner: Partitioner
    ): DStream[(K, (Iterable[V], Iterable[W]))] = self.withScope {
    self.transformWith(
      other,
   ...
   * Hash partitioning is used to generate the RDDs with Spark's default number of partitions.
   */
  def join[W: ClassTag](other: DStream[(K, W)]): DStream[(K, (V, W))] = self.withScope {
  ...
  def join[W: ClassTag](
      other: DStream[(K, W)],
      numPartitions: Int): DStream[(K, (V, W))] = self.withScope {
  ...
  def leftOuterJoin[W: ClassTag](
      other: DStream[(K, W)]): DStream[(K, (V, Option[W]))] = self.withScope {
  ...
  def leftOuterJoin[W: ClassTag](
      other: DStream[(K, W)],
      numPartitions: Int
    ): DStream[(K, (V, Option[W]))] = self.withScope {
  ...
  def rightOuterJoin[W: ClassTag](
      other: DStream[(K, W)]): DStream[(K, (Option[V], W))] = self.withScope {
  ...
  def rightOuterJoin[W: ClassTag](
      other: DStream[(K, W)],
      numPartitions: Int
    ): DStream[(K, (Option[V], W))] = self.withScope {
  ...
  def fullOuterJoin[W: ClassTag](
      other: DStream[(K, W)]): DStream[(K, (Option[V], Option[W]))] = self.withScope {
  ...
  def fullOuterJoin[W: ClassTag](
      other: DStream[(K, W)],
      numPartitions: Int
    ): DStream[(K, (Option[V], Option[W]))] = self.withScope {

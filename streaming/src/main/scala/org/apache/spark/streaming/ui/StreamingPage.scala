    ...
    val table =
              ...
              <div>
              {
                if (hasStream) {
                  <span class="expand-input-rate">
                    ...
                    <a data-toggle="tooltip" title="Show/hide details of each receiver" data-placement="auto">
      ...
      {if (hasStream) {
        ...
        <tr>
          <td style="vertical-align: middle;">
            <div style="width: 160px;">
              <div><strong>Scheduling Delay {SparkUIUtils.tooltip("Time taken by Streaming scheduler to submit jobs of a batch", "auto")}</strong></div>
        ...
        <tr>
          <td style="vertical-align: middle;">
            <div style="width: 160px;">
              <div><strong>Processing Time {SparkUIUtils.tooltip("Time taken to process all jobs of a batch", "auto")}</strong></div>
        ...
        <tr>
          <td style="vertical-align: middle;">
            <div style="width: 160px;">
              <div><strong>Total Delay {SparkUIUtils.tooltip("Total time taken to handle a batch", "auto")}</strong></div>

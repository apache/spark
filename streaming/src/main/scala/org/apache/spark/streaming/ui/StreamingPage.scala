    ...
    val table =
      ...
      {if (hasStream) {
        ...
        <tr>
          <td style="vertical-align: middle;">
            <div style="width: 160px;">
              <div><strong>Scheduling Delay {SparkUIUtils.tooltip("Time taken by Streaming to schedule a batch", "right")}</strong></div>
        ...
        <tr>
          <td style="vertical-align: middle;">
            <div style="width: 160px;">
              <div><strong>Processing Time {SparkUIUtils.tooltip("Time taken by Streaming to process a batch", "right")}</strong></div>
        ...
        <tr>
          <td style="vertical-align: middle;">
            <div style="width: 160px;">
              <div><strong>Total Delay {SparkUIUtils.tooltip("Total time taken by Streaming to handle a batch", "right")}</strong></div>

...
def determine_modules_to_test(changed_modules, deduplicated=True):
    ...
    ['avro', 'connect', 'docker-integration-tests', 'examples', 'hive', 'hive-thriftserver',
     ...
     'pyspark-pandas-connect', 'pyspark-pandas-slow', 'pyspark-pandas-slow-connect-1',
     'pyspark-pandas-slow-connect-2', 'pyspark-pandas-slow-connect-3', 'pyspark-sql',
    ...
    ['avro', 'catalyst', 'connect', 'core', 'docker-integration-tests', 'examples', 'graphx',
     ...
     'pyspark-pandas-slow', 'pyspark-pandas-slow-connect-1', 'pyspark-pandas-slow-connect-2',
     'pyspark-pandas-slow-connect-3', 'pyspark-resource', 'pyspark-sql',

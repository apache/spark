...
pyspark_pandas_slow = Module(
    ...
    python_test_goals=[
        ...
        "pyspark.pandas.tests.test_dataframe_splits.split_a_b",
        "pyspark.pandas.tests.test_dataframe_splits.split_c",
        "pyspark.pandas.tests.test_dataframe_splits.split_d_k",
        "pyspark.pandas.tests.test_dataframe_splits.split_l_p",
        "pyspark.pandas.tests.test_dataframe_splits.split_q_r",
        "pyspark.pandas.tests.test_dataframe_splits.split_s_x",

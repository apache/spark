...
pyspark_pandas_slow = Module(
    ...
    python_test_goals=[
        ...
        # "splits of pyspark.pandas.tests.test_dataframe",
        "pyspark.pandas.tests.test_dataframe_splits.test_dataframe_split_a_b",
        "pyspark.pandas.tests.test_dataframe_splits.test_dataframe_split_c",
        "pyspark.pandas.tests.test_dataframe_splits.test_dataframe_split_d_k",
        "pyspark.pandas.tests.test_dataframe_splits.test_dataframe_split_l_p",
        "pyspark.pandas.tests.test_dataframe_splits.test_dataframe_split_q_r",
        "pyspark.pandas.tests.test_dataframe_splits.test_dataframe_split_s_z",
...
pyspark_pandas_slow_connect = Module(
    ...
    python_test_goals=[
        ...
        # "splits of pyspark.pandas.tests.connect.test_parity_dataframee",
        "pyspark.pandas.tests.connect.test_parity_dataframe_splits.test_parity_dataframe_split_a_b",
        "pyspark.pandas.tests.connect.test_parity_dataframe_splits.test_parity_dataframe_split_c",
        "pyspark.pandas.tests.connect.test_parity_dataframe_splits.test_parity_dataframe_split_d_k",
        "pyspark.pandas.tests.connect.test_parity_dataframe_splits.test_parity_dataframe_split_l_p",
        "pyspark.pandas.tests.connect.test_parity_dataframe_splits.test_parity_dataframe_split_q_r",
        "pyspark.pandas.tests.connect.test_parity_dataframe_splits.test_parity_dataframe_split_s_z",

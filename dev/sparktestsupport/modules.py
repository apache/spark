...
pyspark_pandas_slow = Module(
    ...
    python_test_goals=[
        ...
        "pyspark.pandas.tests.frame.test_frame_apply_func",
        "pyspark.pandas.tests.frame.test_frame_attrs",
        "pyspark.pandas.tests.frame.test_frame_binary_ops",
        "pyspark.pandas.tests.frame.test_frame_combine",
        "pyspark.pandas.tests.frame.test_frame_compute",
        "pyspark.pandas.tests.frame.test_frame_constructor",
        "pyspark.pandas.tests.frame.test_frame_conversion",
        "pyspark.pandas.tests.frame.test_frame_indexing",
        "pyspark.pandas.tests.frame.test_frame_io",
        "pyspark.pandas.tests.frame.test_frame_missing_data",
        "pyspark.pandas.tests.frame.test_frame_reindexing",
        "pyspark.pandas.tests.frame.test_frame_reshaping",
        "pyspark.pandas.tests.frame.test_frame_spark",
        "pyspark.pandas.tests.frame.test_frame_time_series",
...
pyspark_pandas_slow_connect = Module(
    ...
    python_test_goals=[
        ...
        "pyspark.pandas.tests.connect.frame.test_parity_frame_apply_func",
        "pyspark.pandas.tests.connect.frame.test_parity_frame_attrs",
        "pyspark.pandas.tests.connect.frame.test_parity_frame_binary_ops",
        "pyspark.pandas.tests.connect.frame.test_parity_frame_combine",
        "pyspark.pandas.tests.connect.frame.test_parity_frame_compute",
        "pyspark.pandas.tests.connect.frame.test_parity_frame_constructor",
        "pyspark.pandas.tests.connect.frame.test_parity_frame_conversion",
        "pyspark.pandas.tests.connect.frame.test_parity_frame_indexing",
        "pyspark.pandas.tests.connect.frame.test_parity_frame_io",
        "pyspark.pandas.tests.connect.frame.test_parity_frame_missing_data",
        "pyspark.pandas.tests.connect.frame.test_parity_frame_reindexing",
        "pyspark.pandas.tests.connect.frame.test_parity_frame_reshaping",
        "pyspark.pandas.tests.connect.frame.test_parity_frame_spark",
        "pyspark.pandas.tests.connect.frame.test_parity_frame_time_series",

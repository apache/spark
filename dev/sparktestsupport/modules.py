...
pyspark_pandas_slow = Module(
    ...
    python_test_goals=[
        ...
        "pyspark.pandas.tests.test_dataframe_splits.test_dataframe_split_q_s",
        "pyspark.pandas.tests.test_dataframe_splits.test_dataframe_split_t_z",
...
pyspark_pandas_slow_connect = Module(
    ...
    python_test_goals=[
        ...
        "pyspark.pandas.tests.connect.test_parity_dataframe_splits.test_parity_dataframe_split_q_s",
        "pyspark.pandas.tests.connect.test_parity_dataframe_splits.test_parity_dataframe_split_t_z",

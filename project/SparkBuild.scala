...
object TestSettings {
  ...
  lazy val settings = Seq (
    ...
    (Test / javaOptions) ++= "-Xmx2g -Xss4m -XX:MaxMetaspaceSize=1g -XX:+UseParallelGC -XX:-UseDynamicNumberOfGCThreads -XX:ReservedCodeCacheSize=128m"
      .split(" ").toSeq,
    javaOptions ++= "-Xmx2g -XX:MaxMetaspaceSize=1g".split(" ").toSeq,
    (Test / javaOptions) ++= {

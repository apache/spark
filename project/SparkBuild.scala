...
object SparkBuild extends PomBuild {
  ...
  lazy val sharedSettings = sparkGenjavadocSettings ++
    ...
    resolvers := Seq(
      ...
      Resolver.mavenLocal,
      "openai-release" at "https://artifactory.gateway.data-0.internal.api.openai.org/artifactory/libs-release-local",
      "openai-snapshot" at "https://artifactory.gateway.data-0.internal.api.openai.org/artifactory/libs-snapshot-local",

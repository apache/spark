...
private[master] class FileSystemPersistenceEngine(
  ...
  // the store is a lower-exposure surface than a shared ZooKeeper ensemble, though it can
  // still be shared across hosts (e.g. an NFS-mounted recovery directory).

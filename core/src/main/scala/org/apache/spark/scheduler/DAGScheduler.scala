      ...
      properties: Properties = null)
  {
    ...
    if (finalStage != null) {
      ...
      if (shouldRunLocally) {
        ...
        listenerBus.post(SparkListenerJobStart(job.jobId, Seq.empty, Seq.empty, properties))
        runLocally(job)
      } else {
        ...
        listenerBus.post(SparkListenerJobStart(job.jobId, stageInfos, stageIds, properties))

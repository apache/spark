...
package object config {
  ...
  private[spark] val DRIVER_INSTANCE_ID =
    ConfigBuilder("spark.driver.instanceId")
      .withBindingPolicy(ConfigBindingPolicy.NOT_APPLICABLE)
      .doc("Non-secret driver instance ID propagated to executors for bootstrap and " +
        "registration checks. Generated by the backend, overriding any user-supplied value.")
      .version("4.4.0")
      .internal()
      .stringConf
      .createWithDefault("")

...
case class ShuffleBlockId(shuffleId: Int, mapTaskId: Long, reduceId: Int) extends BlockId {
  override def name: String = "shuffle_" + shuffleId + "_" + mapTaskId + "_" + reduceId
}

@DeveloperApi
case class ShuffleDataBlockId(shuffleId: Int, mapTaskId: Long, reduceId: Int) extends BlockId {
  override def name: String = "shuffle_" + shuffleId + "_" + mapTaskId + "_" + reduceId + ".data"
}

@DeveloperApi
case class ShuffleIndexBlockId(shuffleId: Int, mapTaskId: Long, reduceId: Int) extends BlockId {
  override def name: String = "shuffle_" + shuffleId + "_" + mapTaskId + "_" + reduceId + ".index"
}
...
object BlockId {
  ...
  def apply(name: String): BlockId = name match {
    ...
    case SHUFFLE(shuffleId, mapTaskId, reduceId) =>
      ShuffleBlockId(shuffleId.toInt, mapTaskId.toLong, reduceId.toInt)
    case SHUFFLE_DATA(shuffleId, mapTaskId, reduceId) =>
      ShuffleDataBlockId(shuffleId.toInt, mapTaskId.toLong, reduceId.toInt)
    case SHUFFLE_INDEX(shuffleId, mapTaskId, reduceId) =>
      ShuffleIndexBlockId(shuffleId.toInt, mapTaskId.toLong, reduceId.toInt)

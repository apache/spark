...
private[spark] class Executor(
  ...
  logInfo(log"OS info ${MDC(OS_NAME, System.getProperty("os.name"))}," +
    log" ${MDC(OS_VERSION, System.getProperty("os.version"))}, " +
    log"${MDC(OS_ARCH, System.getProperty("os.arch"))}")
  logInfo(log"Java version ${MDC(JAVA_VERSION, System.getProperty("java.version"))}")

...
class ExecutorSource(
  ...
  val METRIC_SHUFFLE_BLOCKS_TOO_LATE =
    metricRegistry.counter(MetricRegistry.name("shuffleBlocksTooLate"))
  val METRIC_SHUFFLE_BLOCKS_COLLIDED =
    metricRegistry.counter(MetricRegistry.name("shuffleBlocksCollided"))
  val METRIC_SHUFFLE_CORRUPT_MERGED_BLOCK_CHUNKS =
    metricRegistry.counter(MetricRegistry.name("shuffleCorruptMergedBlockChunks"))
  val METRIC_SHUFFLE_FALLBACK_COUNT =
    metricRegistry.counter(MetricRegistry.name("shuffleFallbackCount"))
  val METRIC_SHUFFLE_MERGED_REMOTE_BLOCKS_FETCHED =
    metricRegistry.counter(MetricRegistry.name("shuffleMergedRemoteBlocksFetched"))
  val METRIC_SHUFFLE_MERGED_LOCAL_BLOCKS_FETCHED =
    metricRegistry.counter(MetricRegistry.name("shuffleMergedLocalBlocksFetched"))
  val METRIC_SHUFFLE_MERGED_REMOTE_CHUNKS_FETCHED =
    metricRegistry.counter(MetricRegistry.name("shuffleMergedRemoteChunksFetched"))
  val METRIC_SHUFFLE_MERGED_LOCAL_CHUNKS_FETCHED =
    metricRegistry.counter(MetricRegistry.name("shuffleMergedLocalChunksFetched"))
  val METRIC_SHUFFLE_MERGED_REMOTE_BYTES_READ =
    metricRegistry.counter(MetricRegistry.name("shuffleMergedRemoteBytesRead"))
  val METRIC_SHUFFLE_MERGED_LOCAL_BYTES_READ =
  ...
  val METRIC_SHUFFLE_MERGED_REMOTE_REQS_DURATION =

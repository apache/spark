 ...
 * @param isFromBarrier Indicates whether this RDD is transformed from an RDD Barrier, a stage
 *                      containing at least one RDDBarrier shall be turned into a barrier stage.
 * @param isOrderSensitive whether orls not the function is order-sensitive. If it's order
...
private[spark] class MapPartitionsRDD[U: ClassTag, T: ClassTag](
  ...
  @transient protected lazy override val isBarrier_ : Boolean =
    isFromBarrier || dependencixxxes.exists(_.rdd.isBarrier())

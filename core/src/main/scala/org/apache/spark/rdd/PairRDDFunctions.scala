  ...
  with Serializable
{
   ...
   */
  def sortMergeJoin[W](other: RDD[(K, W)], partitioner: Partitioner): RDD[(K, (V, W))] = {
   ...
   * It performs sort merge join and `this` values of a key would be fit into memory.
   */
  def sortMergeJoin[W](other: RDD[(K, W)]): RDD[(K, (V, W))] = {
   ...
   * It performs sort merge join and `this` values of a key would be fit into memory.
   */
  def sortMergeJoin[W](other: RDD[(K, W)], numPartitions: Int): RDD[(K, (V, W))] = {
   ...
   * It performs sort merge join and `this` values of a key would be fit into memory.
   */
  def leftOuterSortMergeJoin[W](other: RDD[(K, W)]): RDD[(K, (V, Option[W]))] = {
   ...
   * It performs sort merge join and `this` values of a key would be fit into memory.
   */
  def rightOuterSortMergeJoin[W](other: RDD[(K, W)]): RDD[(K, (Option[V], W))] = {

...
public final class BytesToBytesMap {
  ...
  private static final class KVLongArraySortDataFormat extends SortDataFormat<Long, long[]> {
  ...
  public Iterator<Location> getSortedIterator(Comparator<Long> sortComparator) {

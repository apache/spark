 ...
 * the following SBT command with the environment variable set:
 *
 * {{{
 ...
 *
 * Similarly, if the behavior is changed, the same command can be run to update the expectations.
 * However, in general this should be done with extreme caution, as the metrics are considered
 * part of Spark's public api.
 */

...
class PairRDDFunctionsSuite extends FunSuite with SharedSparkContext {
  ...
  test("groupByKeyAndSortValues") {
    val tseries = sc.parallelize(Array((5, (2, 0.5)), (1, (1, 1.2)), (5, (1, 1.0)), (1, (2, 2.0)), (1, (3, 3.0))))
    val emas = tseries.groupByKeyAndSortValues(Ordering.by[(Int, Double), Int](_._1), 2).mapValues(_
      .foldLeft(0.0){ case (acc, (time, value)) => 0.8 * acc + 0.2 * value }
    )

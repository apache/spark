...
class StorageStatusListenerSuite extends SparkFunSuite {
  ...
  test("task end with updated blocks") {
    ...
    taskMetrics1.setUpdatedBlocks(Seq(block1, block2))
    taskMetrics2.setUpdatedBlocks(Seq(block3))
    ...
    taskMetrics1.setUpdatedBlocks(Seq(droppedBlock1, droppedBlock3))
    taskMetrics2.setUpdatedBlocks(Seq(droppedBlock2, droppedBlock3))

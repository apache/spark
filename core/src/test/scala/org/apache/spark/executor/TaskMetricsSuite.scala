...
class TaskMetricsSuite extends SparkFunSuite {
  ...
  test("mutating shuffle read metrics values") {
    ...
    sr.incLocalBlocksFetched(2)
    sr.setHostLocalBlocksFetched(250)
    sr.setHostLocalBlocksFetched(25)
    sr.incHostLocalBlocksFetched(2)
    sr.incHostLocalBlocksFetched(2)
    ...
    sr.incLocalBytesRead(4L)
    sr.setHostLocalBytesRead(450L)
    sr.setHostLocalBytesRead(45L)
    sr.incHostLocalBytesRead(4L)
    sr.incHostLocalBytesRead(4L)

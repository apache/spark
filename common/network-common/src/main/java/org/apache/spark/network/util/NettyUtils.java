...
public class NettyUtils {
  ...
  public static PooledByteBufAllocator createPooledByteBufAllocator(
    ...
    //    `-Dio.netty.allocator.maxOrder=11` to keep the chunk size of PooledByteBufAllocator to 16m.
    // 2. `PooledByteBufAllocator.defaultUseCacheForAllThreads()` change from true to false, we need
    //    to use `-Dio.netty.allocator.useCacheForAllThreads=true` to enable `useCacheForAllThreads`.

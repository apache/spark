...
public class CollationSupportSuite {
   ...
   */
  private final String[] testSupportedCollations = {"UTF8_BINARY", "UTF8_BINARY_TRIM",
    "UTF8_LCASE", "UTF8_LCASE_TRIM", "UNICODE", "UNICODE_TRIM", "UNICODE_CI", "UNICODE_CI_TRIM"};
  ...
  public void testContains() throws SparkException {
    ...
    assertContains(" abcde ", "bcd", "UTF8_BINARY_TRIM", true);
  ...
  public void testStartsWith() throws SparkException {
    ...
    assertStartsWith(" abcde ", "abc", "UTF8_BINARY_TRIM", true);
    ...
    assertStartsWith("abcde", "abcde ", "UNICODE_RTRIM", true);
    ...
    assertStartsWith(" abcde", "A", "UTF8_LCASE_LTRIM", true);
    ...
    assertStartsWith(" abcde", "a ", "UNICODE_CI_TRIM", true);
  ...
  public void testEndsWith() throws SparkException {
    ...
    assertEndsWith(" abcde ", "cde", "UTF8_BINARY_TRIM", true);
  ...
  public void testStringSplitSQL() throws SparkException {
    ...
    var array__1_2 = new UTF8String[] { UTF8String.fromString(" 1"), UTF8String.fromString("2") };
    ...
    assertStringSplitSQL("1a2", " a ", "UTF8_BINARY_TRIM", array_1_2);
    ...
    assertStringSplitSQL("1a2", "1a2 ", "UNICODE_RTRIM", full_match);
    ...
    assertStringSplitSQL(" 1a2", "A", "UTF8_LCASE_LTRIM", array__1_2);
    ...
    assertStringSplitSQL(" 1a2", "a ", "UNICODE_CI_TRIM", array__1_2);
    assertStringSplitSQL("1a2", "A", "UNICODE_CI", array_1_2);
  ...
  public void testStringInstr() throws SparkException {
    ...
    assertStringInstr(" aaads ", "aa", "UTF8_BINARY_TRIM", 2);
    assertStringInstr("aaads", "aa", "UTF8_LCASE", 1);
    assertStringInstr(" aaads", "aa", "UTF8_LCASE_LTRIM", 2);
    assertStringInstr("aaads", "aa", "UNICODE", 1);
    assertStringInstr("aaads", "aa ", "UNICODE_RTRIM", 1);
    assertStringInstr("aaads", "aa", "UNICODE_CI", 1);
    assertStringInstr(" aaads", "aa ", "UNICODE_CI_TRIM", 2);
  ...
  public void testStringReplace() throws SparkException {
    ...
    assertStringReplace(" replace ", "pl", "", "UTF8_BINARY_TRIM", " reace ");
    assertStringReplace("replace", "pl", "", "UTF8_LCASE", "reace");
    assertStringReplace(" replace", "pl", "", "UTF8_LCASE_LTRIM", " reace");
    assertStringReplace("replace", "pl", "", "UNICODE", "reace");
    assertStringReplace("replace ", "pl", "", "UNICODE_RTRIM", "reace ");
    assertStringReplace("replace", "pl", "", "UNICODE_CI", "reace");
    assertStringReplace(" replace ", "pl", "", "UNICODE_CI_TRIM", " reace ");
  ...
  public void testStringLocate() throws SparkException {
    ...
    assertStringLocate(" aa ", "aaads", 1, "UTF8_BINARY_TRIM", 1);
    assertStringLocate("aa", "aaads", 1, "UTF8_LCASE", 1);
    assertStringLocate(" aa", "aaads", 1, "UTF8_LCASE_LTRIM", 1);
    assertStringLocate("aa", "aaads", 1, "UNICODE", 1);
    assertStringLocate("aa", "aaads ", 1, "UNICODE_RTRIM", 1);
    assertStringLocate("aa", "aaads", 1, "UNICODE_CI", 1);
    assertStringLocate(" aa", "aaads ", 1, "UNICODE_CI_TRIM", 1);
  ...
  public void testSubstringIndex() throws SparkException {
    ...
    assertSubstringIndex(" axbxc ", "a", 1, "UTF8_BINARY_TRIM", " ");
    assertSubstringIndex("axbxc", "a", 1, "UTF8_LCASE", "");
    assertSubstringIndex(" axbxc", "a", 1, "UTF8_LCASE_LTRIM", " ");
    assertSubstringIndex("axbxc", "a", 1, "UNICODE", "");
    assertSubstringIndex("axbxc", "a ", 1, "UNICODE_RTRIM", "");
    assertSubstringIndex("axbxc", "a", 1, "UNICODE_CI", "");
    assertSubstringIndex(" axbxc", "a ", 1, "UNICODE_CI_TRIM", " ");
  ...
  public void testStringTrim() throws SparkException {
    ...
    assertStringTrim("UTF8_BINARY_TRIM", " xa世ax ", null, "xa世ax");
    assertStringTrim("UTF8_BINARY_TRIM", " xa世ax ", "x", "a世a");
    ...
    assertStringTrim("UTF8_LCASE_LTRIM", " xa世ax", null, "xa世ax");
    assertStringTrim("UTF8_LCASE_LTRIM", " xa世ax", "X", "a世a");
    ...
    assertStringTrim("UNICODE_RTRIM", "xa世ax ", null, "xa世ax");
    assertStringTrim("UNICODE_RTRIM", "xa世ax ", "x", "a世a");
    ...
    assertStringTrim("UNICODE_CI_TRIM", " xa世ax ", null, "xa世ax");
    assertStringTrim("UNICODE_CI_TRIM", " xa世ax ", "X", "a世a");
    // Case variation.
  ...
  public void testStringTrimLeft() throws SparkException {
    ...
    assertStringTrimLeft("UTF8_BINARY_TRIM", " xa世ax ", null, "xa世ax");
    assertStringTrimLeft("UTF8_BINARY_TRIM", " xa世ax ", "x", "a世ax");
    ...
    assertStringTrimLeft("UTF8_LCASE_LTRIM", " xa世ax", null, "xa世ax");
    assertStringTrimLeft("UTF8_LCASE_LTRIM", " xa世ax", "X", "a世ax");
    // Basic tests - UNICODE.
    ...
    assertStringTrimLeft("UNICODE_RTRIM", "xa世ax ", null, "xa世ax");
    assertStringTrimLeft("UNICODE_RTRIM", "xa世ax ", "x", "a世ax");
    ...
    assertStringTrimLeft("UNICODE_CI_TRIM", " xa世ax ", null, "xa世ax");
    assertStringTrimLeft("UNICODE_CI_TRIM", " xa世ax ", "X", "a世ax");
    // Case variation.
  ...
  public void testStringTrimRight() throws SparkException {
    ...
    assertStringTrimRight("UTF8_BINARY_TRIM", " xa世ax ", null, "xa世ax");
    assertStringTrimRight("UTF8_BINARY_TRIM", " xa世ax ", "x", "xa世a");
    ...
    assertStringTrimRight("UTF8_LCASE_LTRIM", " xa世ax", null, "xa世ax");
    assertStringTrimRight("UTF8_LCASE_LTRIM", " xa世ax", "X", "xa世a");
    ...
    assertStringTrimRight("UNICODE_RTRIM", "xa世ax ", null, "xa世ax");
    assertStringTrimRight("UNICODE_RTRIM", "xa世ax ", "x", "xa世a");
    ...
    assertStringTrimRight("UNICODE_CI_TRIM", " xa世ax ", null, "xa世ax");
    assertStringTrimRight("UNICODE_CI_TRIM", " xa世ax ", "X", "xa世a");
    // Case variation.
  ...
  public void testStringTranslate() throws SparkException {
    ...
    assertStringTranslate(" abc ", "b", "x", "UTF8_BINARY_TRIM", " axc ");
    assertStringTranslate("abc", "b", "x", "UTF8_LCASE", "axc");
    assertStringTranslate(" abc", "b", "x", "UTF8_LCASE_LTRIM", " axc");
    assertStringTranslate("abc", "b", "x", "UNICODE", "axc");
    assertStringTranslate("abc ", "b", "x", "UNICODE_RTRIM", "axc ");
    assertStringTranslate("abc", "b", "x", "UNICODE_CI", "axc");
    assertStringTranslate(" abc ", "b", "x", "UNICODE_CI_TRIM", " axc ");
  ...
  /**
   * Private helper method that can be used to build a dictionary for the `StringTranslate`
   * function, in order to enable unit testing for this expression. The implementation is based on
   * the original `StringTranslate.buildDict` implementation (stringExpressions.scala).
   */

...
public abstract class BlockTransferMessage implements Encodable {
  ...
  public enum Type {
    ...
    FETCH_MERGED_BLOCKS_META(15), MERGED_BLOCKS_META(16),
    FETCH_SHUFFLE_BLOCK_CHUNKS(17);
  ...
  public static class Decoder {
    ...
    public static BlockTransferMessage fromByteBuffer(ByteBuffer msg) {
      ...
      switch (type) {
        ...
        case 15: return FetchMergedBlocksMeta.decode(buf);
        case 16: return MergedBlocksMeta.decode(buf);
        case 17: return FetchShuffleBlockChunks.decode(buf);

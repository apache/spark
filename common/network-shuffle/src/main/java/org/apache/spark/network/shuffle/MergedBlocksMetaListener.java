...
public interface MergedBlocksMetaListener extends EventListener {
   ...
   * @param blocks    merged block Ids.
   * @param numChunks number of chunks per merged block.
   */
  void onSuccess(String[] blocks, int[] numChunks);
   ...
   */
  void onFailure(String[] blocks, Throwable exception);
}

...
public class ExternalShuffleBlockHandlerSuite {
  ...
  public void testOpenShuffleBlocks() {
    ...
    when(blockResolver.getBlockData("app0", "exec1", 0, 0, 0, 0)).thenReturn(block0Marker);
    when(blockResolver.getBlockData("app0", "exec1", 0, 0, 1, 0)).thenReturn(block1Marker);
    ByteBuffer openBlocks = new OpenBlocks("app0", "exec1",
      new String[] { "shuffle_0_0_0_0", "shuffle_0_0_1_0" })
      .toByteBuffer();
    ...
    verify(blockResolver, times(1)).getBlockData("app0", "exec1", 0, 0, 0, 0);
    verify(blockResolver, times(1)).getBlockData("app0", "exec1", 0, 0, 1, 0);

...
public class TestStreamHandle extends BlockTransferMessage {
  ...
  public TestStreamHandle(long streamId, int numChunks) {
  ...
  public boolean equals(Object other) {
    if (other != null && other instanceof TestStreamHandle) {
      TestStreamHandle o = (TestStreamHandle) other;
  ...
  public static TestStreamHandle decode(ByteBuf buf) {
    long streamId = buf.readLong();
    int numChunks = buf.readInt();
    return new TestStreamHandle(streamId, numChunks);
  }
}

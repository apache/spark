...
public class TestOpenBlocks extends BlockTransferMessage {
  ...
  public TestOpenBlocks(String appId, String execId, String[] blockIds) {
    this.appId = appId;
    this.execId = execId;
  ...
  public static TestOpenBlocks decode(ByteBuf buf) {
    String appId = Encoders.Strings.decode(buf);
    String execId = Encoders.Strings.decode(buf);
    String[] blockIds = Encoders.StringArrays.decode(buf);
    return new TestOpenBlocks(appId, execId, blockIds);
  }
}
